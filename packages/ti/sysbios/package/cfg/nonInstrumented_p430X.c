 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/vtree/library/trees/avala/avala-q37x/src/ti/sysbios/package/cfg/nonInstrumented_p430X");
 ...
 */
xdc__META(__TARG__, "@(#)__TARG__ = ti.targets.msp430.MSP430X");
