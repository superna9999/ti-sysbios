var filterGeneric = [
    ...
    {deviceFamily:"ARM", deviceId: "~.*(LM3|F28M35|LM4).*", toolChain:"TI"},
];

/*
 * Filter on ~F28M35 since filtering for TMS320C/F prefixes isn't 
 ...
 */
var filterC28 = [
    {deviceFamily:"C2000", deviceId:"~.*F28M35.*", toolChain:"TI"},
];
...
var filterConcertoM3 = [
    {deviceFamily:"ARM", deviceId:".*F28M35.*", toolChain:"TI"},
];
...
var options = [
	...
	cmdFile: "./c28/include/$DeviceId$.cmd",
    },
    {
        variant: "msp430",
        filter: filterMSP430,
	...
	cmdFile: "./m3/include/$DeviceId$.cmd",
    }
] 
...
function module$meta$init()
{
    ...
    /* 
     * special MSP430 example
     */
    Examples.templateArr.$add({
        title: "Clock Swi Example",
        fileList:[
            {path:"./msp430/eg22x/clkswi.c", openOnCreation: true},
            {path:"./msp430/eg22x/clkswi.cfg"},
        ],
        description: "An MSP430 specific example which increments counters in Swi and Clock functions",
        platform: "ti.platforms.msp430:$DeviceId$",
        buildProfile: "release",
        isHybrid: true,
        filterArr:[
            {deviceId:"MSP430F22.*",toolChain:"TI"},
            {deviceId:"MSP430F23.*",toolChain:"TI"},
            {deviceId:"MSP430F43.*",toolChain:"TI"},
        ],
        groups:["ti.sysbios.examples.root.msp430"],
    });
