...
public class ti_sysbios_timers_timer64
{
    ...
    void Timer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.timers.timer64.Timer.Object", new Proto.Str(po, false));
    ...
    void TimestampProvider$$TYPES()
    {
        ...
        po.init("ti.sysbios.timers.timer64.TimestampProvider.Module", om.findStrict("xdc.runtime.ITimestampProvider.Module", "ti.sysbios.timers.timer64"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.a64P',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.a64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.a674',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.timers.timer64.ae64Pe',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.timer64.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
