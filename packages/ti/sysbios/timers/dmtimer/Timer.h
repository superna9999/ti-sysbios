...
#define ti_sysbios_timers_dmtimer_Timer___VERS 150
...
struct ti_sysbios_timers_dmtimer_Timer_Fxns__ {
    ...
    xdc_UInt32 (*getMaxTicks)(ti_sysbios_timers_dmtimer_Timer_Handle, xdc_UInt32);
    xdc_Void (*setNextTick)(ti_sysbios_timers_dmtimer_Timer_Handle, xdc_UInt32, xdc_UInt32);
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Module_startup__R, "ti_sysbios_timers_dmtimer_Timer_Module_startup")
__extern xdc_Int ti_sysbios_timers_dmtimer_Timer_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Instance_init__F, "ti_sysbios_timers_dmtimer_Timer_Instance_init")
__extern int ti_sysbios_timers_dmtimer_Timer_Instance_init__F( ti_sysbios_timers_dmtimer_Timer_Object*, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_timers_dmtimer_Timer_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Instance_finalize__F, "ti_sysbios_timers_dmtimer_Timer_Instance_finalize")
__extern void ti_sysbios_timers_dmtimer_Timer_Instance_finalize__F( ti_sysbios_timers_dmtimer_Timer_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Instance_init__R, "ti_sysbios_timers_dmtimer_Timer_Instance_init")
__extern int ti_sysbios_timers_dmtimer_Timer_Instance_init__R( ti_sysbios_timers_dmtimer_Timer_Object*, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_timers_dmtimer_Timer_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Instance_finalize__R, "ti_sysbios_timers_dmtimer_Timer_Instance_finalize")
__extern void ti_sysbios_timers_dmtimer_Timer_Instance_finalize__R( ti_sysbios_timers_dmtimer_Timer_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Handle__label__S, "ti_sysbios_timers_dmtimer_Timer_Handle__label")
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Module__startupDone__S, "ti_sysbios_timers_dmtimer_Timer_Module__startupDone")
__extern xdc_Bool ti_sysbios_timers_dmtimer_Timer_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Object__create__S, "ti_sysbios_timers_dmtimer_Timer_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Object__delete__S, "ti_sysbios_timers_dmtimer_Timer_Object__delete")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Object__destruct__S, "ti_sysbios_timers_dmtimer_Timer_Object__destruct")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Object__get__S, "ti_sysbios_timers_dmtimer_Timer_Object__get")
__extern xdc_Ptr ti_sysbios_timers_dmtimer_Timer_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Object__first__S, "ti_sysbios_timers_dmtimer_Timer_Object__first")
__extern xdc_Ptr ti_sysbios_timers_dmtimer_Timer_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Object__next__S, "ti_sysbios_timers_dmtimer_Timer_Object__next")
__extern xdc_Ptr ti_sysbios_timers_dmtimer_Timer_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_Params__init__S, "ti_sysbios_timers_dmtimer_Timer_Params__init")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getNumTimers__F, "ti_sysbios_timers_dmtimer_Timer_getNumTimers")
__extern xdc_UInt ti_sysbios_timers_dmtimer_Timer_getNumTimers__F( void );
__extern xdc_UInt ti_sysbios_timers_dmtimer_Timer_getNumTimers__R( void );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getStatus__F, "ti_sysbios_timers_dmtimer_Timer_getStatus")
__extern ti_sysbios_interfaces_ITimer_Status ti_sysbios_timers_dmtimer_Timer_getStatus__F( xdc_UInt id );
__extern ti_sysbios_interfaces_ITimer_Status ti_sysbios_timers_dmtimer_Timer_getStatus__R( xdc_UInt id );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_startup__F, "ti_sysbios_timers_dmtimer_Timer_startup")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_startup__F( void );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_startup__R( void );
...
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getMaxTicks__E( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_UInt32 periodCounts );
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getMaxTicks__F, "ti_sysbios_timers_dmtimer_Timer_getMaxTicks")
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getMaxTicks__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, xdc_UInt32 periodCounts );
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getMaxTicks__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_UInt32 periodCounts );
...
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setNextTick__E( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_UInt32 newPeriod, xdc_UInt32 countsPerTick );
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_setNextTick__F, "ti_sysbios_timers_dmtimer_Timer_setNextTick")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setNextTick__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, xdc_UInt32 newPeriod, xdc_UInt32 countsPerTick );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setNextTick__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_UInt32 newPeriod, xdc_UInt32 countsPerTick );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_start__F, "ti_sysbios_timers_dmtimer_Timer_start")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_start__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_start__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_stop__F, "ti_sysbios_timers_dmtimer_Timer_stop")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_stop__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_stop__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_setPeriod__F, "ti_sysbios_timers_dmtimer_Timer_setPeriod")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setPeriod__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, xdc_UInt32 period );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setPeriod__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_UInt32 period );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs__F, "ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs")
__extern xdc_Bool ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, xdc_UInt32 microsecs );
__extern xdc_Bool ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_UInt32 microsecs );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getPeriod__F, "ti_sysbios_timers_dmtimer_Timer_getPeriod")
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getPeriod__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst );
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getPeriod__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getCount__F, "ti_sysbios_timers_dmtimer_Timer_getCount")
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getCount__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst );
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getCount__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getFreq__F, "ti_sysbios_timers_dmtimer_Timer_getFreq")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_getFreq__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, xdc_runtime_Types_FreqHz* freq );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_getFreq__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_runtime_Types_FreqHz* freq );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getFunc__F, "ti_sysbios_timers_dmtimer_Timer_getFunc")
__extern ti_sysbios_interfaces_ITimer_FuncPtr ti_sysbios_timers_dmtimer_Timer_getFunc__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, xdc_UArg* arg );
__extern ti_sysbios_interfaces_ITimer_FuncPtr ti_sysbios_timers_dmtimer_Timer_getFunc__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_UArg* arg );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_setFunc__F, "ti_sysbios_timers_dmtimer_Timer_setFunc")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setFunc__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setFunc__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_trigger__F, "ti_sysbios_timers_dmtimer_Timer_trigger")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_trigger__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, xdc_UInt32 cycles );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_trigger__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, xdc_UInt32 cycles );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getExpiredCounts__F, "ti_sysbios_timers_dmtimer_Timer_getExpiredCounts")
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getExpiredCounts__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst );
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getExpiredCounts__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_stub__F, "ti_sysbios_timers_dmtimer_Timer_stub")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_stub__F( xdc_UArg arg );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_stub__R( xdc_UArg arg );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_dynStub__F, "ti_sysbios_timers_dmtimer_Timer_dynStub")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_dynStub__F( xdc_UArg arg );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_dynStub__R( xdc_UArg arg );

/* setAvailMask__E */
#define ti_sysbios_timers_dmtimer_Timer_setAvailMask ti_sysbios_timers_dmtimer_Timer_setAvailMask__E
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_setAvailMask__E, "ti_sysbios_timers_dmtimer_Timer_setAvailMask")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setAvailMask__E( xdc_UArg arg );
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_setAvailMask__F, "ti_sysbios_timers_dmtimer_Timer_setAvailMask")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setAvailMask__F( xdc_UArg arg );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_setAvailMask__R( xdc_UArg arg );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_reconfig__F, "ti_sysbios_timers_dmtimer_Timer_reconfig")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_reconfig__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst, ti_sysbios_timers_dmtimer_Timer_FuncPtr tickFxn, const ti_sysbios_timers_dmtimer_Timer_Params* timerParams, xdc_runtime_Error_Block* eb );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_reconfig__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst, ti_sysbios_timers_dmtimer_Timer_FuncPtr tickFxn, const ti_sysbios_timers_dmtimer_Timer_Params* timerParams, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_getRollovers__F, "ti_sysbios_timers_dmtimer_Timer_getRollovers")
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getRollovers__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst );
__extern xdc_UInt32 ti_sysbios_timers_dmtimer_Timer_getRollovers__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst );
...
xdc__CODESECT(ti_sysbios_timers_dmtimer_Timer_enableTimestamping__F, "ti_sysbios_timers_dmtimer_Timer_enableTimestamping")
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_enableTimestamping__F( ti_sysbios_timers_dmtimer_Timer_Object* __inst );
__extern xdc_Void ti_sysbios_timers_dmtimer_Timer_enableTimestamping__R( ti_sysbios_timers_dmtimer_Timer_Handle __inst );
...
typedef xdc_UInt32 (*ti_sysbios_timers_dmtimer_Timer_getMaxTicks_FxnT)(void*, xdc_UInt32);
static inline ti_sysbios_timers_dmtimer_Timer_getMaxTicks_FxnT ti_sysbios_timers_dmtimer_Timer_getMaxTicks_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_getMaxTicks_FxnT)ti_sysbios_timers_dmtimer_Timer_getMaxTicks; 
}

/* setNextTick_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_setNextTick_FxnT)(void*, xdc_UInt32, xdc_UInt32);
static inline ti_sysbios_timers_dmtimer_Timer_setNextTick_FxnT ti_sysbios_timers_dmtimer_Timer_setNextTick_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_setNextTick_FxnT)ti_sysbios_timers_dmtimer_Timer_setNextTick; 
}

/* start_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_start_FxnT)(void*);
static inline ti_sysbios_timers_dmtimer_Timer_start_FxnT ti_sysbios_timers_dmtimer_Timer_start_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_start_FxnT)ti_sysbios_timers_dmtimer_Timer_start; 
}

/* stop_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_stop_FxnT)(void*);
static inline ti_sysbios_timers_dmtimer_Timer_stop_FxnT ti_sysbios_timers_dmtimer_Timer_stop_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_stop_FxnT)ti_sysbios_timers_dmtimer_Timer_stop; 
}

/* setPeriod_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_setPeriod_FxnT)(void*, xdc_UInt32);
static inline ti_sysbios_timers_dmtimer_Timer_setPeriod_FxnT ti_sysbios_timers_dmtimer_Timer_setPeriod_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_setPeriod_FxnT)ti_sysbios_timers_dmtimer_Timer_setPeriod; 
}

/* setPeriodMicroSecs_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs_FxnT)(void*, xdc_UInt32);
static inline ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs_FxnT ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs_FxnT)ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs; 
}

/* getPeriod_{FxnT,fxnP} */
typedef xdc_UInt32 (*ti_sysbios_timers_dmtimer_Timer_getPeriod_FxnT)(void*);
static inline ti_sysbios_timers_dmtimer_Timer_getPeriod_FxnT ti_sysbios_timers_dmtimer_Timer_getPeriod_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_getPeriod_FxnT)ti_sysbios_timers_dmtimer_Timer_getPeriod; 
}

/* getCount_{FxnT,fxnP} */
typedef xdc_UInt32 (*ti_sysbios_timers_dmtimer_Timer_getCount_FxnT)(void*);
static inline ti_sysbios_timers_dmtimer_Timer_getCount_FxnT ti_sysbios_timers_dmtimer_Timer_getCount_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_getCount_FxnT)ti_sysbios_timers_dmtimer_Timer_getCount; 
}

/* getFreq_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_getFreq_FxnT)(void*, xdc_runtime_Types_FreqHz*);
static inline ti_sysbios_timers_dmtimer_Timer_getFreq_FxnT ti_sysbios_timers_dmtimer_Timer_getFreq_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_getFreq_FxnT)ti_sysbios_timers_dmtimer_Timer_getFreq; 
}

/* getFunc_{FxnT,fxnP} */
typedef ti_sysbios_interfaces_ITimer_FuncPtr (*ti_sysbios_timers_dmtimer_Timer_getFunc_FxnT)(void*, xdc_UArg*);
static inline ti_sysbios_timers_dmtimer_Timer_getFunc_FxnT ti_sysbios_timers_dmtimer_Timer_getFunc_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_getFunc_FxnT)ti_sysbios_timers_dmtimer_Timer_getFunc; 
}

/* setFunc_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_setFunc_FxnT)(void*, ti_sysbios_interfaces_ITimer_FuncPtr, xdc_UArg);
static inline ti_sysbios_timers_dmtimer_Timer_setFunc_FxnT ti_sysbios_timers_dmtimer_Timer_setFunc_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_setFunc_FxnT)ti_sysbios_timers_dmtimer_Timer_setFunc; 
}

/* trigger_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_trigger_FxnT)(void*, xdc_UInt32);
static inline ti_sysbios_timers_dmtimer_Timer_trigger_FxnT ti_sysbios_timers_dmtimer_Timer_trigger_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_trigger_FxnT)ti_sysbios_timers_dmtimer_Timer_trigger; 
}

/* getExpiredCounts_{FxnT,fxnP} */
typedef xdc_UInt32 (*ti_sysbios_timers_dmtimer_Timer_getExpiredCounts_FxnT)(void*);
static inline ti_sysbios_timers_dmtimer_Timer_getExpiredCounts_FxnT ti_sysbios_timers_dmtimer_Timer_getExpiredCounts_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_getExpiredCounts_FxnT)ti_sysbios_timers_dmtimer_Timer_getExpiredCounts; 
}

/* reconfig_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_reconfig_FxnT)(void*, ti_sysbios_timers_dmtimer_Timer_FuncPtr, const ti_sysbios_timers_dmtimer_Timer_Params*, xdc_runtime_Error_Block*);
static inline ti_sysbios_timers_dmtimer_Timer_reconfig_FxnT ti_sysbios_timers_dmtimer_Timer_reconfig_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_reconfig_FxnT)ti_sysbios_timers_dmtimer_Timer_reconfig; 
}

/* getRollovers_{FxnT,fxnP} */
typedef xdc_UInt32 (*ti_sysbios_timers_dmtimer_Timer_getRollovers_FxnT)(void*);
static inline ti_sysbios_timers_dmtimer_Timer_getRollovers_FxnT ti_sysbios_timers_dmtimer_Timer_getRollovers_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_getRollovers_FxnT)ti_sysbios_timers_dmtimer_Timer_getRollovers; 
}

/* enableTimestamping_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_timers_dmtimer_Timer_enableTimestamping_FxnT)(void*);
static inline ti_sysbios_timers_dmtimer_Timer_enableTimestamping_FxnT ti_sysbios_timers_dmtimer_Timer_enableTimestamping_fxnP( void )
{
    return (ti_sysbios_timers_dmtimer_Timer_enableTimestamping_FxnT)ti_sysbios_timers_dmtimer_Timer_enableTimestamping; 
}
...
{
    if (dst) {
        ti_sysbios_timers_dmtimer_Timer_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_timers_dmtimer_Timer_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sysbios_timers_dmtimer_Timer_Handle_name( ti_sysbios_timers_dmtimer_Timer_Handle inst )
{
...
/* create */
static inline ti_sysbios_timers_dmtimer_Timer_Handle ti_sysbios_timers_dmtimer_Timer_create( xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_timers_dmtimer_Timer_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_timers_dmtimer_Timer_Args__create __args;
    __args.id = id;
    __args.tickFxn = tickFxn;
    return (ti_sysbios_timers_dmtimer_Timer_Handle)ti_sysbios_timers_dmtimer_Timer_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_timers_dmtimer_Timer_Params), __eb);
}

/* construct */
static inline void ti_sysbios_timers_dmtimer_Timer_construct( ti_sysbios_timers_dmtimer_Timer_Struct* __obj, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_timers_dmtimer_Timer_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_timers_dmtimer_Timer_Args__create __args;
    __args.id = id;
    __args.tickFxn = tickFxn;
    ti_sysbios_timers_dmtimer_Timer_Object__create__S(__obj, sizeof (ti_sysbios_timers_dmtimer_Timer_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_timers_dmtimer_Timer_Params), __eb);
}

/* delete */
static inline void ti_sysbios_timers_dmtimer_Timer_delete( ti_sysbios_timers_dmtimer_Timer_Handle* instp )
{
    ti_sysbios_timers_dmtimer_Timer_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_timers_dmtimer_Timer_destruct( ti_sysbios_timers_dmtimer_Timer_Struct* obj )
{
...
#define Timer_getMaxTicks_fxnP ti_sysbios_timers_dmtimer_Timer_getMaxTicks_fxnP
#define Timer_getMaxTicks_FxnT ti_sysbios_timers_dmtimer_Timer_getMaxTicks_FxnT
#define Timer_setNextTick ti_sysbios_timers_dmtimer_Timer_setNextTick
#define Timer_setNextTick_fxnP ti_sysbios_timers_dmtimer_Timer_setNextTick_fxnP
#define Timer_setNextTick_FxnT ti_sysbios_timers_dmtimer_Timer_setNextTick_FxnT
#define Timer_start ti_sysbios_timers_dmtimer_Timer_start
#define Timer_start_fxnP ti_sysbios_timers_dmtimer_Timer_start_fxnP
#define Timer_start_FxnT ti_sysbios_timers_dmtimer_Timer_start_FxnT
#define Timer_stop ti_sysbios_timers_dmtimer_Timer_stop
#define Timer_stop_fxnP ti_sysbios_timers_dmtimer_Timer_stop_fxnP
#define Timer_stop_FxnT ti_sysbios_timers_dmtimer_Timer_stop_FxnT
#define Timer_setPeriod ti_sysbios_timers_dmtimer_Timer_setPeriod
#define Timer_setPeriod_fxnP ti_sysbios_timers_dmtimer_Timer_setPeriod_fxnP
#define Timer_setPeriod_FxnT ti_sysbios_timers_dmtimer_Timer_setPeriod_FxnT
#define Timer_setPeriodMicroSecs ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs
#define Timer_setPeriodMicroSecs_fxnP ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs_fxnP
#define Timer_setPeriodMicroSecs_FxnT ti_sysbios_timers_dmtimer_Timer_setPeriodMicroSecs_FxnT
#define Timer_getPeriod ti_sysbios_timers_dmtimer_Timer_getPeriod
#define Timer_getPeriod_fxnP ti_sysbios_timers_dmtimer_Timer_getPeriod_fxnP
#define Timer_getPeriod_FxnT ti_sysbios_timers_dmtimer_Timer_getPeriod_FxnT
#define Timer_getCount ti_sysbios_timers_dmtimer_Timer_getCount
#define Timer_getCount_fxnP ti_sysbios_timers_dmtimer_Timer_getCount_fxnP
#define Timer_getCount_FxnT ti_sysbios_timers_dmtimer_Timer_getCount_FxnT
#define Timer_getFreq ti_sysbios_timers_dmtimer_Timer_getFreq
#define Timer_getFreq_fxnP ti_sysbios_timers_dmtimer_Timer_getFreq_fxnP
#define Timer_getFreq_FxnT ti_sysbios_timers_dmtimer_Timer_getFreq_FxnT
#define Timer_getFunc ti_sysbios_timers_dmtimer_Timer_getFunc
#define Timer_getFunc_fxnP ti_sysbios_timers_dmtimer_Timer_getFunc_fxnP
#define Timer_getFunc_FxnT ti_sysbios_timers_dmtimer_Timer_getFunc_FxnT
#define Timer_setFunc ti_sysbios_timers_dmtimer_Timer_setFunc
#define Timer_setFunc_fxnP ti_sysbios_timers_dmtimer_Timer_setFunc_fxnP
#define Timer_setFunc_FxnT ti_sysbios_timers_dmtimer_Timer_setFunc_FxnT
#define Timer_trigger ti_sysbios_timers_dmtimer_Timer_trigger
#define Timer_trigger_fxnP ti_sysbios_timers_dmtimer_Timer_trigger_fxnP
#define Timer_trigger_FxnT ti_sysbios_timers_dmtimer_Timer_trigger_FxnT
#define Timer_getExpiredCounts ti_sysbios_timers_dmtimer_Timer_getExpiredCounts
#define Timer_getExpiredCounts_fxnP ti_sysbios_timers_dmtimer_Timer_getExpiredCounts_fxnP
#define Timer_getExpiredCounts_FxnT ti_sysbios_timers_dmtimer_Timer_getExpiredCounts_FxnT
#define Timer_stub ti_sysbios_timers_dmtimer_Timer_stub
#define Timer_dynStub ti_sysbios_timers_dmtimer_Timer_dynStub
#define Timer_setAvailMask ti_sysbios_timers_dmtimer_Timer_setAvailMask
#define Timer_reconfig ti_sysbios_timers_dmtimer_Timer_reconfig
#define Timer_reconfig_fxnP ti_sysbios_timers_dmtimer_Timer_reconfig_fxnP
#define Timer_reconfig_FxnT ti_sysbios_timers_dmtimer_Timer_reconfig_FxnT
#define Timer_getRollovers ti_sysbios_timers_dmtimer_Timer_getRollovers
#define Timer_getRollovers_fxnP ti_sysbios_timers_dmtimer_Timer_getRollovers_fxnP
#define Timer_getRollovers_FxnT ti_sysbios_timers_dmtimer_Timer_getRollovers_FxnT
#define Timer_enableTimestamping ti_sysbios_timers_dmtimer_Timer_enableTimestamping
#define Timer_enableTimestamping_fxnP ti_sysbios_timers_dmtimer_Timer_enableTimestamping_fxnP
#define Timer_enableTimestamping_FxnT ti_sysbios_timers_dmtimer_Timer_enableTimestamping_FxnT
