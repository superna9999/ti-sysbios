...
public class ti_sysbios_timers_dmtimer
{
    ...
    void Timer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.timers.dmtimer.Timer.Object", new Proto.Str(po, false));
    ...
    void Timer$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.timers.dmtimer.Timer.setAvailMask", new Extern("ti_sysbios_timers_dmtimer_Timer_setAvailMask__E", "xdc_Void(*)(xdc_UArg)", true, false));
    ...
    void Timer$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("tsicr", (Proto)om.findStrict("ti.sysbios.timers.dmtimer.Timer.Tsicr", "ti.sysbios.timers.dmtimer"), Global.newObject("sft", 0L, "posted", 1L), "w");
        ...
        po.init("ti.sysbios.timers.dmtimer.Timer.Module_State", null);
                ...
                po.addFld("intFreq", (Proto)om.findStrict("xdc.runtime.Types.FreqHz", "ti.sysbios.timers.dmtimer"), $$DEFAULT, "w");
    ...
    void TimestampProvider$$TYPES()
    {
        ...
        po.init("ti.sysbios.timers.dmtimer.TimestampProvider.Module", om.findStrict("xdc.runtime.ITimestampProvider.Module", "ti.sysbios.timers.dmtimer"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.a64P',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.a64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.a674',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.ae64T',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.timers.dmtimer.aea8f',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.timers.dmtimer.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
    ...
    void Timer$$SINGLETONS()
    {
        ...
        vo.bind("setAvailMask", om.findStrict("ti.sysbios.timers.dmtimer.Timer.setAvailMask", "ti.sysbios.timers.dmtimer"));
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "setAvailMask", "entry", "%p", "exit", ""));
