 ...
 *  when an error occurs. This is shown in the Timer_create(0 call when the 
...
Void task1(UArg arg0, UArg arg1)
{
    ...
    /*
     * Showing a case where a Timer_create is called but no
     * Error_Block is passed
     * This Timer_create() will fail because timerId of zero
     * is used by ti.sysbios.knl.Clock.
     */
    Timer_create(0, timerFxn, &timerParams, NULL);
}
