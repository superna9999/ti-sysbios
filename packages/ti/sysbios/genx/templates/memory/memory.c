...
#define TASK0BUFSIZE    128     /* size of allocations */
...
#define TASK1BUFSIZE2   256     /* size of allocation */
...
Void main()
{
    ...
    /* 
     *  Setting the stackSize to a value that is functional for any device, 
     *  but not necessarily optimal. Please use ROV to help optimize your
     *  stackSize.
     */ 
    Task_Params_init(&taskParams);
    taskParams.stackSize = 1024;
    Task_create(task1Fxn, &taskParams, NULL);
