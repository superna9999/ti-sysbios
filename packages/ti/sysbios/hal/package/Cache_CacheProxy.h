...
#define ti_sysbios_hal_Cache_CacheProxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Handle__label__S, "ti_sysbios_hal_Cache_CacheProxy_Handle__label")
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Module__startupDone__S, "ti_sysbios_hal_Cache_CacheProxy_Module__startupDone")
__extern xdc_Bool ti_sysbios_hal_Cache_CacheProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Object__create__S, "ti_sysbios_hal_Cache_CacheProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Object__delete__S, "ti_sysbios_hal_Cache_CacheProxy_Object__delete")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Object__destruct__S, "ti_sysbios_hal_Cache_CacheProxy_Object__destruct")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Object__get__S, "ti_sysbios_hal_Cache_CacheProxy_Object__get")
__extern xdc_Ptr ti_sysbios_hal_Cache_CacheProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Object__first__S, "ti_sysbios_hal_Cache_CacheProxy_Object__first")
__extern xdc_Ptr ti_sysbios_hal_Cache_CacheProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Object__next__S, "ti_sysbios_hal_Cache_CacheProxy_Object__next")
__extern xdc_Ptr ti_sysbios_hal_Cache_CacheProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Params__init__S, "ti_sysbios_hal_Cache_CacheProxy_Params__init")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Proxy__abstract__S, "ti_sysbios_hal_Cache_CacheProxy_Proxy__abstract")
__extern xdc_Bool ti_sysbios_hal_Cache_CacheProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_Proxy__delegate__S, "ti_sysbios_hal_Cache_CacheProxy_Proxy__delegate")
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_enable__R, "ti_sysbios_hal_Cache_CacheProxy_enable")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_enable__R( xdc_Bits16 type );
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_disable__R, "ti_sysbios_hal_Cache_CacheProxy_disable")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_disable__R( xdc_Bits16 type );
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_inv__R, "ti_sysbios_hal_Cache_CacheProxy_inv")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_inv__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bits16 type, xdc_Bool wait );
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_wb__R, "ti_sysbios_hal_Cache_CacheProxy_wb")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_wb__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bits16 type, xdc_Bool wait );
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_wbInv__R, "ti_sysbios_hal_Cache_CacheProxy_wbInv")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_wbInv__R( xdc_Ptr blockPtr, xdc_SizeT byteCnt, xdc_Bits16 type, xdc_Bool wait );
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_wbAll__R, "ti_sysbios_hal_Cache_CacheProxy_wbAll")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_wbAll__R( void );
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_wbInvAll__R, "ti_sysbios_hal_Cache_CacheProxy_wbInvAll")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_wbInvAll__R( void );
...
xdc__CODESECT(ti_sysbios_hal_Cache_CacheProxy_wait__R, "ti_sysbios_hal_Cache_CacheProxy_wait")
__extern xdc_Void ti_sysbios_hal_Cache_CacheProxy_wait__R( void );
