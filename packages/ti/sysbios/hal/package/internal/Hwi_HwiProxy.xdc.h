...
#define ti_sysbios_hal_Hwi_HwiProxy_getStackInfo ti_sysbios_hal_Hwi_HwiProxy_getStackInfo__F
...
#define ti_sysbios_hal_Hwi_HwiProxy_disable ti_sysbios_hal_Hwi_HwiProxy_disable__F

/* enable */
#undef ti_sysbios_hal_Hwi_HwiProxy_enable
#define ti_sysbios_hal_Hwi_HwiProxy_enable ti_sysbios_hal_Hwi_HwiProxy_enable__F

/* restore */
#undef ti_sysbios_hal_Hwi_HwiProxy_restore
#define ti_sysbios_hal_Hwi_HwiProxy_restore ti_sysbios_hal_Hwi_HwiProxy_restore__F
...
#define ti_sysbios_hal_Hwi_HwiProxy_Module_startup ti_sysbios_hal_Hwi_HwiProxy_Module_startup__F

/* Instance_init */
#undef ti_sysbios_hal_Hwi_HwiProxy_Instance_init
#define ti_sysbios_hal_Hwi_HwiProxy_Instance_init ti_sysbios_hal_Hwi_HwiProxy_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_hal_Hwi_HwiProxy_Instance_finalize
#define ti_sysbios_hal_Hwi_HwiProxy_Instance_finalize ti_sysbios_hal_Hwi_HwiProxy_Instance_finalize__F
