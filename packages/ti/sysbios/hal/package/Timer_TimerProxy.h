...
#define ti_sysbios_hal_Timer_TimerProxy___VERS 150
...
__extern __FAR__ const CT__ti_sysbios_hal_Timer_TimerProxy_Module__startupDoneFxn ti_sysbios_hal_Timer_TimerProxy_Module__startupDoneFxn__C;
...
struct ti_sysbios_hal_Timer_TimerProxy_Fxns__ {
    ...
    xdc_Void (*setNextTick)(ti_sysbios_hal_Timer_TimerProxy_Handle, xdc_UInt32, xdc_UInt32);
    xdc_Void (*start)(ti_sysbios_hal_Timer_TimerProxy_Handle);
    xdc_Void (*stop)(ti_sysbios_hal_Timer_TimerProxy_Handle);
    xdc_Void (*setPeriod)(ti_sysbios_hal_Timer_TimerProxy_Handle, xdc_UInt32);
    ...
    xdc_Void (*getFreq)(ti_sysbios_hal_Timer_TimerProxy_Handle, xdc_runtime_Types_FreqHz*);
    ti_sysbios_interfaces_ITimer_FuncPtr (*getFunc)(ti_sysbios_hal_Timer_TimerProxy_Handle, xdc_UArg*);
    xdc_Void (*setFunc)(ti_sysbios_hal_Timer_TimerProxy_Handle, ti_sysbios_interfaces_ITimer_FuncPtr, xdc_UArg);
    xdc_Void (*trigger)(ti_sysbios_hal_Timer_TimerProxy_Handle, xdc_UInt32);
...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Handle__label__S, "ti_sysbios_hal_Timer_TimerProxy_Handle__label")
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Module__startupDone__S, "ti_sysbios_hal_Timer_TimerProxy_Module__startupDone")
__extern xdc_Bool ti_sysbios_hal_Timer_TimerProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__create__S, "ti_sysbios_hal_Timer_TimerProxy_Object__create")
__extern xdc_Ptr ti_sysbios_hal_Timer_TimerProxy_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar* __pa, xdc_SizeT __psz, xdc_runtime_Error_Block* __eb );

/* Object__delete__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__delete__S, "ti_sysbios_hal_Timer_TimerProxy_Object__delete")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__destruct__S, "ti_sysbios_hal_Timer_TimerProxy_Object__destruct")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__get__S, "ti_sysbios_hal_Timer_TimerProxy_Object__get")
__extern xdc_Ptr ti_sysbios_hal_Timer_TimerProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__first__S, "ti_sysbios_hal_Timer_TimerProxy_Object__first")
__extern xdc_Ptr ti_sysbios_hal_Timer_TimerProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__next__S, "ti_sysbios_hal_Timer_TimerProxy_Object__next")
__extern xdc_Ptr ti_sysbios_hal_Timer_TimerProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Params__init__S, "ti_sysbios_hal_Timer_TimerProxy_Params__init")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Proxy__abstract__S, "ti_sysbios_hal_Timer_TimerProxy_Proxy__abstract")
__extern xdc_Bool ti_sysbios_hal_Timer_TimerProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Proxy__delegate__S, "ti_sysbios_hal_Timer_TimerProxy_Proxy__delegate")
__extern xdc_Ptr ti_sysbios_hal_Timer_TimerProxy_Proxy__delegate__S( void );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getNumTimers__R, "ti_sysbios_hal_Timer_TimerProxy_getNumTimers")
__extern xdc_UInt ti_sysbios_hal_Timer_TimerProxy_getNumTimers__R( void );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getStatus__R, "ti_sysbios_hal_Timer_TimerProxy_getStatus")
__extern ti_sysbios_interfaces_ITimer_Status ti_sysbios_hal_Timer_TimerProxy_getStatus__R( xdc_UInt id );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_startup__R, "ti_sysbios_hal_Timer_TimerProxy_startup")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_startup__R( void );
...
__extern xdc_UInt32 ti_sysbios_hal_Timer_TimerProxy_getMaxTicks__E( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 periodCounts );
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getMaxTicks__R, "ti_sysbios_hal_Timer_TimerProxy_getMaxTicks")
__extern xdc_UInt32 ti_sysbios_hal_Timer_TimerProxy_getMaxTicks__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 periodCounts );
...
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_setNextTick__E( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 newPeriod, xdc_UInt32 countsPerTick );
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_setNextTick__R, "ti_sysbios_hal_Timer_TimerProxy_setNextTick")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_setNextTick__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 newPeriod, xdc_UInt32 countsPerTick );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_start__R, "ti_sysbios_hal_Timer_TimerProxy_start")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_start__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_stop__R, "ti_sysbios_hal_Timer_TimerProxy_stop")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_stop__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_setPeriod__R, "ti_sysbios_hal_Timer_TimerProxy_setPeriod")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_setPeriod__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 period );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_setPeriodMicroSecs__R, "ti_sysbios_hal_Timer_TimerProxy_setPeriodMicroSecs")
__extern xdc_Bool ti_sysbios_hal_Timer_TimerProxy_setPeriodMicroSecs__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 microsecs );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getPeriod__R, "ti_sysbios_hal_Timer_TimerProxy_getPeriod")
__extern xdc_UInt32 ti_sysbios_hal_Timer_TimerProxy_getPeriod__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getCount__R, "ti_sysbios_hal_Timer_TimerProxy_getCount")
__extern xdc_UInt32 ti_sysbios_hal_Timer_TimerProxy_getCount__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getFreq__R, "ti_sysbios_hal_Timer_TimerProxy_getFreq")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_getFreq__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_runtime_Types_FreqHz* freq );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getFunc__R, "ti_sysbios_hal_Timer_TimerProxy_getFunc")
__extern ti_sysbios_interfaces_ITimer_FuncPtr ti_sysbios_hal_Timer_TimerProxy_getFunc__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UArg* arg );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_setFunc__R, "ti_sysbios_hal_Timer_TimerProxy_setFunc")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_setFunc__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_trigger__R, "ti_sysbios_hal_Timer_TimerProxy_trigger")
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_trigger__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 cycles );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getExpiredCounts__R, "ti_sysbios_hal_Timer_TimerProxy_getExpiredCounts")
__extern xdc_UInt32 ti_sysbios_hal_Timer_TimerProxy_getExpiredCounts__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst );
...
{
    return (ti_sysbios_hal_Timer_TimerProxy_getMaxTicks_FxnT)ti_sysbios_hal_Timer_TimerProxy_getMaxTicks; 
}

/* setNextTick_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Timer_TimerProxy_setNextTick_FxnT)(void*, xdc_UInt32, xdc_UInt32);
static inline ti_sysbios_hal_Timer_TimerProxy_setNextTick_FxnT ti_sysbios_hal_Timer_TimerProxy_setNextTick_fxnP( void )
{
    return (ti_sysbios_hal_Timer_TimerProxy_setNextTick_FxnT)ti_sysbios_hal_Timer_TimerProxy_setNextTick; 
}

/* start_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Timer_TimerProxy_start_FxnT)(void*);
static inline ti_sysbios_hal_Timer_TimerProxy_start_FxnT ti_sysbios_hal_Timer_TimerProxy_start_fxnP( void )
{
    return (ti_sysbios_hal_Timer_TimerProxy_start_FxnT)ti_sysbios_hal_Timer_TimerProxy_start; 
}

/* stop_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Timer_TimerProxy_stop_FxnT)(void*);
static inline ti_sysbios_hal_Timer_TimerProxy_stop_FxnT ti_sysbios_hal_Timer_TimerProxy_stop_fxnP( void )
{
    return (ti_sysbios_hal_Timer_TimerProxy_stop_FxnT)ti_sysbios_hal_Timer_TimerProxy_stop; 
}

/* setPeriod_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Timer_TimerProxy_setPeriod_FxnT)(void*, xdc_UInt32);
static inline ti_sysbios_hal_Timer_TimerProxy_setPeriod_FxnT ti_sysbios_hal_Timer_TimerProxy_setPeriod_fxnP( void )
{
    return (ti_sysbios_hal_Timer_TimerProxy_setPeriod_FxnT)ti_sysbios_hal_Timer_TimerProxy_setPeriod; 
}
...
{
    return (ti_sysbios_hal_Timer_TimerProxy_setPeriodMicroSecs_FxnT)ti_sysbios_hal_Timer_TimerProxy_setPeriodMicroSecs; 
}
...
{
    return (ti_sysbios_hal_Timer_TimerProxy_getPeriod_FxnT)ti_sysbios_hal_Timer_TimerProxy_getPeriod; 
}
...
{
    return (ti_sysbios_hal_Timer_TimerProxy_getCount_FxnT)ti_sysbios_hal_Timer_TimerProxy_getCount; 
}

/* getFreq_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Timer_TimerProxy_getFreq_FxnT)(void*, xdc_runtime_Types_FreqHz*);
static inline ti_sysbios_hal_Timer_TimerProxy_getFreq_FxnT ti_sysbios_hal_Timer_TimerProxy_getFreq_fxnP( void )
{
    return (ti_sysbios_hal_Timer_TimerProxy_getFreq_FxnT)ti_sysbios_hal_Timer_TimerProxy_getFreq; 
}
...
{
    return (ti_sysbios_hal_Timer_TimerProxy_getFunc_FxnT)ti_sysbios_hal_Timer_TimerProxy_getFunc; 
}

/* setFunc_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Timer_TimerProxy_setFunc_FxnT)(void*, ti_sysbios_interfaces_ITimer_FuncPtr, xdc_UArg);
static inline ti_sysbios_hal_Timer_TimerProxy_setFunc_FxnT ti_sysbios_hal_Timer_TimerProxy_setFunc_fxnP( void )
{
    return (ti_sysbios_hal_Timer_TimerProxy_setFunc_FxnT)ti_sysbios_hal_Timer_TimerProxy_setFunc; 
}

/* trigger_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Timer_TimerProxy_trigger_FxnT)(void*, xdc_UInt32);
static inline ti_sysbios_hal_Timer_TimerProxy_trigger_FxnT ti_sysbios_hal_Timer_TimerProxy_trigger_fxnP( void )
{
    return (ti_sysbios_hal_Timer_TimerProxy_trigger_FxnT)ti_sysbios_hal_Timer_TimerProxy_trigger; 
}
...
{
    return (ti_sysbios_hal_Timer_TimerProxy_getExpiredCounts_FxnT)ti_sysbios_hal_Timer_TimerProxy_getExpiredCounts; 
}
...
#define Timer_TimerProxy_getMaxTicks_fxnP ti_sysbios_hal_Timer_TimerProxy_getMaxTicks_fxnP
#define Timer_TimerProxy_getMaxTicks_FxnT ti_sysbios_hal_Timer_TimerProxy_getMaxTicks_FxnT
#define Timer_TimerProxy_setNextTick ti_sysbios_hal_Timer_TimerProxy_setNextTick
#define Timer_TimerProxy_setNextTick_fxnP ti_sysbios_hal_Timer_TimerProxy_setNextTick_fxnP
#define Timer_TimerProxy_setNextTick_FxnT ti_sysbios_hal_Timer_TimerProxy_setNextTick_FxnT
#define Timer_TimerProxy_start ti_sysbios_hal_Timer_TimerProxy_start
#define Timer_TimerProxy_start_fxnP ti_sysbios_hal_Timer_TimerProxy_start_fxnP
#define Timer_TimerProxy_start_FxnT ti_sysbios_hal_Timer_TimerProxy_start_FxnT
#define Timer_TimerProxy_stop ti_sysbios_hal_Timer_TimerProxy_stop
#define Timer_TimerProxy_stop_fxnP ti_sysbios_hal_Timer_TimerProxy_stop_fxnP
#define Timer_TimerProxy_stop_FxnT ti_sysbios_hal_Timer_TimerProxy_stop_FxnT
#define Timer_TimerProxy_setPeriod ti_sysbios_hal_Timer_TimerProxy_setPeriod
#define Timer_TimerProxy_setPeriod_fxnP ti_sysbios_hal_Timer_TimerProxy_setPeriod_fxnP
#define Timer_TimerProxy_setPeriod_FxnT ti_sysbios_hal_Timer_TimerProxy_setPeriod_FxnT
#define Timer_TimerProxy_setPeriodMicroSecs ti_sysbios_hal_Timer_TimerProxy_setPeriodMicroSecs
#define Timer_TimerProxy_setPeriodMicroSecs_fxnP ti_sysbios_hal_Timer_TimerProxy_setPeriodMicroSecs_fxnP
#define Timer_TimerProxy_setPeriodMicroSecs_FxnT ti_sysbios_hal_Timer_TimerProxy_setPeriodMicroSecs_FxnT
#define Timer_TimerProxy_getPeriod ti_sysbios_hal_Timer_TimerProxy_getPeriod
#define Timer_TimerProxy_getPeriod_fxnP ti_sysbios_hal_Timer_TimerProxy_getPeriod_fxnP
#define Timer_TimerProxy_getPeriod_FxnT ti_sysbios_hal_Timer_TimerProxy_getPeriod_FxnT
#define Timer_TimerProxy_getCount ti_sysbios_hal_Timer_TimerProxy_getCount
#define Timer_TimerProxy_getCount_fxnP ti_sysbios_hal_Timer_TimerProxy_getCount_fxnP
#define Timer_TimerProxy_getCount_FxnT ti_sysbios_hal_Timer_TimerProxy_getCount_FxnT
#define Timer_TimerProxy_getFreq ti_sysbios_hal_Timer_TimerProxy_getFreq
#define Timer_TimerProxy_getFreq_fxnP ti_sysbios_hal_Timer_TimerProxy_getFreq_fxnP
#define Timer_TimerProxy_getFreq_FxnT ti_sysbios_hal_Timer_TimerProxy_getFreq_FxnT
#define Timer_TimerProxy_getFunc ti_sysbios_hal_Timer_TimerProxy_getFunc
#define Timer_TimerProxy_getFunc_fxnP ti_sysbios_hal_Timer_TimerProxy_getFunc_fxnP
#define Timer_TimerProxy_getFunc_FxnT ti_sysbios_hal_Timer_TimerProxy_getFunc_FxnT
#define Timer_TimerProxy_setFunc ti_sysbios_hal_Timer_TimerProxy_setFunc
#define Timer_TimerProxy_setFunc_fxnP ti_sysbios_hal_Timer_TimerProxy_setFunc_fxnP
#define Timer_TimerProxy_setFunc_FxnT ti_sysbios_hal_Timer_TimerProxy_setFunc_FxnT
#define Timer_TimerProxy_trigger ti_sysbios_hal_Timer_TimerProxy_trigger
#define Timer_TimerProxy_trigger_fxnP ti_sysbios_hal_Timer_TimerProxy_trigger_fxnP
#define Timer_TimerProxy_trigger_FxnT ti_sysbios_hal_Timer_TimerProxy_trigger_FxnT
#define Timer_TimerProxy_getExpiredCounts ti_sysbios_hal_Timer_TimerProxy_getExpiredCounts
#define Timer_TimerProxy_getExpiredCounts_fxnP ti_sysbios_hal_Timer_TimerProxy_getExpiredCounts_fxnP
#define Timer_TimerProxy_getExpiredCounts_FxnT ti_sysbios_hal_Timer_TimerProxy_getExpiredCounts_FxnT
