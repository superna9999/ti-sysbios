...
#define ti_sysbios_hal_Hwi_HwiProxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Handle__label__S, "ti_sysbios_hal_Hwi_HwiProxy_Handle__label")
...
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Module__startupDone__S, "ti_sysbios_hal_Hwi_HwiProxy_Module__startupDone")
__extern xdc_Bool ti_sysbios_hal_Hwi_HwiProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Object__create__S, "ti_sysbios_hal_Hwi_HwiProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Object__delete__S, "ti_sysbios_hal_Hwi_HwiProxy_Object__delete")
__extern xdc_Void ti_sysbios_hal_Hwi_HwiProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Object__destruct__S, "ti_sysbios_hal_Hwi_HwiProxy_Object__destruct")
__extern xdc_Void ti_sysbios_hal_Hwi_HwiProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Object__get__S, "ti_sysbios_hal_Hwi_HwiProxy_Object__get")
__extern xdc_Ptr ti_sysbios_hal_Hwi_HwiProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Object__first__S, "ti_sysbios_hal_Hwi_HwiProxy_Object__first")
__extern xdc_Ptr ti_sysbios_hal_Hwi_HwiProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Object__next__S, "ti_sysbios_hal_Hwi_HwiProxy_Object__next")
__extern xdc_Ptr ti_sysbios_hal_Hwi_HwiProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Params__init__S, "ti_sysbios_hal_Hwi_HwiProxy_Params__init")
__extern xdc_Void ti_sysbios_hal_Hwi_HwiProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Proxy__abstract__S, "ti_sysbios_hal_Hwi_HwiProxy_Proxy__abstract")
__extern xdc_Bool ti_sysbios_hal_Hwi_HwiProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_sysbios_hal_Hwi_HwiProxy_Proxy__delegate__S, "ti_sysbios_hal_Hwi_HwiProxy_Proxy__delegate")
...
{
    return (ti_sysbios_hal_Hwi_HwiProxy_getFunc_FxnT)ti_sysbios_hal_Hwi_HwiProxy_getFunc; 
}

/* setFunc_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Hwi_HwiProxy_setFunc_FxnT)(void*, ti_sysbios_interfaces_IHwi_FuncPtr, xdc_UArg);
static inline ti_sysbios_hal_Hwi_HwiProxy_setFunc_FxnT ti_sysbios_hal_Hwi_HwiProxy_setFunc_fxnP( void )
{
    return (ti_sysbios_hal_Hwi_HwiProxy_setFunc_FxnT)ti_sysbios_hal_Hwi_HwiProxy_setFunc; 
}
...
{
    return (ti_sysbios_hal_Hwi_HwiProxy_getHookContext_FxnT)ti_sysbios_hal_Hwi_HwiProxy_getHookContext; 
}

/* setHookContext_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_hal_Hwi_HwiProxy_setHookContext_FxnT)(void*, xdc_Int, xdc_Ptr);
static inline ti_sysbios_hal_Hwi_HwiProxy_setHookContext_FxnT ti_sysbios_hal_Hwi_HwiProxy_setHookContext_fxnP( void )
{
    return (ti_sysbios_hal_Hwi_HwiProxy_setHookContext_FxnT)ti_sysbios_hal_Hwi_HwiProxy_setHookContext; 
}
...
{
    return (ti_sysbios_hal_Hwi_HwiProxy_getIrp_FxnT)ti_sysbios_hal_Hwi_HwiProxy_getIrp; 
}
...
#define Hwi_HwiProxy_getFunc_fxnP ti_sysbios_hal_Hwi_HwiProxy_getFunc_fxnP
#define Hwi_HwiProxy_getFunc_FxnT ti_sysbios_hal_Hwi_HwiProxy_getFunc_FxnT
#define Hwi_HwiProxy_setFunc ti_sysbios_hal_Hwi_HwiProxy_setFunc
#define Hwi_HwiProxy_setFunc_fxnP ti_sysbios_hal_Hwi_HwiProxy_setFunc_fxnP
#define Hwi_HwiProxy_setFunc_FxnT ti_sysbios_hal_Hwi_HwiProxy_setFunc_FxnT
#define Hwi_HwiProxy_getHookContext ti_sysbios_hal_Hwi_HwiProxy_getHookContext
#define Hwi_HwiProxy_getHookContext_fxnP ti_sysbios_hal_Hwi_HwiProxy_getHookContext_fxnP
#define Hwi_HwiProxy_getHookContext_FxnT ti_sysbios_hal_Hwi_HwiProxy_getHookContext_FxnT
#define Hwi_HwiProxy_setHookContext ti_sysbios_hal_Hwi_HwiProxy_setHookContext
#define Hwi_HwiProxy_setHookContext_fxnP ti_sysbios_hal_Hwi_HwiProxy_setHookContext_fxnP
#define Hwi_HwiProxy_setHookContext_FxnT ti_sysbios_hal_Hwi_HwiProxy_setHookContext_FxnT
#define Hwi_HwiProxy_getIrp ti_sysbios_hal_Hwi_HwiProxy_getIrp
#define Hwi_HwiProxy_getIrp_fxnP ti_sysbios_hal_Hwi_HwiProxy_getIrp_fxnP
#define Hwi_HwiProxy_getIrp_FxnT ti_sysbios_hal_Hwi_HwiProxy_getIrp_FxnT
