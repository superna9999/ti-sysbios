...
#define ti_sysbios_hal_unicache_Cache_dumpRegs ti_sysbios_hal_unicache_Cache_dumpRegs__F
...
#define ti_sysbios_hal_unicache_Cache_Module_startup ti_sysbios_hal_unicache_Cache_Module_startup__F

/* Instance_init */
#undef ti_sysbios_hal_unicache_Cache_Instance_init
#define ti_sysbios_hal_unicache_Cache_Instance_init ti_sysbios_hal_unicache_Cache_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_hal_unicache_Cache_Instance_finalize
#define ti_sysbios_hal_unicache_Cache_Instance_finalize ti_sysbios_hal_unicache_Cache_Instance_finalize__F
