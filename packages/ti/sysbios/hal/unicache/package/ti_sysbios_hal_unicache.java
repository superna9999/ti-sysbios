...
public class ti_sysbios_hal_unicache
{
    ...
    void Cache_Module_GateProxy$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.hal.unicache.Cache_Module_GateProxy.Object", new Proto.Str(po, false));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.ae64T',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.aem3',\n");
            sb.append("'lib/debug/ti.sysbios.hal.unicache.am3g',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.hal.unicache.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
    ...
    void Cache$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "dumpRegs", "entry", "", "exit", ""));
