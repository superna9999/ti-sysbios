...
public class ti_sysbios_hal_ammu
{
    ...
    void AMMU$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.hal.ammu.AMMU.init", new Extern("ti_sysbios_hal_ammu_AMMU_init__I", "xdc_Void(*)(xdc_Void)", true, false));
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.hal.ammu.ae64T',\n");
            sb.append("'lib/debug/ti.sysbios.hal.ammu.aem3',\n");
            sb.append("'lib/debug/ti.sysbios.hal.ammu.am3g',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.hal.ammu.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
    ...
    void AMMU$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_hal_ammu_AMMU_Module__startupDone__E", "ti_sysbios_hal_ammu_AMMU_invAll__E", "ti_sysbios_hal_ammu_AMMU_dumpAmmu__E"));
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "invAll", "entry", "", "exit", ""));
        loggables.add(Global.newObject("name", "dumpAmmu", "entry", "", "exit", ""));
