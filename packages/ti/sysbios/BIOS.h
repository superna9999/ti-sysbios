...
xdc__CODESECT(ti_sysbios_BIOS_Module__startupDone__S, "ti_sysbios_BIOS_Module__startupDone")
...
xdc__CODESECT(ti_sysbios_BIOS_start__F, "ti_sysbios_BIOS_start")
__extern xdc_Void ti_sysbios_BIOS_start__F( void );
__extern xdc_Void ti_sysbios_BIOS_start__R( void );
...
xdc__CODESECT(ti_sysbios_BIOS_exit__F, "ti_sysbios_BIOS_exit")
__extern xdc_Void ti_sysbios_BIOS_exit__F( xdc_Int stat );
__extern xdc_Void ti_sysbios_BIOS_exit__R( xdc_Int stat );
...
xdc__CODESECT(ti_sysbios_BIOS_getThreadType__F, "ti_sysbios_BIOS_getThreadType")
__extern ti_sysbios_BIOS_ThreadType ti_sysbios_BIOS_getThreadType__F( void );
__extern ti_sysbios_BIOS_ThreadType ti_sysbios_BIOS_getThreadType__R( void );
...
xdc__CODESECT(ti_sysbios_BIOS_setThreadType__F, "ti_sysbios_BIOS_setThreadType")
__extern ti_sysbios_BIOS_ThreadType ti_sysbios_BIOS_setThreadType__F( ti_sysbios_BIOS_ThreadType ttype );
__extern ti_sysbios_BIOS_ThreadType ti_sysbios_BIOS_setThreadType__R( ti_sysbios_BIOS_ThreadType ttype );
...
xdc__CODESECT(ti_sysbios_BIOS_setCpuFreq__F, "ti_sysbios_BIOS_setCpuFreq")
__extern xdc_Void ti_sysbios_BIOS_setCpuFreq__F( xdc_runtime_Types_FreqHz* freq );
__extern xdc_Void ti_sysbios_BIOS_setCpuFreq__R( xdc_runtime_Types_FreqHz* freq );
...
xdc__CODESECT(ti_sysbios_BIOS_getCpuFreq__F, "ti_sysbios_BIOS_getCpuFreq")
__extern xdc_Void ti_sysbios_BIOS_getCpuFreq__F( xdc_runtime_Types_FreqHz* freq );
__extern xdc_Void ti_sysbios_BIOS_getCpuFreq__R( xdc_runtime_Types_FreqHz* freq );
