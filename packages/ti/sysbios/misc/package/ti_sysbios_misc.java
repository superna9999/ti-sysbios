...
public class ti_sysbios_misc
{
    ...
    void Stats$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.misc.Stats.Object", new Proto.Str(po, false));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/ti.sysbios.misc.a64',\n");
            sb.append("'lib/debug/ti.sysbios.misc.a64P',\n");
            sb.append("'lib/debug/ti.sysbios.misc.a64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.misc.a674',\n");
            sb.append("'lib/debug/ti.sysbios.misc.a430',\n");
            sb.append("'lib/debug/ti.sysbios.misc.a430X',\n");
            sb.append("'lib/debug/ti.sysbios.misc.a430XS',\n");
            sb.append("'lib/debug/ti.sysbios.misc.ae430X',\n");
            sb.append("'lib/debug/ti.sysbios.misc.ae430XS',\n");
            sb.append("'lib/debug/ti.sysbios.misc.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.misc.ae64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.misc.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.misc.ae64T',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.misc.aea8f',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.misc.aer4te',\n");
            sb.append("'lib/debug/ti.sysbios.misc.aer4fte',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.misc.a86W',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/ti.sysbios.misc.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.a430', {target: 'ti.targets.msp430.MSP430', suffix: '430'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.a430X', {target: 'ti.targets.msp430.MSP430X', suffix: '430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.a430XS', {target: 'ti.targets.msp430.MSP430X_small', suffix: '430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.ae430XS', {target: 'ti.targets.msp430.elf.MSP430X_small', suffix: 'e430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.misc.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.misc.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/debug/ti.sysbios.misc.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.misc.a86W', {target: 'microsoft.targets.Win32', suffix: '86W'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void Stats$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "add", "entry", "%p, %d", "exit", ""));
        loggables.add(Global.newObject("name", "delta", "entry", "%p, %d", "exit", ""));
        loggables.add(Global.newObject("name", "set", "entry", "%p, %d", "exit", ""));
        loggables.add(Global.newObject("name", "reset", "entry", "%p", "exit", ""));
        loggables.add(Global.newObject("name", "getPrev", "entry", "%p", "exit", "%d"));
        loggables.add(Global.newObject("name", "getCount", "entry", "%p", "exit", "%d"));
        loggables.add(Global.newObject("name", "getTotal", "entry", "%p", "exit", "%d"));
        loggables.add(Global.newObject("name", "getMax", "entry", "%p", "exit", "%d"));
