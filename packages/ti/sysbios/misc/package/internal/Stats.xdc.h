...
#define ti_sysbios_misc_Stats_add ti_sysbios_misc_Stats_add__F

/* delta */
#undef ti_sysbios_misc_Stats_delta
#define ti_sysbios_misc_Stats_delta ti_sysbios_misc_Stats_delta__F

/* set */
#undef ti_sysbios_misc_Stats_set
#define ti_sysbios_misc_Stats_set ti_sysbios_misc_Stats_set__F

/* reset */
#undef ti_sysbios_misc_Stats_reset
#define ti_sysbios_misc_Stats_reset ti_sysbios_misc_Stats_reset__F

/* getPrev */
#undef ti_sysbios_misc_Stats_getPrev
#define ti_sysbios_misc_Stats_getPrev ti_sysbios_misc_Stats_getPrev__F

/* getCount */
#undef ti_sysbios_misc_Stats_getCount
#define ti_sysbios_misc_Stats_getCount ti_sysbios_misc_Stats_getCount__F

/* getTotal */
#undef ti_sysbios_misc_Stats_getTotal
#define ti_sysbios_misc_Stats_getTotal ti_sysbios_misc_Stats_getTotal__F

/* getMax */
#undef ti_sysbios_misc_Stats_getMax
#define ti_sysbios_misc_Stats_getMax ti_sysbios_misc_Stats_getMax__F

/* print */
#undef ti_sysbios_misc_Stats_print
#define ti_sysbios_misc_Stats_print ti_sysbios_misc_Stats_print__F

/* Module_startup */
#undef ti_sysbios_misc_Stats_Module_startup
#define ti_sysbios_misc_Stats_Module_startup ti_sysbios_misc_Stats_Module_startup__F

/* Instance_init */
#undef ti_sysbios_misc_Stats_Instance_init
#define ti_sysbios_misc_Stats_Instance_init ti_sysbios_misc_Stats_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_misc_Stats_Instance_finalize
#define ti_sysbios_misc_Stats_Instance_finalize ti_sysbios_misc_Stats_Instance_finalize__F
