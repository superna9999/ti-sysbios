...
#define ti_sysbios_interfaces_IHwi___VERS 150
...
/* setFunc_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_interfaces_IHwi_setFunc_FxnT)(void*, ti_sysbios_interfaces_IHwi_FuncPtr, xdc_UArg);
...
typedef xdc_Void (*ti_sysbios_interfaces_IHwi_setHookContext_FxnT)(void*, xdc_Int, xdc_Ptr);
