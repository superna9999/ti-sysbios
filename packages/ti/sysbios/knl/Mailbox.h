...
#define ti_sysbios_knl_Mailbox___VERS 150
...
xdc__CODESECT(ti_sysbios_knl_Mailbox_Module_startup__R, "ti_sysbios_knl_Mailbox_Module_startup")
__extern xdc_Int ti_sysbios_knl_Mailbox_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Instance_init__F, "ti_sysbios_knl_Mailbox_Instance_init")
__extern int ti_sysbios_knl_Mailbox_Instance_init__F( ti_sysbios_knl_Mailbox_Object*, xdc_SizeT msgSize, xdc_UInt numMsgs, const ti_sysbios_knl_Mailbox_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Instance_finalize__F, "ti_sysbios_knl_Mailbox_Instance_finalize")
__extern void ti_sysbios_knl_Mailbox_Instance_finalize__F( ti_sysbios_knl_Mailbox_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Instance_init__R, "ti_sysbios_knl_Mailbox_Instance_init")
__extern int ti_sysbios_knl_Mailbox_Instance_init__R( ti_sysbios_knl_Mailbox_Object*, xdc_SizeT msgSize, xdc_UInt numMsgs, const ti_sysbios_knl_Mailbox_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Instance_finalize__R, "ti_sysbios_knl_Mailbox_Instance_finalize")
__extern void ti_sysbios_knl_Mailbox_Instance_finalize__R( ti_sysbios_knl_Mailbox_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Handle__label__S, "ti_sysbios_knl_Mailbox_Handle__label")
__extern xdc_runtime_Types_Label* ti_sysbios_knl_Mailbox_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Module__startupDone__S, "ti_sysbios_knl_Mailbox_Module__startupDone")
__extern xdc_Bool ti_sysbios_knl_Mailbox_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Object__create__S, "ti_sysbios_knl_Mailbox_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Object__delete__S, "ti_sysbios_knl_Mailbox_Object__delete")
__extern xdc_Void ti_sysbios_knl_Mailbox_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Object__destruct__S, "ti_sysbios_knl_Mailbox_Object__destruct")
__extern xdc_Void ti_sysbios_knl_Mailbox_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Object__get__S, "ti_sysbios_knl_Mailbox_Object__get")
__extern xdc_Ptr ti_sysbios_knl_Mailbox_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Object__first__S, "ti_sysbios_knl_Mailbox_Object__first")
__extern xdc_Ptr ti_sysbios_knl_Mailbox_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Object__next__S, "ti_sysbios_knl_Mailbox_Object__next")
__extern xdc_Ptr ti_sysbios_knl_Mailbox_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_knl_Mailbox_Params__init__S, "ti_sysbios_knl_Mailbox_Params__init")
__extern xdc_Void ti_sysbios_knl_Mailbox_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sysbios_knl_Mailbox_getMsgSize__F, "ti_sysbios_knl_Mailbox_getMsgSize")
__extern xdc_SizeT ti_sysbios_knl_Mailbox_getMsgSize__F( ti_sysbios_knl_Mailbox_Object* __inst );
__extern xdc_SizeT ti_sysbios_knl_Mailbox_getMsgSize__R( ti_sysbios_knl_Mailbox_Handle __inst );
...
xdc__CODESECT(ti_sysbios_knl_Mailbox_getNumFreeMsgs__F, "ti_sysbios_knl_Mailbox_getNumFreeMsgs")
__extern xdc_Int ti_sysbios_knl_Mailbox_getNumFreeMsgs__F( ti_sysbios_knl_Mailbox_Object* __inst );
__extern xdc_Int ti_sysbios_knl_Mailbox_getNumFreeMsgs__R( ti_sysbios_knl_Mailbox_Handle __inst );
...
xdc__CODESECT(ti_sysbios_knl_Mailbox_getNumPendingMsgs__F, "ti_sysbios_knl_Mailbox_getNumPendingMsgs")
__extern xdc_Int ti_sysbios_knl_Mailbox_getNumPendingMsgs__F( ti_sysbios_knl_Mailbox_Object* __inst );
__extern xdc_Int ti_sysbios_knl_Mailbox_getNumPendingMsgs__R( ti_sysbios_knl_Mailbox_Handle __inst );
...
__extern xdc_Bool ti_sysbios_knl_Mailbox_pend__E( ti_sysbios_knl_Mailbox_Handle __inst, xdc_Ptr msg, xdc_UInt timeout );
xdc__CODESECT(ti_sysbios_knl_Mailbox_pend__F, "ti_sysbios_knl_Mailbox_pend")
__extern xdc_Bool ti_sysbios_knl_Mailbox_pend__F( ti_sysbios_knl_Mailbox_Object* __inst, xdc_Ptr msg, xdc_UInt timeout );
__extern xdc_Bool ti_sysbios_knl_Mailbox_pend__R( ti_sysbios_knl_Mailbox_Handle __inst, xdc_Ptr msg, xdc_UInt timeout );
...
__extern xdc_Bool ti_sysbios_knl_Mailbox_post__E( ti_sysbios_knl_Mailbox_Handle __inst, xdc_Ptr msg, xdc_UInt timeout );
xdc__CODESECT(ti_sysbios_knl_Mailbox_post__F, "ti_sysbios_knl_Mailbox_post")
__extern xdc_Bool ti_sysbios_knl_Mailbox_post__F( ti_sysbios_knl_Mailbox_Object* __inst, xdc_Ptr msg, xdc_UInt timeout );
__extern xdc_Bool ti_sysbios_knl_Mailbox_post__R( ti_sysbios_knl_Mailbox_Handle __inst, xdc_Ptr msg, xdc_UInt timeout );
...
/* getMsgSize_{FxnT,fxnP} */
typedef xdc_SizeT (*ti_sysbios_knl_Mailbox_getMsgSize_FxnT)(void*);
static inline ti_sysbios_knl_Mailbox_getMsgSize_FxnT ti_sysbios_knl_Mailbox_getMsgSize_fxnP( void )
{
    return (ti_sysbios_knl_Mailbox_getMsgSize_FxnT)ti_sysbios_knl_Mailbox_getMsgSize; 
}

/* getNumFreeMsgs_{FxnT,fxnP} */
typedef xdc_Int (*ti_sysbios_knl_Mailbox_getNumFreeMsgs_FxnT)(void*);
static inline ti_sysbios_knl_Mailbox_getNumFreeMsgs_FxnT ti_sysbios_knl_Mailbox_getNumFreeMsgs_fxnP( void )
{
    return (ti_sysbios_knl_Mailbox_getNumFreeMsgs_FxnT)ti_sysbios_knl_Mailbox_getNumFreeMsgs; 
}

/* getNumPendingMsgs_{FxnT,fxnP} */
typedef xdc_Int (*ti_sysbios_knl_Mailbox_getNumPendingMsgs_FxnT)(void*);
static inline ti_sysbios_knl_Mailbox_getNumPendingMsgs_FxnT ti_sysbios_knl_Mailbox_getNumPendingMsgs_fxnP( void )
{
    return (ti_sysbios_knl_Mailbox_getNumPendingMsgs_FxnT)ti_sysbios_knl_Mailbox_getNumPendingMsgs; 
}

/* pend_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_knl_Mailbox_pend_FxnT)(void*, xdc_Ptr, xdc_UInt);
static inline ti_sysbios_knl_Mailbox_pend_FxnT ti_sysbios_knl_Mailbox_pend_fxnP( void )
{
    return (ti_sysbios_knl_Mailbox_pend_FxnT)ti_sysbios_knl_Mailbox_pend; 
}

/* post_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_knl_Mailbox_post_FxnT)(void*, xdc_Ptr, xdc_UInt);
static inline ti_sysbios_knl_Mailbox_post_FxnT ti_sysbios_knl_Mailbox_post_fxnP( void )
{
    return (ti_sysbios_knl_Mailbox_post_FxnT)ti_sysbios_knl_Mailbox_post; 
}
...
{
    if (dst) {
        ti_sysbios_knl_Mailbox_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_knl_Mailbox_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline ti_sysbios_knl_Mailbox_Handle ti_sysbios_knl_Mailbox_create( xdc_SizeT msgSize, xdc_UInt numMsgs, const ti_sysbios_knl_Mailbox_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_knl_Mailbox_Args__create __args;
    __args.msgSize = msgSize;
    __args.numMsgs = numMsgs;
    return (ti_sysbios_knl_Mailbox_Handle)ti_sysbios_knl_Mailbox_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_knl_Mailbox_Params), __eb);
}

/* construct */
static inline void ti_sysbios_knl_Mailbox_construct( ti_sysbios_knl_Mailbox_Struct* __obj, xdc_SizeT msgSize, xdc_UInt numMsgs, const ti_sysbios_knl_Mailbox_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_knl_Mailbox_Args__create __args;
    __args.msgSize = msgSize;
    __args.numMsgs = numMsgs;
    ti_sysbios_knl_Mailbox_Object__create__S(__obj, sizeof (ti_sysbios_knl_Mailbox_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_knl_Mailbox_Params), __eb);
}

/* delete */
static inline void ti_sysbios_knl_Mailbox_delete( ti_sysbios_knl_Mailbox_Handle* instp )
{
    ti_sysbios_knl_Mailbox_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_knl_Mailbox_destruct( ti_sysbios_knl_Mailbox_Struct* obj )
{
...
#define Mailbox_getMsgSize_fxnP ti_sysbios_knl_Mailbox_getMsgSize_fxnP
#define Mailbox_getMsgSize_FxnT ti_sysbios_knl_Mailbox_getMsgSize_FxnT
#define Mailbox_getNumFreeMsgs ti_sysbios_knl_Mailbox_getNumFreeMsgs
#define Mailbox_getNumFreeMsgs_fxnP ti_sysbios_knl_Mailbox_getNumFreeMsgs_fxnP
#define Mailbox_getNumFreeMsgs_FxnT ti_sysbios_knl_Mailbox_getNumFreeMsgs_FxnT
#define Mailbox_getNumPendingMsgs ti_sysbios_knl_Mailbox_getNumPendingMsgs
#define Mailbox_getNumPendingMsgs_fxnP ti_sysbios_knl_Mailbox_getNumPendingMsgs_fxnP
#define Mailbox_getNumPendingMsgs_FxnT ti_sysbios_knl_Mailbox_getNumPendingMsgs_FxnT
#define Mailbox_pend ti_sysbios_knl_Mailbox_pend
#define Mailbox_pend_fxnP ti_sysbios_knl_Mailbox_pend_fxnP
#define Mailbox_pend_FxnT ti_sysbios_knl_Mailbox_pend_FxnT
#define Mailbox_post ti_sysbios_knl_Mailbox_post
#define Mailbox_post_fxnP ti_sysbios_knl_Mailbox_post_fxnP
#define Mailbox_post_FxnT ti_sysbios_knl_Mailbox_post_FxnT
