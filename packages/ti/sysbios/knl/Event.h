...
#define ti_sysbios_knl_Event___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_knl_Event_Instance_init__F, "ti_sysbios_knl_Event_Instance_init")
__extern void ti_sysbios_knl_Event_Instance_init__F( ti_sysbios_knl_Event_Object*, const ti_sysbios_knl_Event_Params* );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_knl_Event_Instance_init__R, "ti_sysbios_knl_Event_Instance_init")
__extern void ti_sysbios_knl_Event_Instance_init__R( ti_sysbios_knl_Event_Object*, const ti_sysbios_knl_Event_Params* );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_knl_Event_Handle__label__S, "ti_sysbios_knl_Event_Handle__label")
__extern xdc_runtime_Types_Label* ti_sysbios_knl_Event_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_knl_Event_Module__startupDone__S, "ti_sysbios_knl_Event_Module__startupDone")
__extern xdc_Bool ti_sysbios_knl_Event_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_knl_Event_Object__create__S, "ti_sysbios_knl_Event_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_knl_Event_Object__delete__S, "ti_sysbios_knl_Event_Object__delete")
__extern xdc_Void ti_sysbios_knl_Event_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_knl_Event_Object__destruct__S, "ti_sysbios_knl_Event_Object__destruct")
__extern xdc_Void ti_sysbios_knl_Event_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_knl_Event_Object__get__S, "ti_sysbios_knl_Event_Object__get")
__extern xdc_Ptr ti_sysbios_knl_Event_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_knl_Event_Object__first__S, "ti_sysbios_knl_Event_Object__first")
__extern xdc_Ptr ti_sysbios_knl_Event_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_knl_Event_Object__next__S, "ti_sysbios_knl_Event_Object__next")
__extern xdc_Ptr ti_sysbios_knl_Event_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_knl_Event_Params__init__S, "ti_sysbios_knl_Event_Params__init")
__extern xdc_Void ti_sysbios_knl_Event_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
__extern xdc_UInt ti_sysbios_knl_Event_pend__E( ti_sysbios_knl_Event_Handle __inst, xdc_UInt andMask, xdc_UInt orMask, xdc_UInt timeout );
xdc__CODESECT(ti_sysbios_knl_Event_pend__F, "ti_sysbios_knl_Event_pend")
__extern xdc_UInt ti_sysbios_knl_Event_pend__F( ti_sysbios_knl_Event_Object* __inst, xdc_UInt andMask, xdc_UInt orMask, xdc_UInt timeout );
__extern xdc_UInt ti_sysbios_knl_Event_pend__R( ti_sysbios_knl_Event_Handle __inst, xdc_UInt andMask, xdc_UInt orMask, xdc_UInt timeout );
...
{
    return (ti_sysbios_knl_Event_pend_FxnT)ti_sysbios_knl_Event_pend; 
}

/* post_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_knl_Event_post_FxnT)(void*, xdc_UInt);
static inline ti_sysbios_knl_Event_post_FxnT ti_sysbios_knl_Event_post_fxnP( void )
{
    return (ti_sysbios_knl_Event_post_FxnT)ti_sysbios_knl_Event_post; 
}
...
{
    return (ti_sysbios_knl_Event_getPostedEvents_FxnT)ti_sysbios_knl_Event_getPostedEvents; 
}

/* sync_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_knl_Event_sync_FxnT)(void*, xdc_UInt, xdc_UInt);
static inline ti_sysbios_knl_Event_sync_FxnT ti_sysbios_knl_Event_sync_fxnP( void )
{
    return (ti_sysbios_knl_Event_sync_FxnT)ti_sysbios_knl_Event_sync; 
}
...
{
    ti_sysbios_knl_Event_Object__create__S(__obj, sizeof (ti_sysbios_knl_Event_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_knl_Event_Params), NULL);
}
...
#define Event_pend_fxnP ti_sysbios_knl_Event_pend_fxnP
#define Event_pend_FxnT ti_sysbios_knl_Event_pend_FxnT
#define Event_post ti_sysbios_knl_Event_post
#define Event_post_fxnP ti_sysbios_knl_Event_post_fxnP
#define Event_post_FxnT ti_sysbios_knl_Event_post_FxnT
#define Event_getPostedEvents ti_sysbios_knl_Event_getPostedEvents
#define Event_getPostedEvents_fxnP ti_sysbios_knl_Event_getPostedEvents_fxnP
#define Event_getPostedEvents_FxnT ti_sysbios_knl_Event_getPostedEvents_FxnT
#define Event_sync ti_sysbios_knl_Event_sync
#define Event_sync_fxnP ti_sysbios_knl_Event_sync_fxnP
#define Event_sync_FxnT ti_sysbios_knl_Event_sync_FxnT
