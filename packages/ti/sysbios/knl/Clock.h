...
#define ti_sysbios_knl_Clock___VERS 150
...
__extern xdc_Void ti_sysbios_knl_Clock_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
__extern xdc_Void ti_sysbios_knl_Clock_setPeriod__E( ti_sysbios_knl_Clock_Handle __inst, xdc_UInt period );
xdc__CODESECT(ti_sysbios_knl_Clock_setPeriod__F, "ti_sysbios_knl_Clock_setPeriod")
__extern xdc_Void ti_sysbios_knl_Clock_setPeriod__F( ti_sysbios_knl_Clock_Object* __inst, xdc_UInt period );
__extern xdc_Void ti_sysbios_knl_Clock_setPeriod__R( ti_sysbios_knl_Clock_Handle __inst, xdc_UInt period );
...
__extern xdc_Void ti_sysbios_knl_Clock_setTimeout__E( ti_sysbios_knl_Clock_Handle __inst, xdc_UInt timeout );
xdc__CODESECT(ti_sysbios_knl_Clock_setTimeout__F, "ti_sysbios_knl_Clock_setTimeout")
__extern xdc_Void ti_sysbios_knl_Clock_setTimeout__F( ti_sysbios_knl_Clock_Object* __inst, xdc_UInt timeout );
__extern xdc_Void ti_sysbios_knl_Clock_setTimeout__R( ti_sysbios_knl_Clock_Handle __inst, xdc_UInt timeout );
...
__extern xdc_UInt ti_sysbios_knl_Clock_getPeriod__E( ti_sysbios_knl_Clock_Handle __inst );
xdc__CODESECT(ti_sysbios_knl_Clock_getPeriod__F, "ti_sysbios_knl_Clock_getPeriod")
__extern xdc_UInt ti_sysbios_knl_Clock_getPeriod__F( ti_sysbios_knl_Clock_Object* __inst );
__extern xdc_UInt ti_sysbios_knl_Clock_getPeriod__R( ti_sysbios_knl_Clock_Handle __inst );
...
__extern xdc_UInt ti_sysbios_knl_Clock_getTimeout__E( ti_sysbios_knl_Clock_Handle __inst );
xdc__CODESECT(ti_sysbios_knl_Clock_getTimeout__F, "ti_sysbios_knl_Clock_getTimeout")
__extern xdc_UInt ti_sysbios_knl_Clock_getTimeout__F( ti_sysbios_knl_Clock_Object* __inst );
__extern xdc_UInt ti_sysbios_knl_Clock_getTimeout__R( ti_sysbios_knl_Clock_Handle __inst );
...
typedef xdc_Void (*ti_sysbios_knl_Clock_setPeriod_FxnT)(void*, xdc_UInt);
...
typedef xdc_Void (*ti_sysbios_knl_Clock_setTimeout_FxnT)(void*, xdc_UInt);
