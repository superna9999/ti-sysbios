...
#define ti_sysbios_knl_Mailbox_Module_startup ti_sysbios_knl_Mailbox_Module_startup__F

/* Instance_init */
#undef ti_sysbios_knl_Mailbox_Instance_init
#define ti_sysbios_knl_Mailbox_Instance_init ti_sysbios_knl_Mailbox_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_knl_Mailbox_Instance_finalize
#define ti_sysbios_knl_Mailbox_Instance_finalize ti_sysbios_knl_Mailbox_Instance_finalize__F
