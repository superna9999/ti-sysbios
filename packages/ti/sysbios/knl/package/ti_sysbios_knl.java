...
public class ti_sysbios_knl
{
    ...
    void Clock$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.knl.Clock.Object", new Proto.Str(po, false));
    ...
    void Event$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.knl.Event.Object", new Proto.Str(po, false));
    ...
    void Mailbox$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.knl.Mailbox.Object", new Proto.Str(po, false));
    ...
    void Queue$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.knl.Queue.Object", new Proto.Str(po, false));
    ...
    void Semaphore$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.knl.Semaphore.Object", new Proto.Str(po, false));
    ...
    void Swi$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.knl.Swi.Object", new Proto.Str(po, false));
    ...
    void Task$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.knl.Task.Object", new Proto.Str(po, false));
    ...
    void Clock$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.knl.Clock.getTimerHandle", new Extern("ti_sysbios_knl_Clock_getTimerHandle__E", "ti_sysbios_hal_Timer_Handle(*)(xdc_Void)", true, false));
        ...
        om.bind("ti.sysbios.knl.Clock.setupTimerToSkipTicks", new Extern("ti_sysbios_knl_Clock_setupTimerToSkipTicks__E", "xdc_Void(*)(xdc_UInt)", true, false));
    ...
    {
        // module Semaphore
        om.bind("ti.sysbios.knl.Semaphore.Mode_COUNTING", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.knl.Semaphore.Mode", "ti.sysbios.knl"), "ti.sysbios.knl.Semaphore.Mode_COUNTING", 0));
        om.bind("ti.sysbios.knl.Semaphore.Mode_BINARY", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.knl.Semaphore.Mode", "ti.sysbios.knl"), "ti.sysbios.knl.Semaphore.Mode_BINARY", 1));
    ...
    void Task$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.knl.Task.sleep", new Extern("ti_sysbios_knl_Task_sleep__E", "xdc_Void(*)(xdc_UInt)", true, false));
    ...
    void Swi$$CREATES()
    {
        ...
        if (isCFG) {
            ...
            sb = new StringBuilder();
            sb.append("ti$sysbios$knl$Swi$$create = function( fxn, __params ) {\n");
        ...
        if (isCFG) {
            ...
            sb = new StringBuilder();
            sb.append("ti$sysbios$knl$Swi$$construct = function( __obj, fxn, __params ) {\n");
                sb.append("var __mod = xdc.om['ti.sysbios.knl.Swi'];\n");
                sb.append("var __inst = __obj;\n");
                sb.append("__inst.$$bind('$args', {fxn:fxn});\n");
                sb.append("__inst.$$bind('$module', __mod);\n");
    ...
    void Clock$$SIZES()
    {
        ...
        sizes.add(Global.newArray("doTickFunc", "UFxn"));
        sizes.add(Global.newArray("swi", "UPtr"));
        sizes.add(Global.newArray("periodCounts", "UInt32"));
        sizes.add(Global.newArray("numTickSkip", "UInt"));
        sizes.add(Global.newArray("skipsWorkFunc", "UInt"));
    ...
    void Semaphore$$SIZES()
    {
        ...
        sizes.add(Global.newArray("mode", "Nti.sysbios.knl.Semaphore.Mode;;;"));
    ...
    void Clock$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("period", Proto.Elm.newCNum("(xdc_UInt)"), 0L, "w");
        ...
        po.init("ti.sysbios.knl.Clock.Module_State", null);
                ...
                po.addFld("timer", (Proto)om.findStrict("ti.sysbios.hal.Timer.Handle", "ti.sysbios.knl"), $$UNDEF, "w");
                ...
                po.addFld("periodCounts", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("numTickSkip", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                po.addFld("skipsWorkFunc", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
    ...
    void Task$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("allBlockedFunc", new Proto.Adr("xdc_Void(*)(xdc_Void)", "PFv"), $$UNDEF, "w");
        ...
        po.init("ti.sysbios.knl.Task.DetailedView", null);
                ...
                po.addFld("arg0", new Proto.Adr("xdc_UArg", "Pv"), $$UNDEF, "w");
                po.addFld("arg1", new Proto.Adr("xdc_UArg", "Pv"), $$UNDEF, "w");
                po.addFld("stackPeak", Proto.Elm.newCNum("(xdc_SizeT)"), $$UNDEF, "w");
                po.addFld("stackSize", Proto.Elm.newCNum("(xdc_SizeT)"), $$UNDEF, "w");
                po.addFld("stackBase", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
        ...
        po.init("ti.sysbios.knl.Task.ModuleView", null);
                ...
                po.addFld("currentTask", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
        ...
        po.init("ti.sysbios.knl.Task.Module_State", null);
                ...
                po.addFld("curQ", (Proto)om.findStrict("ti.sysbios.knl.Queue.Handle", "ti.sysbios.knl"), $$UNDEF, "w");
                po.addFld("readyQ", new Proto.Arr((Proto)om.findStrict("ti.sysbios.knl.Queue.Object", "ti.sysbios.knl"), false), $$DEFAULT, "w");
                po.addFld("idleTask", (Proto)om.findStrict("ti.sysbios.knl.Task.Handle", "ti.sysbios.knl"), $$UNDEF, "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/ti.sysbios.knl.a64',\n");
            sb.append("'lib/debug/ti.sysbios.knl.a64P',\n");
            sb.append("'lib/debug/ti.sysbios.knl.a64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.knl.a674',\n");
            sb.append("'lib/debug/ti.sysbios.knl.a430',\n");
            sb.append("'lib/debug/ti.sysbios.knl.a430X',\n");
            sb.append("'lib/debug/ti.sysbios.knl.a430XS',\n");
            sb.append("'lib/debug/ti.sysbios.knl.ae430X',\n");
            sb.append("'lib/debug/ti.sysbios.knl.ae430XS',\n");
            sb.append("'lib/debug/ti.sysbios.knl.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.knl.ae64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.knl.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.knl.ae64T',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.knl.aea8f',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.knl.aer4te',\n");
            sb.append("'lib/debug/ti.sysbios.knl.aer4fte',\n");
            sb.append("'lib/debug/ti.sysbios.knl.am3g',\n");
            sb.append("'lib/debug/ti.sysbios.knl.am4g',\n");
            sb.append("'lib/debug/ti.sysbios.knl.am4fg',\n");
            sb.append("'lib/debug/ti.sysbios.knl.a86W',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/ti.sysbios.knl.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.a430', {target: 'ti.targets.msp430.MSP430', suffix: '430'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.a430X', {target: 'ti.targets.msp430.MSP430X', suffix: '430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.a430XS', {target: 'ti.targets.msp430.MSP430X_small', suffix: '430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.ae430XS', {target: 'ti.targets.msp430.elf.MSP430X_small', suffix: 'e430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.knl.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.knl.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/debug/ti.sysbios.knl.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.knl.a86W', {target: 'microsoft.targets.Win32', suffix: '86W'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void Event$$SINGLETONS()
    {
        ...
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray("A_nullEventMasks", "A_nullEventId", "A_eventInUse", "A_badContext"));
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
        atmap.seal("length");
    ...
    void Semaphore$$SINGLETONS()
    {
        ...
        vo.bind("$$logEvtCfgs", Global.newArray("LM_post", "LM_pend"));
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray("A_noEvents", "A_invTimeout", "A_badContext"));
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
        atmap.seal("length");
    ...
    void Task$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_knl_Task_Handle__label__E", "ti_sysbios_knl_Task_Module__startupDone__E", "ti_sysbios_knl_Task_Object__create__E", "ti_sysbios_knl_Task_Object__delete__E", "ti_sysbios_knl_Task_Object__destruct__E", "ti_sysbios_knl_Task_Object__get__E", "ti_sysbios_knl_Task_Object__first__E", "ti_sysbios_knl_Task_Object__next__E", "ti_sysbios_knl_Task_Params__init__E", "ti_sysbios_knl_Task_startup__E", "ti_sysbios_knl_Task_disable__E", "ti_sysbios_knl_Task_enable__E", "ti_sysbios_knl_Task_restore__E", "ti_sysbios_knl_Task_restoreHwi__E", "ti_sysbios_knl_Task_self__E", "ti_sysbios_knl_Task_selfMacro__E", "ti_sysbios_knl_Task_checkStacks__E", "ti_sysbios_knl_Task_exit__E", "ti_sysbios_knl_Task_sleep__E", "ti_sysbios_knl_Task_yield__E", "ti_sysbios_knl_Task_getIdleTask__E", "ti_sysbios_knl_Task_getArg0__E", "ti_sysbios_knl_Task_getArg1__E", "ti_sysbios_knl_Task_getEnv__E", "ti_sysbios_knl_Task_getHookContext__E", "ti_sysbios_knl_Task_getPri__E", "ti_sysbios_knl_Task_setArg0__E", "ti_sysbios_knl_Task_setArg1__E", "ti_sysbios_knl_Task_setEnv__E", "ti_sysbios_knl_Task_setHookContext__E", "ti_sysbios_knl_Task_setPri__E", "ti_sysbios_knl_Task_stat__E", "ti_sysbios_knl_Task_getMode__E", "ti_sysbios_knl_Task_block__E", "ti_sysbios_knl_Task_unblock__E", "ti_sysbios_knl_Task_blockI__E", "ti_sysbios_knl_Task_unblockI__E"));
        vo.bind("$$logEvtCfgs", Global.newArray("LM_switch", "LM_sleep", "LD_ready", "LD_block", "LM_yield", "LM_setPri", "LD_exit"));
        vo.bind("$$errorDescCfgs", Global.newArray("E_stackOverflow", "E_spOutOfBounds"));
        vo.bind("$$assertDescCfgs", Global.newArray("A_badThreadType", "A_badTaskState", "A_noPendElem", "A_taskDisabled", "A_badPriority", "A_badTimeout"));
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
        atmap.setElem("", true);
        atmap.setElem("", true);
