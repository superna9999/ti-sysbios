...
#define ti_sysbios_knl_Semaphore___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Instance_init__F, "ti_sysbios_knl_Semaphore_Instance_init")
__extern void ti_sysbios_knl_Semaphore_Instance_init__F( ti_sysbios_knl_Semaphore_Object*, xdc_Int count, const ti_sysbios_knl_Semaphore_Params* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Instance_finalize__F, "ti_sysbios_knl_Semaphore_Instance_finalize")
__extern void ti_sysbios_knl_Semaphore_Instance_finalize__F( ti_sysbios_knl_Semaphore_Object* );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Instance_init__R, "ti_sysbios_knl_Semaphore_Instance_init")
__extern void ti_sysbios_knl_Semaphore_Instance_init__R( ti_sysbios_knl_Semaphore_Object*, xdc_Int count, const ti_sysbios_knl_Semaphore_Params* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Instance_finalize__R, "ti_sysbios_knl_Semaphore_Instance_finalize")
__extern void ti_sysbios_knl_Semaphore_Instance_finalize__R( ti_sysbios_knl_Semaphore_Object* );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Handle__label__S, "ti_sysbios_knl_Semaphore_Handle__label")
__extern xdc_runtime_Types_Label* ti_sysbios_knl_Semaphore_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Module__startupDone__S, "ti_sysbios_knl_Semaphore_Module__startupDone")
__extern xdc_Bool ti_sysbios_knl_Semaphore_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Object__create__S, "ti_sysbios_knl_Semaphore_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Object__delete__S, "ti_sysbios_knl_Semaphore_Object__delete")
__extern xdc_Void ti_sysbios_knl_Semaphore_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Object__destruct__S, "ti_sysbios_knl_Semaphore_Object__destruct")
__extern xdc_Void ti_sysbios_knl_Semaphore_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Object__get__S, "ti_sysbios_knl_Semaphore_Object__get")
__extern xdc_Ptr ti_sysbios_knl_Semaphore_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Object__first__S, "ti_sysbios_knl_Semaphore_Object__first")
__extern xdc_Ptr ti_sysbios_knl_Semaphore_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Object__next__S, "ti_sysbios_knl_Semaphore_Object__next")
__extern xdc_Ptr ti_sysbios_knl_Semaphore_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_knl_Semaphore_Params__init__S, "ti_sysbios_knl_Semaphore_Params__init")
__extern xdc_Void ti_sysbios_knl_Semaphore_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sysbios_knl_Semaphore_getCount__F, "ti_sysbios_knl_Semaphore_getCount")
__extern xdc_Int ti_sysbios_knl_Semaphore_getCount__F( ti_sysbios_knl_Semaphore_Object* __inst );
__extern xdc_Int ti_sysbios_knl_Semaphore_getCount__R( ti_sysbios_knl_Semaphore_Handle __inst );
...
__extern xdc_Bool ti_sysbios_knl_Semaphore_pend__E( ti_sysbios_knl_Semaphore_Handle __inst, xdc_UInt timeout );
xdc__CODESECT(ti_sysbios_knl_Semaphore_pend__F, "ti_sysbios_knl_Semaphore_pend")
__extern xdc_Bool ti_sysbios_knl_Semaphore_pend__F( ti_sysbios_knl_Semaphore_Object* __inst, xdc_UInt timeout );
__extern xdc_Bool ti_sysbios_knl_Semaphore_pend__R( ti_sysbios_knl_Semaphore_Handle __inst, xdc_UInt timeout );
...
xdc__CODESECT(ti_sysbios_knl_Semaphore_post__F, "ti_sysbios_knl_Semaphore_post")
__extern xdc_Void ti_sysbios_knl_Semaphore_post__F( ti_sysbios_knl_Semaphore_Object* __inst );
__extern xdc_Void ti_sysbios_knl_Semaphore_post__R( ti_sysbios_knl_Semaphore_Handle __inst );
...
xdc__CODESECT(ti_sysbios_knl_Semaphore_registerEvent__F, "ti_sysbios_knl_Semaphore_registerEvent")
__extern xdc_Void ti_sysbios_knl_Semaphore_registerEvent__F( ti_sysbios_knl_Semaphore_Object* __inst, ti_sysbios_knl_Event_Handle event, xdc_UInt eventId );
__extern xdc_Void ti_sysbios_knl_Semaphore_registerEvent__R( ti_sysbios_knl_Semaphore_Handle __inst, ti_sysbios_knl_Event_Handle event, xdc_UInt eventId );
...
xdc__CODESECT(ti_sysbios_knl_Semaphore_reset__F, "ti_sysbios_knl_Semaphore_reset")
__extern xdc_Void ti_sysbios_knl_Semaphore_reset__F( ti_sysbios_knl_Semaphore_Object* __inst, xdc_Int count );
__extern xdc_Void ti_sysbios_knl_Semaphore_reset__R( ti_sysbios_knl_Semaphore_Handle __inst, xdc_Int count );
...
{
    return (ti_sysbios_knl_Semaphore_getCount_FxnT)ti_sysbios_knl_Semaphore_getCount; 
}
...
{
    return (ti_sysbios_knl_Semaphore_pend_FxnT)ti_sysbios_knl_Semaphore_pend; 
}

/* post_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_knl_Semaphore_post_FxnT)(void*);
static inline ti_sysbios_knl_Semaphore_post_FxnT ti_sysbios_knl_Semaphore_post_fxnP( void )
{
    return (ti_sysbios_knl_Semaphore_post_FxnT)ti_sysbios_knl_Semaphore_post; 
}

/* registerEvent_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_knl_Semaphore_registerEvent_FxnT)(void*, ti_sysbios_knl_Event_Handle, xdc_UInt);
static inline ti_sysbios_knl_Semaphore_registerEvent_FxnT ti_sysbios_knl_Semaphore_registerEvent_fxnP( void )
{
    return (ti_sysbios_knl_Semaphore_registerEvent_FxnT)ti_sysbios_knl_Semaphore_registerEvent; 
}

/* reset_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_knl_Semaphore_reset_FxnT)(void*, xdc_Int);
static inline ti_sysbios_knl_Semaphore_reset_FxnT ti_sysbios_knl_Semaphore_reset_fxnP( void )
{
    return (ti_sysbios_knl_Semaphore_reset_FxnT)ti_sysbios_knl_Semaphore_reset; 
}
...
static inline void ti_sysbios_knl_Semaphore_construct( ti_sysbios_knl_Semaphore_Struct* __obj, xdc_Int count, const ti_sysbios_knl_Semaphore_Params* __prms )
{
    ti_sysbios_knl_Semaphore_Args__create __args;
    __args.count = count;
    ti_sysbios_knl_Semaphore_Object__create__S(__obj, sizeof (ti_sysbios_knl_Semaphore_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_knl_Semaphore_Params), NULL);
}
...
#define Semaphore_getCount_fxnP ti_sysbios_knl_Semaphore_getCount_fxnP
#define Semaphore_getCount_FxnT ti_sysbios_knl_Semaphore_getCount_FxnT
#define Semaphore_pend ti_sysbios_knl_Semaphore_pend
#define Semaphore_pend_fxnP ti_sysbios_knl_Semaphore_pend_fxnP
#define Semaphore_pend_FxnT ti_sysbios_knl_Semaphore_pend_FxnT
#define Semaphore_post ti_sysbios_knl_Semaphore_post
#define Semaphore_post_fxnP ti_sysbios_knl_Semaphore_post_fxnP
#define Semaphore_post_FxnT ti_sysbios_knl_Semaphore_post_FxnT
#define Semaphore_registerEvent ti_sysbios_knl_Semaphore_registerEvent
#define Semaphore_registerEvent_fxnP ti_sysbios_knl_Semaphore_registerEvent_fxnP
#define Semaphore_registerEvent_FxnT ti_sysbios_knl_Semaphore_registerEvent_FxnT
#define Semaphore_reset ti_sysbios_knl_Semaphore_reset
#define Semaphore_reset_fxnP ti_sysbios_knl_Semaphore_reset_fxnP
#define Semaphore_reset_FxnT ti_sysbios_knl_Semaphore_reset_FxnT
