...
#define ti_sysbios_gates_GateMutex___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Instance_init__F, "ti_sysbios_gates_GateMutex_Instance_init")
__extern void ti_sysbios_gates_GateMutex_Instance_init__F( ti_sysbios_gates_GateMutex_Object*, const ti_sysbios_gates_GateMutex_Params* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Instance_finalize__F, "ti_sysbios_gates_GateMutex_Instance_finalize")
__extern void ti_sysbios_gates_GateMutex_Instance_finalize__F( ti_sysbios_gates_GateMutex_Object* );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Instance_init__R, "ti_sysbios_gates_GateMutex_Instance_init")
__extern void ti_sysbios_gates_GateMutex_Instance_init__R( ti_sysbios_gates_GateMutex_Object*, const ti_sysbios_gates_GateMutex_Params* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Instance_finalize__R, "ti_sysbios_gates_GateMutex_Instance_finalize")
__extern void ti_sysbios_gates_GateMutex_Instance_finalize__R( ti_sysbios_gates_GateMutex_Object* );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Handle__label__S, "ti_sysbios_gates_GateMutex_Handle__label")
__extern xdc_runtime_Types_Label* ti_sysbios_gates_GateMutex_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Module__startupDone__S, "ti_sysbios_gates_GateMutex_Module__startupDone")
__extern xdc_Bool ti_sysbios_gates_GateMutex_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Object__create__S, "ti_sysbios_gates_GateMutex_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Object__delete__S, "ti_sysbios_gates_GateMutex_Object__delete")
__extern xdc_Void ti_sysbios_gates_GateMutex_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Object__destruct__S, "ti_sysbios_gates_GateMutex_Object__destruct")
__extern xdc_Void ti_sysbios_gates_GateMutex_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Object__get__S, "ti_sysbios_gates_GateMutex_Object__get")
__extern xdc_Ptr ti_sysbios_gates_GateMutex_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Object__first__S, "ti_sysbios_gates_GateMutex_Object__first")
__extern xdc_Ptr ti_sysbios_gates_GateMutex_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Object__next__S, "ti_sysbios_gates_GateMutex_Object__next")
__extern xdc_Ptr ti_sysbios_gates_GateMutex_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_gates_GateMutex_Params__init__S, "ti_sysbios_gates_GateMutex_Params__init")
__extern xdc_Void ti_sysbios_gates_GateMutex_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sysbios_gates_GateMutex_query__F, "ti_sysbios_gates_GateMutex_query")
__extern xdc_Bool ti_sysbios_gates_GateMutex_query__F( xdc_Int qual );
__extern xdc_Bool ti_sysbios_gates_GateMutex_query__R( xdc_Int qual );
...
xdc__CODESECT(ti_sysbios_gates_GateMutex_enter__F, "ti_sysbios_gates_GateMutex_enter")
__extern xdc_IArg ti_sysbios_gates_GateMutex_enter__F( ti_sysbios_gates_GateMutex_Object* __inst );
__extern xdc_IArg ti_sysbios_gates_GateMutex_enter__R( ti_sysbios_gates_GateMutex_Handle __inst );
...
xdc__CODESECT(ti_sysbios_gates_GateMutex_leave__F, "ti_sysbios_gates_GateMutex_leave")
__extern xdc_Void ti_sysbios_gates_GateMutex_leave__F( ti_sysbios_gates_GateMutex_Object* __inst, xdc_IArg key );
__extern xdc_Void ti_sysbios_gates_GateMutex_leave__R( ti_sysbios_gates_GateMutex_Handle __inst, xdc_IArg key );
...
{
    return (ti_sysbios_gates_GateMutex_enter_FxnT)ti_sysbios_gates_GateMutex_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_gates_GateMutex_leave_FxnT)(void*, xdc_IArg);
static inline ti_sysbios_gates_GateMutex_leave_FxnT ti_sysbios_gates_GateMutex_leave_fxnP( void )
{
    return (ti_sysbios_gates_GateMutex_leave_FxnT)ti_sysbios_gates_GateMutex_leave; 
}
...
{
    ti_sysbios_gates_GateMutex_Object__create__S(__obj, sizeof (ti_sysbios_gates_GateMutex_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_gates_GateMutex_Params), NULL);
}
...
#define GateMutex_enter_fxnP ti_sysbios_gates_GateMutex_enter_fxnP
#define GateMutex_enter_FxnT ti_sysbios_gates_GateMutex_enter_FxnT
#define GateMutex_leave ti_sysbios_gates_GateMutex_leave
#define GateMutex_leave_fxnP ti_sysbios_gates_GateMutex_leave_fxnP
#define GateMutex_leave_FxnT ti_sysbios_gates_GateMutex_leave_FxnT
