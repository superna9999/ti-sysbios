...
#define ti_sysbios_gates_GateMutexPri___VERS 150
...
struct ti_sysbios_gates_GateMutexPri_Struct {
    ...
    xdc_UInt __f0;
    xdc_Int __f1;
    ti_sysbios_knl_Task_Handle __f2;
...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Instance_init__F, "ti_sysbios_gates_GateMutexPri_Instance_init")
__extern void ti_sysbios_gates_GateMutexPri_Instance_init__F( ti_sysbios_gates_GateMutexPri_Object*, const ti_sysbios_gates_GateMutexPri_Params* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Instance_finalize__F, "ti_sysbios_gates_GateMutexPri_Instance_finalize")
__extern void ti_sysbios_gates_GateMutexPri_Instance_finalize__F( ti_sysbios_gates_GateMutexPri_Object* );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Instance_init__R, "ti_sysbios_gates_GateMutexPri_Instance_init")
__extern void ti_sysbios_gates_GateMutexPri_Instance_init__R( ti_sysbios_gates_GateMutexPri_Object*, const ti_sysbios_gates_GateMutexPri_Params* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Instance_finalize__R, "ti_sysbios_gates_GateMutexPri_Instance_finalize")
__extern void ti_sysbios_gates_GateMutexPri_Instance_finalize__R( ti_sysbios_gates_GateMutexPri_Object* );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Handle__label__S, "ti_sysbios_gates_GateMutexPri_Handle__label")
...
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Module__startupDone__S, "ti_sysbios_gates_GateMutexPri_Module__startupDone")
__extern xdc_Bool ti_sysbios_gates_GateMutexPri_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Object__create__S, "ti_sysbios_gates_GateMutexPri_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Object__delete__S, "ti_sysbios_gates_GateMutexPri_Object__delete")
__extern xdc_Void ti_sysbios_gates_GateMutexPri_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Object__destruct__S, "ti_sysbios_gates_GateMutexPri_Object__destruct")
__extern xdc_Void ti_sysbios_gates_GateMutexPri_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Object__get__S, "ti_sysbios_gates_GateMutexPri_Object__get")
__extern xdc_Ptr ti_sysbios_gates_GateMutexPri_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Object__first__S, "ti_sysbios_gates_GateMutexPri_Object__first")
__extern xdc_Ptr ti_sysbios_gates_GateMutexPri_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Object__next__S, "ti_sysbios_gates_GateMutexPri_Object__next")
__extern xdc_Ptr ti_sysbios_gates_GateMutexPri_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_Params__init__S, "ti_sysbios_gates_GateMutexPri_Params__init")
__extern xdc_Void ti_sysbios_gates_GateMutexPri_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_query__F, "ti_sysbios_gates_GateMutexPri_query")
__extern xdc_Bool ti_sysbios_gates_GateMutexPri_query__F( xdc_Int qual );
__extern xdc_Bool ti_sysbios_gates_GateMutexPri_query__R( xdc_Int qual );
...
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_enter__F, "ti_sysbios_gates_GateMutexPri_enter")
__extern xdc_IArg ti_sysbios_gates_GateMutexPri_enter__F( ti_sysbios_gates_GateMutexPri_Object* __inst );
__extern xdc_IArg ti_sysbios_gates_GateMutexPri_enter__R( ti_sysbios_gates_GateMutexPri_Handle __inst );
...
xdc__CODESECT(ti_sysbios_gates_GateMutexPri_leave__F, "ti_sysbios_gates_GateMutexPri_leave")
__extern xdc_Void ti_sysbios_gates_GateMutexPri_leave__F( ti_sysbios_gates_GateMutexPri_Object* __inst, xdc_IArg key );
__extern xdc_Void ti_sysbios_gates_GateMutexPri_leave__R( ti_sysbios_gates_GateMutexPri_Handle __inst, xdc_IArg key );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*ti_sysbios_gates_GateMutexPri_enter_FxnT)(void*);
static inline ti_sysbios_gates_GateMutexPri_enter_FxnT ti_sysbios_gates_GateMutexPri_enter_fxnP( void )
{
    return (ti_sysbios_gates_GateMutexPri_enter_FxnT)ti_sysbios_gates_GateMutexPri_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_gates_GateMutexPri_leave_FxnT)(void*, xdc_IArg);
static inline ti_sysbios_gates_GateMutexPri_leave_FxnT ti_sysbios_gates_GateMutexPri_leave_fxnP( void )
{
    return (ti_sysbios_gates_GateMutexPri_leave_FxnT)ti_sysbios_gates_GateMutexPri_leave; 
}
...
{
    if (dst) {
        ti_sysbios_gates_GateMutexPri_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_gates_GateMutexPri_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sysbios_gates_GateMutexPri_Handle_name( ti_sysbios_gates_GateMutexPri_Handle inst )
{
...
/* create */
static inline ti_sysbios_gates_GateMutexPri_Handle ti_sysbios_gates_GateMutexPri_create( const ti_sysbios_gates_GateMutexPri_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_sysbios_gates_GateMutexPri_Handle)ti_sysbios_gates_GateMutexPri_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_gates_GateMutexPri_Params), __eb);
}

/* construct */
static inline void ti_sysbios_gates_GateMutexPri_construct( ti_sysbios_gates_GateMutexPri_Struct* __obj, const ti_sysbios_gates_GateMutexPri_Params* __prms )
{
    ti_sysbios_gates_GateMutexPri_Object__create__S(__obj, sizeof (ti_sysbios_gates_GateMutexPri_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_gates_GateMutexPri_Params), NULL);
}

/* delete */
static inline void ti_sysbios_gates_GateMutexPri_delete( ti_sysbios_gates_GateMutexPri_Handle* instp )
{
    ti_sysbios_gates_GateMutexPri_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_gates_GateMutexPri_destruct( ti_sysbios_gates_GateMutexPri_Struct* obj )
{
...
#define GateMutexPri_enter_fxnP ti_sysbios_gates_GateMutexPri_enter_fxnP
#define GateMutexPri_enter_FxnT ti_sysbios_gates_GateMutexPri_enter_FxnT
#define GateMutexPri_leave ti_sysbios_gates_GateMutexPri_leave
#define GateMutexPri_leave_fxnP ti_sysbios_gates_GateMutexPri_leave_fxnP
#define GateMutexPri_leave_FxnT ti_sysbios_gates_GateMutexPri_leave_FxnT
