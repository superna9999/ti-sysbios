...
#define ti_sysbios_syncs_SyncEvent___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Instance_init__F, "ti_sysbios_syncs_SyncEvent_Instance_init")
__extern void ti_sysbios_syncs_SyncEvent_Instance_init__F( ti_sysbios_syncs_SyncEvent_Object*, const ti_sysbios_syncs_SyncEvent_Params* );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Instance_init__R, "ti_sysbios_syncs_SyncEvent_Instance_init")
__extern void ti_sysbios_syncs_SyncEvent_Instance_init__R( ti_sysbios_syncs_SyncEvent_Object*, const ti_sysbios_syncs_SyncEvent_Params* );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Handle__label__S, "ti_sysbios_syncs_SyncEvent_Handle__label")
__extern xdc_runtime_Types_Label* ti_sysbios_syncs_SyncEvent_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Module__startupDone__S, "ti_sysbios_syncs_SyncEvent_Module__startupDone")
__extern xdc_Bool ti_sysbios_syncs_SyncEvent_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Object__create__S, "ti_sysbios_syncs_SyncEvent_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Object__delete__S, "ti_sysbios_syncs_SyncEvent_Object__delete")
__extern xdc_Void ti_sysbios_syncs_SyncEvent_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Object__destruct__S, "ti_sysbios_syncs_SyncEvent_Object__destruct")
__extern xdc_Void ti_sysbios_syncs_SyncEvent_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Object__get__S, "ti_sysbios_syncs_SyncEvent_Object__get")
__extern xdc_Ptr ti_sysbios_syncs_SyncEvent_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Object__first__S, "ti_sysbios_syncs_SyncEvent_Object__first")
__extern xdc_Ptr ti_sysbios_syncs_SyncEvent_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Object__next__S, "ti_sysbios_syncs_SyncEvent_Object__next")
__extern xdc_Ptr ti_sysbios_syncs_SyncEvent_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_Params__init__S, "ti_sysbios_syncs_SyncEvent_Params__init")
__extern xdc_Void ti_sysbios_syncs_SyncEvent_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_query__F, "ti_sysbios_syncs_SyncEvent_query")
__extern xdc_Bool ti_sysbios_syncs_SyncEvent_query__F( ti_sysbios_syncs_SyncEvent_Object* __inst, xdc_Int qual );
__extern xdc_Bool ti_sysbios_syncs_SyncEvent_query__R( ti_sysbios_syncs_SyncEvent_Handle __inst, xdc_Int qual );
...
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_signal__F, "ti_sysbios_syncs_SyncEvent_signal")
__extern xdc_Void ti_sysbios_syncs_SyncEvent_signal__F( ti_sysbios_syncs_SyncEvent_Object* __inst );
__extern xdc_Void ti_sysbios_syncs_SyncEvent_signal__R( ti_sysbios_syncs_SyncEvent_Handle __inst );
...
xdc__CODESECT(ti_sysbios_syncs_SyncEvent_wait__F, "ti_sysbios_syncs_SyncEvent_wait")
__extern xdc_Int ti_sysbios_syncs_SyncEvent_wait__F( ti_sysbios_syncs_SyncEvent_Object* __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
__extern xdc_Int ti_sysbios_syncs_SyncEvent_wait__R( ti_sysbios_syncs_SyncEvent_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb );
...
/* query_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_syncs_SyncEvent_query_FxnT)(void*, xdc_Int);
static inline ti_sysbios_syncs_SyncEvent_query_FxnT ti_sysbios_syncs_SyncEvent_query_fxnP( void )
{
    return (ti_sysbios_syncs_SyncEvent_query_FxnT)ti_sysbios_syncs_SyncEvent_query; 
}

/* signal_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_syncs_SyncEvent_signal_FxnT)(void*);
static inline ti_sysbios_syncs_SyncEvent_signal_FxnT ti_sysbios_syncs_SyncEvent_signal_fxnP( void )
{
    return (ti_sysbios_syncs_SyncEvent_signal_FxnT)ti_sysbios_syncs_SyncEvent_signal; 
}

/* wait_{FxnT,fxnP} */
typedef xdc_Int (*ti_sysbios_syncs_SyncEvent_wait_FxnT)(void*, xdc_UInt, xdc_runtime_Error_Block*);
static inline ti_sysbios_syncs_SyncEvent_wait_FxnT ti_sysbios_syncs_SyncEvent_wait_fxnP( void )
{
    return (ti_sysbios_syncs_SyncEvent_wait_FxnT)ti_sysbios_syncs_SyncEvent_wait; 
}
...
{
    if (dst) {
        ti_sysbios_syncs_SyncEvent_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_syncs_SyncEvent_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sysbios_syncs_SyncEvent_Handle_name( ti_sysbios_syncs_SyncEvent_Handle inst )
{
...
/* create */
static inline ti_sysbios_syncs_SyncEvent_Handle ti_sysbios_syncs_SyncEvent_create( const ti_sysbios_syncs_SyncEvent_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_sysbios_syncs_SyncEvent_Handle)ti_sysbios_syncs_SyncEvent_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_syncs_SyncEvent_Params), __eb);
}

/* construct */
static inline void ti_sysbios_syncs_SyncEvent_construct( ti_sysbios_syncs_SyncEvent_Struct* __obj, const ti_sysbios_syncs_SyncEvent_Params* __prms )
{
    ti_sysbios_syncs_SyncEvent_Object__create__S(__obj, sizeof (ti_sysbios_syncs_SyncEvent_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_syncs_SyncEvent_Params), NULL);
}

/* delete */
static inline void ti_sysbios_syncs_SyncEvent_delete( ti_sysbios_syncs_SyncEvent_Handle* instp )
{
    ti_sysbios_syncs_SyncEvent_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_syncs_SyncEvent_destruct( ti_sysbios_syncs_SyncEvent_Struct* obj )
{
    ti_sysbios_syncs_SyncEvent_Object__destruct__S(obj);
}
...
#define SyncEvent_query_fxnP ti_sysbios_syncs_SyncEvent_query_fxnP
#define SyncEvent_query_FxnT ti_sysbios_syncs_SyncEvent_query_FxnT
#define SyncEvent_signal ti_sysbios_syncs_SyncEvent_signal
#define SyncEvent_signal_fxnP ti_sysbios_syncs_SyncEvent_signal_fxnP
#define SyncEvent_signal_FxnT ti_sysbios_syncs_SyncEvent_signal_FxnT
#define SyncEvent_wait ti_sysbios_syncs_SyncEvent_wait
#define SyncEvent_wait_fxnP ti_sysbios_syncs_SyncEvent_wait_fxnP
#define SyncEvent_wait_FxnT ti_sysbios_syncs_SyncEvent_wait_FxnT
