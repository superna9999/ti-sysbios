...
#define ti_sysbios_syncs_SyncSem_query ti_sysbios_syncs_SyncSem_query__F

/* signal */
#undef ti_sysbios_syncs_SyncSem_signal
#define ti_sysbios_syncs_SyncSem_signal ti_sysbios_syncs_SyncSem_signal__F

/* wait */
#undef ti_sysbios_syncs_SyncSem_wait
#define ti_sysbios_syncs_SyncSem_wait ti_sysbios_syncs_SyncSem_wait__F

/* Module_startup */
#undef ti_sysbios_syncs_SyncSem_Module_startup
#define ti_sysbios_syncs_SyncSem_Module_startup ti_sysbios_syncs_SyncSem_Module_startup__F

/* Instance_init */
#undef ti_sysbios_syncs_SyncSem_Instance_init
#define ti_sysbios_syncs_SyncSem_Instance_init ti_sysbios_syncs_SyncSem_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_syncs_SyncSem_Instance_finalize
#define ti_sysbios_syncs_SyncSem_Instance_finalize ti_sysbios_syncs_SyncSem_Instance_finalize__F
