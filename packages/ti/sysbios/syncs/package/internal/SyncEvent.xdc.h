...
#define ti_sysbios_syncs_SyncEvent_query ti_sysbios_syncs_SyncEvent_query__F

/* signal */
#undef ti_sysbios_syncs_SyncEvent_signal
#define ti_sysbios_syncs_SyncEvent_signal ti_sysbios_syncs_SyncEvent_signal__F

/* wait */
#undef ti_sysbios_syncs_SyncEvent_wait
#define ti_sysbios_syncs_SyncEvent_wait ti_sysbios_syncs_SyncEvent_wait__F

/* Module_startup */
#undef ti_sysbios_syncs_SyncEvent_Module_startup
#define ti_sysbios_syncs_SyncEvent_Module_startup ti_sysbios_syncs_SyncEvent_Module_startup__F

/* Instance_init */
#undef ti_sysbios_syncs_SyncEvent_Instance_init
#define ti_sysbios_syncs_SyncEvent_Instance_init ti_sysbios_syncs_SyncEvent_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_syncs_SyncEvent_Instance_finalize
#define ti_sysbios_syncs_SyncEvent_Instance_finalize ti_sysbios_syncs_SyncEvent_Instance_finalize__F
