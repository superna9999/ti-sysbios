...
public class ti_sysbios_utils
{
    ...
    void Load$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.utils.Load.addTask", new Extern("ti_sysbios_utils_Load_addTask__E", "xdc_Bool(*)(ti_sysbios_knl_Task_Handle,ti_sysbios_utils_Load_HookContext*)", true, false));
    ...
    void Load$$SIZES()
    {
        ...
        sizes.add(Global.newArray("taskStartTime", "UInt32"));
        ...
        sizes.add(Global.newArray("gate", "Sti.sysbios.gates.GateMutex;Instance_State"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
    ...
    void Load$$TYPES()
    {
        ...
        po.init("ti.sysbios.utils.Load.Module_State", null);
                ...
                po.addFld("taskStartTime", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("timeElapsed", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("runningTask", (Proto)om.findStrict("ti.sysbios.knl.Task.Handle", "ti.sysbios.utils"), $$UNDEF, "w");
                ...
                po.addFldV("gate", (Proto)om.findStrict("ti.sysbios.gates.GateMutex.Object", "ti.sysbios.utils"), $$DEFAULT, "wh", $$objFldGet, $$objFldSet);
                po.addFld("Object_field_gate", (Proto)om.findStrict("ti.sysbios.gates.GateMutex.Object", "ti.sysbios.utils"), $$DEFAULT, "w");
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/ti.sysbios.utils.a64',\n");
            sb.append("'lib/debug/ti.sysbios.utils.a64P',\n");
            sb.append("'lib/debug/ti.sysbios.utils.a64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.utils.a674',\n");
            sb.append("'lib/debug/ti.sysbios.utils.a430',\n");
            sb.append("'lib/debug/ti.sysbios.utils.a430X',\n");
            sb.append("'lib/debug/ti.sysbios.utils.a430XS',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae430X',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae430XS',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.utils.ae64T',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.utils.aea8f',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.utils.aer4te',\n");
            sb.append("'lib/debug/ti.sysbios.utils.aer4fte',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.utils.a86W',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/ti.sysbios.utils.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.a430', {target: 'ti.targets.msp430.MSP430', suffix: '430'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.a430X', {target: 'ti.targets.msp430.MSP430X', suffix: '430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.a430XS', {target: 'ti.targets.msp430.MSP430X_small', suffix: '430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae430XS', {target: 'ti.targets.msp430.elf.MSP430X_small', suffix: 'e430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.utils.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.utils.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/debug/ti.sysbios.utils.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.utils.a86W', {target: 'microsoft.targets.Win32', suffix: '86W'}],\n");
        sb.append("];\n");
    ...
    void Load$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_utils_Load_Module__startupDone__E", "ti_sysbios_utils_Load_getTaskLoad__E", "ti_sysbios_utils_Load_update__E", "ti_sysbios_utils_Load_reset__E", "ti_sysbios_utils_Load_getGlobalSwiLoad__E", "ti_sysbios_utils_Load_getGlobalHwiLoad__E", "ti_sysbios_utils_Load_getCPULoad__E", "ti_sysbios_utils_Load_calculateLoad__E", "ti_sysbios_utils_Load_setMinIdle__E", "ti_sysbios_utils_Load_addTask__E", "ti_sysbios_utils_Load_removeTask__E", "ti_sysbios_utils_Load_idleFxn__E", "ti_sysbios_utils_Load_taskCreateHook__E", "ti_sysbios_utils_Load_taskDeleteHook__E", "ti_sysbios_utils_Load_taskSwitchHook__E", "ti_sysbios_utils_Load_swiBeginHook__E", "ti_sysbios_utils_Load_swiEndHook__E", "ti_sysbios_utils_Load_hwiBeginHook__E", "ti_sysbios_utils_Load_hwiEndHook__E", "ti_sysbios_utils_Load_taskRegHook__E"));
