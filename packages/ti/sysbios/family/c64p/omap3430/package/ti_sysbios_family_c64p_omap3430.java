...
public class ti_sysbios_family_c64p_omap3430
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.omap3430.a64P',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.omap3430.a64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.omap3430.a674',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.omap3430.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.omap3430.ae64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.omap3430.ae674',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.omap3430.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.omap3430.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.omap3430.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.omap3430.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.omap3430.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
    ...
    void Wugen$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "applyMasks", "entry", "%p", "exit", ""));
        loggables.add(Global.newObject("name", "disableDma", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "disableEvent", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "enableDma", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "enableEvent", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "getMasks", "entry", "%p", "exit", ""));
        loggables.add(Global.newObject("name", "ierToMasks", "entry", "%p", "exit", ""));
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("Wugen", vo);
