...
#define ti_sysbios_family_c64p_MemoryProtect___VERS 150
...
xdc__CODESECT(ti_sysbios_family_c64p_MemoryProtect_Module_startup__R, "ti_sysbios_family_c64p_MemoryProtect_Module_startup")
__extern xdc_Int ti_sysbios_family_c64p_MemoryProtect_Module_startup__R( xdc_Int state );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_family_c64p_MemoryProtect_Module__startupDone__S, "ti_sysbios_family_c64p_MemoryProtect_Module__startupDone")
...
xdc__CODESECT(ti_sysbios_family_c64p_MemoryProtect_getPA__F, "ti_sysbios_family_c64p_MemoryProtect_getPA")
__extern xdc_Bool ti_sysbios_family_c64p_MemoryProtect_getPA__F( xdc_Ptr addr, xdc_UInt32* paMask );
__extern xdc_Bool ti_sysbios_family_c64p_MemoryProtect_getPA__R( xdc_Ptr addr, xdc_UInt32* paMask );
...
xdc__CODESECT(ti_sysbios_family_c64p_MemoryProtect_setPA__F, "ti_sysbios_family_c64p_MemoryProtect_setPA")
__extern xdc_Bool ti_sysbios_family_c64p_MemoryProtect_setPA__F( xdc_Ptr addr, xdc_SizeT size, xdc_UInt32 paMask );
__extern xdc_Bool ti_sysbios_family_c64p_MemoryProtect_setPA__R( xdc_Ptr addr, xdc_SizeT size, xdc_UInt32 paMask );
...
xdc__CODESECT(ti_sysbios_family_c64p_MemoryProtect_getPageSize__F, "ti_sysbios_family_c64p_MemoryProtect_getPageSize")
__extern xdc_Bool ti_sysbios_family_c64p_MemoryProtect_getPageSize__F( xdc_Ptr addr, xdc_UInt* pageSize );
__extern xdc_Bool ti_sysbios_family_c64p_MemoryProtect_getPageSize__R( xdc_Ptr addr, xdc_UInt* pageSize );
...
xdc__CODESECT(ti_sysbios_family_c64p_MemoryProtect_getPrivMode__F, "ti_sysbios_family_c64p_MemoryProtect_getPrivMode")
__extern xdc_UInt ti_sysbios_family_c64p_MemoryProtect_getPrivMode__F( void );
__extern xdc_UInt ti_sysbios_family_c64p_MemoryProtect_getPrivMode__R( void );
...
xdc__CODESECT(ti_sysbios_family_c64p_MemoryProtect_setPrivMode__F, "ti_sysbios_family_c64p_MemoryProtect_setPrivMode")
__extern xdc_Void ti_sysbios_family_c64p_MemoryProtect_setPrivMode__F( xdc_UInt mode );
__extern xdc_Void ti_sysbios_family_c64p_MemoryProtect_setPrivMode__R( xdc_UInt mode );
