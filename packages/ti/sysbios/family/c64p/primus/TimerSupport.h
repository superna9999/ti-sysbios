...
#define ti_sysbios_family_c64p_primus_TimerSupport___VERS 150
...
xdc__CODESECT(ti_sysbios_family_c64p_primus_TimerSupport_Module__startupDone__S, "ti_sysbios_family_c64p_primus_TimerSupport_Module__startupDone")
...
xdc__CODESECT(ti_sysbios_family_c64p_primus_TimerSupport_enable__F, "ti_sysbios_family_c64p_primus_TimerSupport_enable")
__extern xdc_Void ti_sysbios_family_c64p_primus_TimerSupport_enable__F( xdc_UInt timerId, xdc_runtime_Error_Block* eb );
__extern xdc_Void ti_sysbios_family_c64p_primus_TimerSupport_enable__R( xdc_UInt timerId, xdc_runtime_Error_Block* eb );
