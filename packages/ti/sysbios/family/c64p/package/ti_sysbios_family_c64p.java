...
public class ti_sysbios_family_c64p
{
    ...
    void Hwi$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.c64p.Hwi.Object", new Proto.Str(po, false));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.a64P',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.a64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.a674',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.family.c64p.ae64Pe',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.family.c64p.ae64T',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.c64p.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.family.c64p.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void EventCombiner$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "disableEvent", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "enableEvent", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "dispatch", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "dispatchPlug", "entry", "0x%x, %p, %p, %d", "exit", ""));
        loggables.add(Global.newObject("name", "unused", "entry", "%p", "exit", ""));
    ...
    void MemoryProtect$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "getPA", "entry", "%p, %p", "exit", "%d"));
        loggables.add(Global.newObject("name", "setPA", "entry", "%p, 0x%x, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "getPageSize", "entry", "%p, %p", "exit", "%d"));
        loggables.add(Global.newObject("name", "getPrivMode", "entry", "", "exit", "0x%x"));
        loggables.add(Global.newObject("name", "setPrivMode", "entry", "0x%x", "exit", ""));
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("MemoryProtect", vo);
    ...
    void $$INITIALIZATION()
    {
        ...
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("ti.sysbios.family.c64p.Exception", "ti.sysbios.family.c64p");
            Global.put(vo, "rovViewInfo", Global.callFxn("create", (Scriptable)om.find("xdc.rov.ViewInfo"), Global.newObject("viewMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"Exception", Global.newObject("type", om.find("xdc.rov.ViewInfo.TREE"), "viewInitFxn", "viewInitException", "structName", "Context")})}))));
        }//isCFG
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("ti.sysbios.family.c64p.Hwi", "ti.sysbios.family.c64p");
