...
public class ti_sysbios_family_msp430
{
    ...
    void Hwi$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.msp430.Hwi.Object", new Proto.Str(po, false));
    ...
    void Timer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.msp430.Timer.Object", new Proto.Str(po, false));
    ...
    {
        // module Timer
        om.bind("ti.sysbios.family.msp430.Timer.Source_ACLK", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.msp430.Timer.Source", "ti.sysbios.family.msp430"), "ti.sysbios.family.msp430.Timer.Source_ACLK", 0));
        om.bind("ti.sysbios.family.msp430.Timer.Source_SMCLK", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.msp430.Timer.Source", "ti.sysbios.family.msp430"), "ti.sysbios.family.msp430.Timer.Source_SMCLK", 1));
        om.bind("ti.sysbios.family.msp430.Timer.Source_EXTERNAL", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.msp430.Timer.Source", "ti.sysbios.family.msp430"), "ti.sysbios.family.msp430.Timer.Source_EXTERNAL", 2));
        om.bind("ti.sysbios.family.msp430.Timer.Source_EXTERNAL_INVERTED", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.msp430.Timer.Source", "ti.sysbios.family.msp430"), "ti.sysbios.family.msp430.Timer.Source_EXTERNAL_INVERTED", 3));
    ...
    void Timer$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("controlRegInit", (Proto)om.findStrict("ti.sysbios.family.msp430.Timer.Control", "ti.sysbios.family.msp430"), Global.newObject("source", om.find("ti.sysbios.family.msp430.Timer.Source_ACLK")), "w");
                        po.addFld("instance", (Proto)om.findStrict("xdc.runtime.IInstance.Params", "ti.sysbios.family.msp430"), $$UNDEF, "w");
        }//isCFG
    ...
    void TimestampProvider$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.msp430.TimestampProvider.Module", om.findStrict("xdc.runtime.ITimestampProvider.Module", "ti.sysbios.family.msp430"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
    ...
    void Power$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.msp430.Power.Module", om.findStrict("xdc.runtime.IModule.Module", "ti.sysbios.family.msp430"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.msp430.a430',\n");
            sb.append("'lib/debug/ti.sysbios.family.msp430.a430X',\n");
            sb.append("'lib/debug/ti.sysbios.family.msp430.a430XS',\n");
            sb.append("'lib/debug/ti.sysbios.family.msp430.ae430X',\n");
            sb.append("'lib/debug/ti.sysbios.family.msp430.ae430XS',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.msp430.a430', {target: 'ti.targets.msp430.MSP430', suffix: '430'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.msp430.a430X', {target: 'ti.targets.msp430.MSP430X', suffix: '430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.msp430.a430XS', {target: 'ti.targets.msp430.MSP430X_small', suffix: '430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.msp430.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.msp430.ae430XS', {target: 'ti.targets.msp430.elf.MSP430X_small', suffix: 'e430XS'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
