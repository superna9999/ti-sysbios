...
public class ti_sysbios_family_arp32
{
    ...
    void Hwi$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.arp32.Hwi.Object", new Proto.Str(po, false));
    ...
    void Timer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.arp32.Timer.Object", new Proto.Str(po, false));
    ...
    {
        // module Hwi
        om.bind("ti.sysbios.family.arp32.Hwi.NUM_INTERRUPTS", 32L);
        om.bind("ti.sysbios.family.arp32.Hwi.NUM_VECTORS", 8L);
        ...
        om.bind("ti.sysbios.family.arp32.Hwi.dispatchCore", new Extern("ti_sysbios_family_arp32_Hwi_dispatchCore__I", "xdc_Void(*)(xdc_Void)", true, false));
    ...
    void Hwi$$SIZES()
    {
        ...
        sizes.add(Global.newArray("vectorNum", "UInt16"));
        sizes.add(Global.newArray("index", "UInt16"));
        ...
        sizes.clear();
        sizes.add(Global.newArray("interruptMask", "UInt32"));
        sizes.add(Global.newArray("disableIerMask", "UInt16"));
        sizes.add(Global.newArray("restoreIerMask", "UInt16"));
        ...
        sizes.add(Global.newArray("irp", "A8;UIArg"));
        sizes.add(Global.newArray("dispatchTable", "A32;UPtr"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
    ...
    void Hwi$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arp32.Hwi.Module", om.findStrict("ti.sysbios.interfaces.IHwi.Module", "ti.sysbios.family.arp32"));
                ...
                po.addFld("NUM_VECTORS", Proto.Elm.newCNum("(xdc_Int)"), 8L, "rh");
        if (isCFG) {
            ...
            po.addFld("INTCREGSBASEADDR", new Proto.Adr("ti_sysbios_family_arp32_Hwi_IntcRegs*", "PS"), 0x40080200L, "w");
            ...
            po.addFld("vectors", new Proto.Arr((Proto)om.findStrict("ti.sysbios.family.arp32.Hwi.VectorObj", "ti.sysbios.family.arp32"), false, xdc.services.intern.xsr.Enum.intValue(8L)), $$DEFAULT, "wh");
            po.addFld("interrupt", new Proto.Arr((Proto)om.findStrict("ti.sysbios.family.arp32.Hwi.InterruptObj", "ti.sysbios.family.arp32"), false, xdc.services.intern.xsr.Enum.intValue(32L)), $$DEFAULT, "wh");
        }//isCFG
        if (isCFG) {
        ...
        if (isCFG) {
            ...
            po.addFld("vectorNum", Proto.Elm.newCNum("(xdc_Bits16)"), 4L, "w");
        ...
        po.init("ti.sysbios.family.arp32.Hwi.Instance_State", null);
                ...
                po.addFld("vectorNum", Proto.Elm.newCNum("(xdc_UInt16)"), $$UNDEF, "w");
                po.addFld("index", Proto.Elm.newCNum("(xdc_UInt16)"), $$UNDEF, "w");
                po.addFld("arg", new Proto.Adr("xdc_UArg", "Pv"), $$UNDEF, "w");
                po.addFld("fxn", new Proto.Adr("xdc_Void(*)(xdc_UArg)", "PFv"), $$UNDEF, "w");
        ...
        po.init("ti.sysbios.family.arp32.Hwi.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("interruptMask", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
                po.addFld("disableIerMask", Proto.Elm.newCNum("(xdc_Bits16)"), $$UNDEF, "w");
                po.addFld("restoreIerMask", Proto.Elm.newCNum("(xdc_Bits16)"), $$UNDEF, "w");
                ...
                po.addFld("irp", new Proto.Arr(new Proto.Adr("xdc_UArg", "Pv"), false, xdc.services.intern.xsr.Enum.intValue(8L)), $$DEFAULT, "w");
                po.addFld("dispatchTable", new Proto.Arr((Proto)om.findStrict("ti.sysbios.family.arp32.Hwi.Handle", "ti.sysbios.family.arp32"), false, xdc.services.intern.xsr.Enum.intValue(32L)), $$DEFAULT, "w");
    }
    ...
    void TimestampProvider$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arp32.TimestampProvider.Module", om.findStrict("xdc.runtime.ITimestampProvider.Module", "ti.sysbios.family.arp32"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
        }//isCFG
        fxn = Global.get(cap, "module$use");
    ...
    void Hwi$$SINGLETONS()
    {
        ...
        mcfgs.add("INTCREGSBASEADDR");
        icfgs.add("INTCREGSBASEADDR");
        ...
        loggables.add(Global.newObject("name", "selfLoop", "entry", "%p", "exit", ""));
