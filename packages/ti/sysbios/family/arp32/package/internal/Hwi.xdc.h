...
#define ti_sysbios_family_arp32_Hwi_getStackInfo ti_sysbios_family_arp32_Hwi_getStackInfo__F
...
#define ti_sysbios_family_arp32_Hwi_selfLoop ti_sysbios_family_arp32_Hwi_selfLoop__F

/* getHandle */
#undef ti_sysbios_family_arp32_Hwi_getHandle
#define ti_sysbios_family_arp32_Hwi_getHandle ti_sysbios_family_arp32_Hwi_getHandle__F

/* disableIER */
#undef ti_sysbios_family_arp32_Hwi_disableIER
#define ti_sysbios_family_arp32_Hwi_disableIER ti_sysbios_family_arp32_Hwi_disableIER__F

/* enableIER */
#undef ti_sysbios_family_arp32_Hwi_enableIER
#define ti_sysbios_family_arp32_Hwi_enableIER ti_sysbios_family_arp32_Hwi_enableIER__F

/* restoreIER */
#undef ti_sysbios_family_arp32_Hwi_restoreIER
#define ti_sysbios_family_arp32_Hwi_restoreIER ti_sysbios_family_arp32_Hwi_restoreIER__F

/* reconfig */
#undef ti_sysbios_family_arp32_Hwi_reconfig
#define ti_sysbios_family_arp32_Hwi_reconfig ti_sysbios_family_arp32_Hwi_reconfig__F
...
#define ti_sysbios_family_arp32_Hwi_Module_startup ti_sysbios_family_arp32_Hwi_Module_startup__F

/* Instance_init */
#undef ti_sysbios_family_arp32_Hwi_Instance_init
#define ti_sysbios_family_arp32_Hwi_Instance_init ti_sysbios_family_arp32_Hwi_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_family_arp32_Hwi_Instance_finalize
#define ti_sysbios_family_arp32_Hwi_Instance_finalize ti_sysbios_family_arp32_Hwi_Instance_finalize__F
