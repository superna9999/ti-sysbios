...
#define ti_sysbios_family_arp32_Hwi___VERS 150
...
/* NUM_INTERRUPTS */
#define ti_sysbios_family_arp32_Hwi_NUM_INTERRUPTS (32)

/* NUM_VECTORS */
#define ti_sysbios_family_arp32_Hwi_NUM_VECTORS (8)
...
typedef ti_sysbios_family_arp32_Hwi_Irp __ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__irp[8];
...
typedef ti_sysbios_family_arp32_Hwi_Handle __ARRAY1_ti_sysbios_family_arp32_Hwi_Module_State__dispatchTable[32];
...
/* INTCREGSBASEADDR */
#define ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDR (ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDR__C)
typedef ti_sysbios_family_arp32_Hwi_IntcRegs* CT__ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDR;
__extern __FAR__ const CT__ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDR ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDR__C;
...
struct ti_sysbios_family_arp32_Hwi_Struct {
    ...
    xdc_UInt16 __f3;
    xdc_UArg __f4;
    ti_sysbios_family_arp32_Hwi_FuncPtr __f5;
    ti_sysbios_family_arp32_Hwi_Irp __f6;
    __TA_ti_sysbios_family_arp32_Hwi_Instance_State__hookEnv __f7;
...
__extern xdc_Void ti_sysbios_family_arp32_Hwi_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
__extern xdc_Void ti_sysbios_family_arp32_Hwi_dispatchCore__I( void );
...
{
    if (dst) {
        ti_sysbios_family_arp32_Hwi_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_family_arp32_Hwi_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
#define Hwi_INTCREGSBASEADDR ti_sysbios_family_arp32_Hwi_INTCREGSBASEADDR
