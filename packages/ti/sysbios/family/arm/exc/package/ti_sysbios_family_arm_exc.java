...
public class ti_sysbios_family_arm_exc
{
    ...
    void Exception$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.exc.Exception.init", new Extern("ti_sysbios_family_arm_exc_Exception_init__I", "xdc_Void(*)(xdc_Void)", true, false));
    ...
    void Exception$$SIZES()
    {
        ...
        sizes.add(Global.newArray("excStackBuffer", "UPtr"));
    ...
    void Exception$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("excStackSize", Proto.Elm.newCNum("(xdc_SizeT)"), 128L, "wh");
        ...
        po.init("ti.sysbios.family.arm.exc.Exception.Module_State", null);
                ...
                po.addFld("excContext", new Proto.Adr("ti_sysbios_family_arm_exc_Exception_ExcContext*", "PS"), $$UNDEF, "w");
                po.addFld("excStackBuffer", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("excStack", new Proto.Arr(Proto.Elm.newCNum("(xdc_Char)"), false), $$DEFAULT, "w");
    ...
    void Exception$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.exc.Exception$$Module_State", "ti.sysbios.family.arm.exc");
        po.bind("excContext$fetchDesc", Global.newObject("type", "ti.sysbios.family.arm.exc.Exception.ExcContext", "isScalar", false));
        po.bind("excStack$fetchDesc", Global.newObject("type", "xdc.rov.support.ScalarStructs.S_Char", "isScalar", true));
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/ti.sysbios.family.arm.exc.aea8f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.exc.aea8fnv',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.exc.aer4te',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.exc.aer4fte',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.exc.ae9', {target: 'ti.targets.arm.elf.Arm9', suffix: 'e9'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.exc.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.exc.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.exc.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.exc.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
        sb.append("];\n");
    ...
    void Exception$$SINGLETONS()
    {
        ...
        vo.bind("init", om.findStrict("ti.sysbios.family.arm.exc.Exception.init", "ti.sysbios.family.arm.exc"));
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_exc_Exception_Module__startupDone__E"));
    ...
    void $$INITIALIZATION()
    {
        ...
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("ti.sysbios.family.arm.exc.Exception", "ti.sysbios.family.arm.exc");
            Global.put(vo, "rovViewInfo", Global.callFxn("create", (Scriptable)om.find("xdc.rov.ViewInfo"), Global.newObject("viewMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"Basic", Global.newObject("type", om.find("xdc.rov.ViewInfo.TREE"), "viewInitFxn", "viewInitBasic", "structName", "ExcContext")})}))));
        }//isCFG
