...
public class ti_sysbios_family_arm_ducati
{
    ...
    void GateDualCore$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.arm.ducati.GateDualCore.Object", new Proto.Str(po, false));
    ...
    void Timer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.arm.ducati.Timer.Object", new Proto.Str(po, false));
    ...
    void Core$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arm.ducati.Core.Module", om.findStrict("xdc.runtime.IModule.Module", "ti.sysbios.family.arm.ducati"));
    ...
    void Core$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_ducati_Core_Module__startupDone__E", "ti_sysbios_family_arm_ducati_Core_getId__E"));
    ...
    void Wugen$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "disableInterrupt", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "enableInterrupt", "entry", "0x%x", "exit", ""));
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("Wugen", vo);
