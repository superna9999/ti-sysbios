...
#define ti_sysbios_family_arm_ducati_CTM___VERS 150
...
xdc__CODESECT(ti_sysbios_family_arm_ducati_CTM_Module__startupDone__S, "ti_sysbios_family_arm_ducati_CTM_Module__startupDone")
