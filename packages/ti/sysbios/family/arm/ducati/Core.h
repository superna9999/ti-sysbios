...
#define ti_sysbios_family_arm_ducati_Core___VERS 150
...
xdc__CODESECT(ti_sysbios_family_arm_ducati_Core_Module__startupDone__S, "ti_sysbios_family_arm_ducati_Core_Module__startupDone")
