...
#define ti_sysbios_family_arm_ducati_TimerSupport___VERS 150
...
xdc__CODESECT(ti_sysbios_family_arm_ducati_TimerSupport_Module__startupDone__S, "ti_sysbios_family_arm_ducati_TimerSupport_Module__startupDone")
