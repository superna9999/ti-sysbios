...
#define ti_sysbios_family_arm_m3_Hwi___VERS 150
...
/* Module_State */
typedef xdc_Bits32 __T1_ti_sysbios_family_arm_m3_Hwi_Module_State__iser;
typedef xdc_Bits32 __ARRAY1_ti_sysbios_family_arm_m3_Hwi_Module_State__iser[8];
typedef __ARRAY1_ti_sysbios_family_arm_m3_Hwi_Module_State__iser __TA_ti_sysbios_family_arm_m3_Hwi_Module_State__iser;
typedef xdc_UInt8 __T1_ti_sysbios_family_arm_m3_Hwi_Module_State__priorities;
typedef xdc_UInt8 *__ARRAY1_ti_sysbios_family_arm_m3_Hwi_Module_State__priorities;
typedef __ARRAY1_ti_sysbios_family_arm_m3_Hwi_Module_State__priorities __TA_ti_sysbios_family_arm_m3_Hwi_Module_State__priorities;
typedef ti_sysbios_family_arm_m3_Hwi_Handle __T1_ti_sysbios_family_arm_m3_Hwi_Module_State__dispatchTable;
typedef ti_sysbios_family_arm_m3_Hwi_Handle *__ARRAY1_ti_sysbios_family_arm_m3_Hwi_Module_State__dispatchTable;
typedef __ARRAY1_ti_sysbios_family_arm_m3_Hwi_Module_State__dispatchTable __TA_ti_sysbios_family_arm_m3_Hwi_Module_State__dispatchTable;
...
struct ti_sysbios_family_arm_m3_Hwi_Struct {
    ...
    xdc_Int __f2;
    ti_sysbios_family_arm_m3_Hwi_Irp __f3;
    __TA_ti_sysbios_family_arm_m3_Hwi_Instance_State__hookEnv __f4;
...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Instance_init__F, "ti_sysbios_family_arm_m3_Hwi_Instance_init")
__extern int ti_sysbios_family_arm_m3_Hwi_Instance_init__F( ti_sysbios_family_arm_m3_Hwi_Object*, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arm_m3_Hwi_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Instance_finalize__F, "ti_sysbios_family_arm_m3_Hwi_Instance_finalize")
__extern void ti_sysbios_family_arm_m3_Hwi_Instance_finalize__F( ti_sysbios_family_arm_m3_Hwi_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Instance_init__R, "ti_sysbios_family_arm_m3_Hwi_Instance_init")
__extern int ti_sysbios_family_arm_m3_Hwi_Instance_init__R( ti_sysbios_family_arm_m3_Hwi_Object*, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arm_m3_Hwi_Params*, xdc_runtime_Error_Block* );
...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Handle__label__S, "ti_sysbios_family_arm_m3_Hwi_Handle__label")
...
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Module__startupDone__S, "ti_sysbios_family_arm_m3_Hwi_Module__startupDone")
__extern xdc_Bool ti_sysbios_family_arm_m3_Hwi_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Object__create__S, "ti_sysbios_family_arm_m3_Hwi_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Object__delete__S, "ti_sysbios_family_arm_m3_Hwi_Object__delete")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Object__destruct__S, "ti_sysbios_family_arm_m3_Hwi_Object__destruct")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Object__get__S, "ti_sysbios_family_arm_m3_Hwi_Object__get")
__extern xdc_Ptr ti_sysbios_family_arm_m3_Hwi_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Object__first__S, "ti_sysbios_family_arm_m3_Hwi_Object__first")
__extern xdc_Ptr ti_sysbios_family_arm_m3_Hwi_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Object__next__S, "ti_sysbios_family_arm_m3_Hwi_Object__next")
__extern xdc_Ptr ti_sysbios_family_arm_m3_Hwi_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_Params__init__S, "ti_sysbios_family_arm_m3_Hwi_Params__init")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_plug__E( xdc_UInt intNum, ti_sysbios_family_arm_m3_Hwi_VectorFuncPtr fxn );
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_plug__F, "ti_sysbios_family_arm_m3_Hwi_plug")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_plug__F( xdc_UInt intNum, ti_sysbios_family_arm_m3_Hwi_VectorFuncPtr fxn );
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_plug__R( xdc_UInt intNum, ti_sysbios_family_arm_m3_Hwi_VectorFuncPtr fxn );
...
/* allowInterrupts_wa1_1__E */
#define ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1 ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1__E
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1__E, "ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1__E( void );
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1__F, "ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1__F( void );
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1__R( void );
...
/* beginHook_wa1_1__I */
#define ti_sysbios_family_arm_m3_Hwi_beginHook_wa1_1 ti_sysbios_family_arm_m3_Hwi_beginHook_wa1_1__I
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_beginHook_wa1_1__I, "ti_sysbios_family_arm_m3_Hwi_beginHook_wa1_1")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_beginHook_wa1_1__I( ti_sysbios_interfaces_IHwi_Handle hwi );

/* initVTOR__I */
#define ti_sysbios_family_arm_m3_Hwi_initVTOR ti_sysbios_family_arm_m3_Hwi_initVTOR__I
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_initVTOR__I, "ti_sysbios_family_arm_m3_Hwi_initVTOR")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_initVTOR__I( void );
...
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_excFillContext__I( void );
...
/* init__I */
#define ti_sysbios_family_arm_m3_Hwi_init ti_sysbios_family_arm_m3_Hwi_init__I
xdc__CODESECT(ti_sysbios_family_arm_m3_Hwi_init__I, "ti_sysbios_family_arm_m3_Hwi_init")
__extern xdc_Void ti_sysbios_family_arm_m3_Hwi_init__I( void );
...
__extern xdc_UInt ti_sysbios_family_arm_m3_Hwi_dispatchC__I( ti_sysbios_family_arm_m3_Hwi_Irp irp );
...
/* getFunc_{FxnT,fxnP} */
typedef ti_sysbios_interfaces_IHwi_FuncPtr (*ti_sysbios_family_arm_m3_Hwi_getFunc_FxnT)(void*, xdc_UArg*);
static inline ti_sysbios_family_arm_m3_Hwi_getFunc_FxnT ti_sysbios_family_arm_m3_Hwi_getFunc_fxnP( void )
{
    return (ti_sysbios_family_arm_m3_Hwi_getFunc_FxnT)ti_sysbios_family_arm_m3_Hwi_getFunc; 
}

/* setFunc_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_family_arm_m3_Hwi_setFunc_FxnT)(void*, ti_sysbios_interfaces_IHwi_FuncPtr, xdc_UArg);
static inline ti_sysbios_family_arm_m3_Hwi_setFunc_FxnT ti_sysbios_family_arm_m3_Hwi_setFunc_fxnP( void )
{
    return (ti_sysbios_family_arm_m3_Hwi_setFunc_FxnT)ti_sysbios_family_arm_m3_Hwi_setFunc; 
}

/* getHookContext_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sysbios_family_arm_m3_Hwi_getHookContext_FxnT)(void*, xdc_Int);
static inline ti_sysbios_family_arm_m3_Hwi_getHookContext_FxnT ti_sysbios_family_arm_m3_Hwi_getHookContext_fxnP( void )
{
    return (ti_sysbios_family_arm_m3_Hwi_getHookContext_FxnT)ti_sysbios_family_arm_m3_Hwi_getHookContext; 
}

/* setHookContext_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_family_arm_m3_Hwi_setHookContext_FxnT)(void*, xdc_Int, xdc_Ptr);
static inline ti_sysbios_family_arm_m3_Hwi_setHookContext_FxnT ti_sysbios_family_arm_m3_Hwi_setHookContext_fxnP( void )
{
    return (ti_sysbios_family_arm_m3_Hwi_setHookContext_FxnT)ti_sysbios_family_arm_m3_Hwi_setHookContext; 
}

/* getIrp_{FxnT,fxnP} */
typedef ti_sysbios_interfaces_IHwi_Irp (*ti_sysbios_family_arm_m3_Hwi_getIrp_FxnT)(void*);
static inline ti_sysbios_family_arm_m3_Hwi_getIrp_FxnT ti_sysbios_family_arm_m3_Hwi_getIrp_fxnP( void )
{
    return (ti_sysbios_family_arm_m3_Hwi_getIrp_FxnT)ti_sysbios_family_arm_m3_Hwi_getIrp; 
}

/* reconfig_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_family_arm_m3_Hwi_reconfig_FxnT)(void*, ti_sysbios_family_arm_m3_Hwi_FuncPtr, const ti_sysbios_family_arm_m3_Hwi_Params*);
static inline ti_sysbios_family_arm_m3_Hwi_reconfig_FxnT ti_sysbios_family_arm_m3_Hwi_reconfig_fxnP( void )
{
    return (ti_sysbios_family_arm_m3_Hwi_reconfig_FxnT)ti_sysbios_family_arm_m3_Hwi_reconfig; 
}
...
{
    if (dst) {
        ti_sysbios_family_arm_m3_Hwi_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_family_arm_m3_Hwi_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline ti_sysbios_family_arm_m3_Hwi_Handle ti_sysbios_family_arm_m3_Hwi_create( xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arm_m3_Hwi_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_family_arm_m3_Hwi_Args__create __args;
    __args.intNum = intNum;
    __args.hwiFxn = hwiFxn;
    return (ti_sysbios_family_arm_m3_Hwi_Handle)ti_sysbios_family_arm_m3_Hwi_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_family_arm_m3_Hwi_Params), __eb);
}

/* construct */
static inline void ti_sysbios_family_arm_m3_Hwi_construct( ti_sysbios_family_arm_m3_Hwi_Struct* __obj, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arm_m3_Hwi_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_family_arm_m3_Hwi_Args__create __args;
    __args.intNum = intNum;
    __args.hwiFxn = hwiFxn;
    ti_sysbios_family_arm_m3_Hwi_Object__create__S(__obj, sizeof (ti_sysbios_family_arm_m3_Hwi_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_family_arm_m3_Hwi_Params), __eb);
}

/* delete */
static inline void ti_sysbios_family_arm_m3_Hwi_delete( ti_sysbios_family_arm_m3_Hwi_Handle* instp )
{
    ti_sysbios_family_arm_m3_Hwi_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_family_arm_m3_Hwi_destruct( ti_sysbios_family_arm_m3_Hwi_Struct* obj )
{
...
#define Hwi_getFunc_fxnP ti_sysbios_family_arm_m3_Hwi_getFunc_fxnP
#define Hwi_getFunc_FxnT ti_sysbios_family_arm_m3_Hwi_getFunc_FxnT
#define Hwi_setFunc ti_sysbios_family_arm_m3_Hwi_setFunc
#define Hwi_setFunc_fxnP ti_sysbios_family_arm_m3_Hwi_setFunc_fxnP
#define Hwi_setFunc_FxnT ti_sysbios_family_arm_m3_Hwi_setFunc_FxnT
#define Hwi_getHookContext ti_sysbios_family_arm_m3_Hwi_getHookContext
#define Hwi_getHookContext_fxnP ti_sysbios_family_arm_m3_Hwi_getHookContext_fxnP
#define Hwi_getHookContext_FxnT ti_sysbios_family_arm_m3_Hwi_getHookContext_FxnT
#define Hwi_setHookContext ti_sysbios_family_arm_m3_Hwi_setHookContext
#define Hwi_setHookContext_fxnP ti_sysbios_family_arm_m3_Hwi_setHookContext_fxnP
#define Hwi_setHookContext_FxnT ti_sysbios_family_arm_m3_Hwi_setHookContext_FxnT
#define Hwi_getIrp ti_sysbios_family_arm_m3_Hwi_getIrp
#define Hwi_getIrp_fxnP ti_sysbios_family_arm_m3_Hwi_getIrp_fxnP
#define Hwi_getIrp_FxnT ti_sysbios_family_arm_m3_Hwi_getIrp_FxnT
...
#define Hwi_allowInterrupts_wa1_1 ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1
#define Hwi_reconfig ti_sysbios_family_arm_m3_Hwi_reconfig
#define Hwi_reconfig_fxnP ti_sysbios_family_arm_m3_Hwi_reconfig_fxnP
#define Hwi_reconfig_FxnT ti_sysbios_family_arm_m3_Hwi_reconfig_FxnT
