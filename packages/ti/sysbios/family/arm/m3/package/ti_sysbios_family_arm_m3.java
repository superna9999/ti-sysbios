...
public class ti_sysbios_family_arm_m3
{
    ...
    void Hwi$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.sysbios.family.arm.m3.Hwi$$NonDispatchedInterrupt", new Proto.Obj());
        om.bind("ti.sysbios.family.arm.m3.Hwi.NonDispatchedInterrupt", new Proto.Str(spo, false));
        ...
        Object objP = om.bind("ti.sysbios.family.arm.m3.Hwi.Object", new Proto.Str(po, false));
    ...
    void Timer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.arm.m3.Timer.Object", new Proto.Str(po, false));
    ...
    void Hwi$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.m3.Hwi.plug", new Extern("ti_sysbios_family_arm_m3_Hwi_plug__E", "xdc_Void(*)(xdc_UInt,xdc_Void(*)(xdc_Void))", true, false));
        ...
        om.bind("ti.sysbios.family.arm.m3.Hwi.allowInterrupts_wa1_1", new Extern("ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.m3.Hwi.beginHook_wa1_1", new Extern("ti_sysbios_family_arm_m3_Hwi_beginHook_wa1_1__I", "xdc_Void(*)(ti_sysbios_interfaces_IHwi_Handle)", true, false));
        om.bind("ti.sysbios.family.arm.m3.Hwi.initVTOR", new Extern("ti_sysbios_family_arm_m3_Hwi_initVTOR__I", "xdc_Void(*)(xdc_Void)", true, false));
        ...
        om.bind("ti.sysbios.family.arm.m3.Hwi.excFillContext", new Extern("ti_sysbios_family_arm_m3_Hwi_excFillContext__I", "xdc_Void(*)(xdc_Void)", true, false));
        ...
        om.bind("ti.sysbios.family.arm.m3.Hwi.init", new Extern("ti_sysbios_family_arm_m3_Hwi_init__I", "xdc_Void(*)(xdc_Void)", true, false));
        ...
        om.bind("ti.sysbios.family.arm.m3.Hwi.dispatchC", new Extern("ti_sysbios_family_arm_m3_Hwi_dispatchC__I", "xdc_UInt(*)(xdc_UArg)", true, false));
    ...
    void Hwi$$SIZES()
    {
        ...
        sizes.clear();
        sizes.add(Global.newArray("enables", "UInt16"));
        sizes.add(Global.newArray("iser", "A8;UInt32"));
        sizes.add(Global.newArray("priorities", "UPtr"));
    ...
    void Hwi$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("E_memFault", (Proto)om.findStrict("xdc.runtime.Error$$Id", "ti.sysbios.family.arm.m3"), Global.newObject("msg", "E_memFault: %s"), "w");
            po.addFld("E_busFault", (Proto)om.findStrict("xdc.runtime.Error$$Id", "ti.sysbios.family.arm.m3"), Global.newObject("msg", "E_busFault: %s"), "w");
            ...
            po.addFld("nullIsrFunc", new Proto.Adr("xdc_Void(*)(xdc_Void)", "PFv"), $$UNDEF, "wh");
            ...
            po.addFld("nonDispatchedInterrupts", new Proto.Map((Proto)om.findStrict("ti.sysbios.family.arm.m3.Hwi.NonDispatchedInterrupt", "ti.sysbios.family.arm.m3")), $$DEFAULT, "wh");
            ...
            po.addFld("excHandlerFunc", new Proto.Adr("xdc_Void(*)(xdc_UInt*,xdc_UInt)", "PFv"), om.find("ti.sysbios.family.arm.m3.Hwi.excHandlerMin"), "w");
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.m3.Hwi$$NonDispatchedInterrupt", "ti.sysbios.family.arm.m3");
        po.init("ti.sysbios.family.arm.m3.Hwi.NonDispatchedInterrupt", null);
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("intNum", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF, "w");
                po.addFld("vfxn", new Proto.Adr("xdc_Void(*)(xdc_Void)", "PFv"), $$UNDEF, "w");
        ...
        po.init("ti.sysbios.family.arm.m3.Hwi.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("enables", Proto.Elm.newCNum("(xdc_Bits16)"), $$UNDEF, "w");
                po.addFld("iser", new Proto.Arr(Proto.Elm.newCNum("(xdc_Bits32)"), false, xdc.services.intern.xsr.Enum.intValue(8L)), $$DEFAULT, "w");
                po.addFld("priorities", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt8)"), false), $$DEFAULT, "w");
                po.addFld("taskSP", new Proto.Adr("xdc_Char*", "Pn"), $$UNDEF, "w");
                po.addFld("excActive", $$T_Bool, $$UNDEF, "w");
                po.addFld("excContext", new Proto.Adr("ti_sysbios_family_arm_m3_Hwi_ExcContext*", "PS"), $$UNDEF, "w");
                ...
                po.addFld("dispatchTable", new Proto.Arr((Proto)om.findStrict("ti.sysbios.family.arm.m3.Hwi.Handle", "ti.sysbios.family.arm.m3"), false), $$DEFAULT, "w");
    }
    ...
    void Hwi$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.m3.Hwi$$Module_State", "ti.sysbios.family.arm.m3");
        po.bind("priorities$fetchDesc", Global.newObject("type", "xdc.rov.support.ScalarStructs.S_UInt8", "isScalar", true));
        po.bind("excContext$fetchDesc", Global.newObject("type", "ti.sysbios.family.arm.m3.Hwi.ExcContext", "isScalar", false));
    ...
    void Hwi$$SINGLETONS()
    {
        ...
        mcfgs.add("priGroup");
        vo.bind("NonDispatchedInterrupt", om.findStrict("ti.sysbios.family.arm.m3.Hwi.NonDispatchedInterrupt", "ti.sysbios.family.arm.m3"));
        tdefs.add(om.findStrict("ti.sysbios.family.arm.m3.Hwi.NonDispatchedInterrupt", "ti.sysbios.family.arm.m3"));
        ...
        vo.bind("allowInterrupts_wa1_1", om.findStrict("ti.sysbios.family.arm.m3.Hwi.allowInterrupts_wa1_1", "ti.sysbios.family.arm.m3"));
        vo.bind("beginHook_wa1_1", om.findStrict("ti.sysbios.family.arm.m3.Hwi.beginHook_wa1_1", "ti.sysbios.family.arm.m3"));
        vo.bind("initVTOR", om.findStrict("ti.sysbios.family.arm.m3.Hwi.initVTOR", "ti.sysbios.family.arm.m3"));
        ...
        vo.bind("init", om.findStrict("ti.sysbios.family.arm.m3.Hwi.init", "ti.sysbios.family.arm.m3"));
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_m3_Hwi_Handle__label__E", "ti_sysbios_family_arm_m3_Hwi_Module__startupDone__E", "ti_sysbios_family_arm_m3_Hwi_Object__create__E", "ti_sysbios_family_arm_m3_Hwi_Object__delete__E", "ti_sysbios_family_arm_m3_Hwi_Object__destruct__E", "ti_sysbios_family_arm_m3_Hwi_Object__get__E", "ti_sysbios_family_arm_m3_Hwi_Object__first__E", "ti_sysbios_family_arm_m3_Hwi_Object__next__E", "ti_sysbios_family_arm_m3_Hwi_Params__init__E", "ti_sysbios_family_arm_m3_Hwi_getStackInfo__E", "ti_sysbios_family_arm_m3_Hwi_startup__E", "ti_sysbios_family_arm_m3_Hwi_switchFromBootStack__E", "ti_sysbios_family_arm_m3_Hwi_post__E", "ti_sysbios_family_arm_m3_Hwi_getTaskSP__E", "ti_sysbios_family_arm_m3_Hwi_clearInterrupt__E", "ti_sysbios_family_arm_m3_Hwi_getFunc__E", "ti_sysbios_family_arm_m3_Hwi_setFunc__E", "ti_sysbios_family_arm_m3_Hwi_getHookContext__E", "ti_sysbios_family_arm_m3_Hwi_setHookContext__E", "ti_sysbios_family_arm_m3_Hwi_getIrp__E", "ti_sysbios_family_arm_m3_Hwi_disable__E", "ti_sysbios_family_arm_m3_Hwi_enable__E", "ti_sysbios_family_arm_m3_Hwi_restore__E", "ti_sysbios_family_arm_m3_Hwi_disableInterrupt__E", "ti_sysbios_family_arm_m3_Hwi_enableInterrupt__E", "ti_sysbios_family_arm_m3_Hwi_restoreInterrupt__E", "ti_sysbios_family_arm_m3_Hwi_plug__E", "ti_sysbios_family_arm_m3_Hwi_getHandle__E", "ti_sysbios_family_arm_m3_Hwi_setPriority__E", "ti_sysbios_family_arm_m3_Hwi_excSetBuffers__E", "ti_sysbios_family_arm_m3_Hwi_allowInterrupts_wa1_1__E", "ti_sysbios_family_arm_m3_Hwi_reconfig__E"));
        vo.bind("$$logEvtCfgs", Global.newArray("LM_begin", "LD_end"));
        vo.bind("$$errorDescCfgs", Global.newArray("E_alreadyDefined", "E_exception", "E_noIsr", "E_NMI", "E_hardFault", "E_memFault", "E_busFault", "E_usageFault", "E_svCall", "E_debugMon", "E_reserved"));
