...
#define ti_sysbios_family_arm_IntrinsicsSupport___VERS 150
...
xdc__CODESECT(ti_sysbios_family_arm_IntrinsicsSupport_Module__startupDone__S, "ti_sysbios_family_arm_IntrinsicsSupport_Module__startupDone")
...
xdc__CODESECT(ti_sysbios_family_arm_IntrinsicsSupport_maxbit__F, "ti_sysbios_family_arm_IntrinsicsSupport_maxbit")
__extern xdc_UInt ti_sysbios_family_arm_IntrinsicsSupport_maxbit__F( xdc_UInt bits );
__extern xdc_UInt ti_sysbios_family_arm_IntrinsicsSupport_maxbit__R( xdc_UInt bits );
...
#endif
/*
 *  @(#) ti.sysbios.family.arm; 2, 0, 0, 0,296; 5-18-2012 06:03:44; /db/vtree/library/trees/avala/avala-q37x/src/ xlibrary
