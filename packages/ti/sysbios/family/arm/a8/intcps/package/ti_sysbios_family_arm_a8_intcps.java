...
public class ti_sysbios_family_arm_a8_intcps
{
    ...
    void Hwi$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.sysbios.family.arm.a8.intcps.Hwi$$ExcContext", new Proto.Obj());
        om.bind("ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext", new Proto.Str(spo, false));
        ...
        Object objP = om.bind("ti.sysbios.family.arm.a8.intcps.Hwi.Object", new Proto.Str(po, false));
    ...
    void Hwi$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.a8.intcps.Hwi.init", new Extern("ti_sysbios_family_arm_a8_intcps_Hwi_init__I", "xdc_Void(*)(xdc_Void)", true, false));
    ...
    void Hwi$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext", "ti.sysbios.family.arm.a8.intcps");
        sizes.clear();
        ...
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext'], fld); }");
        so.bind("$offsetof", fxn);
    ...
    void Hwi$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("enableException", $$T_Bool, false, "wh");
            ...
            po.addFld("excStack", new Proto.Adr("xdc_Ptr", "Pv"), null, "w");
            po.addFld("excStackSize", Proto.Elm.newCNum("(xdc_SizeT)"), 1024L, "wh");
            ...
            po.addFld("E_excMin", (Proto)om.findStrict("xdc.runtime.Error$$Id", "ti.sysbios.family.arm.a8.intcps"), Global.newObject("msg", "E_exception: pc = 0x%08x, lr = 0x%08x."), "w");
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.a8.intcps.Hwi$$ExcContext", "ti.sysbios.family.arm.a8.intcps");
        po.init("ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("threadType", (Proto)om.findStrict("ti.sysbios.BIOS.ThreadType", "ti.sysbios.family.arm.a8.intcps"), $$UNDEF, "w");
    ...
    void Hwi$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.a8.intcps.Hwi$$Intc", "ti.sysbios.family.arm.a8.intcps");
        vo.bind("ExcContext$fetchDesc", Global.newObject("type", "ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.a8.intcps.Hwi$$ExcContext", "ti.sysbios.family.arm.a8.intcps");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.a8.intcps.aea8f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.a8.intcps.aea8fnv',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.a8.intcps.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
    ...
    void Hwi$$SINGLETONS()
    {
        ...
        vo.bind("intc", om.findStrict("ti.sysbios.family.arm.a8.intcps.Hwi.intc", "ti.sysbios.family.arm.a8.intcps"));
        vo.bind("ExcContext", om.findStrict("ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext", "ti.sysbios.family.arm.a8.intcps"));
        tdefs.add(om.findStrict("ti.sysbios.family.arm.a8.intcps.Hwi.ExcContext", "ti.sysbios.family.arm.a8.intcps"));
        mcfgs.add("fiqStack");
        mcfgs.add("excStack");
        mcfgs.add("mir0Mask");
        mcfgs.add("mir1Mask");
