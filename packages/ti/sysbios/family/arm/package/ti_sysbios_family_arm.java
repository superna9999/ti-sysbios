...
public class ti_sysbios_family_arm
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/ti.sysbios.family.arm.aea8f',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.aea8fnv',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.aer4te',\n");
            sb.append("'lib/debug/ti.sysbios.family.arm.aer4fte',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.ae9', {target: 'ti.targets.arm.elf.Arm9', suffix: 'e9'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/debug/ti.sysbios.family.arm.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
        sb.append("];\n");
