...
public class ti_sysbios_family_c28
{
    ...
    void Hwi$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.c28.Hwi.Object", new Proto.Str(po, false));
    ...
    void Timer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.c28.Timer.Object", new Proto.Str(po, false));
    ...
    void Hwi$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.c28.Hwi.NUM_INTERRUPTS_PIE", 96L);
        om.bind("ti.sysbios.family.c28.Hwi.NUM_INTERRUPTS_ALL", Global.eval("32 + 96"));
    ...
    void TimestampProvider$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.c28.TimestampProvider.Module", om.findStrict("xdc.runtime.ITimestampProvider.Module", "ti.sysbios.family.c28"));
    ...
    void Hwi$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.c28.Hwi.Module", om.findStrict("ti.sysbios.interfaces.IHwi.Module", "ti.sysbios.family.c28"));
                ...
                po.addFld("NUM_INTERRUPTS_PIE", Proto.Elm.newCNum("(xdc_Int)"), 96L, "rh");
                po.addFld("NUM_INTERRUPTS_ALL", Proto.Elm.newCNum("(xdc_Int)"), Global.eval("32 + 96"), "rh");
        ...
        if (isCFG) {
            ...
            po.addFld("interrupt", new Proto.Arr((Proto)om.findStrict("ti.sysbios.family.c28.Hwi.InterruptObj", "ti.sysbios.family.c28"), false, xdc.services.intern.xsr.Enum.intValue(Global.eval("32 + 96"))), $$DEFAULT, "wh");
        }//isCFG
        if (isCFG) {
    ...
    void TaskSupport$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.c28.TaskSupport.Module", om.findStrict("ti.sysbios.interfaces.ITaskSupport.Module", "ti.sysbios.family.c28"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
            po.addFld("E_invalidStack", (Proto)om.findStrict("xdc.runtime.Error$$Id", "ti.sysbios.family.c28"), Global.newObject("msg", "Stack (%d) not located on PAGE 0 (stack must be located entirely below 0x10000)"), "w");
    ...
    void Timer$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "setPrescale", "entry", "%p, 0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "getPrescale", "entry", "%p", "exit", "0x%x"));
        loggables.add(Global.newObject("name", "getPrescaleCount", "entry", "%p", "exit", "0x%x"));
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("Timer", vo);
