...
#define ti_sysbios_family_c28_Hwi___VERS 150
...
/* NUM_INTERRUPTS_PIE */
#define ti_sysbios_family_c28_Hwi_NUM_INTERRUPTS_PIE (96)

/* NUM_INTERRUPTS_ALL */
#define ti_sysbios_family_c28_Hwi_NUM_INTERRUPTS_ALL (32 + 96)
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Module_startup__R, "ti_sysbios_family_c28_Hwi_Module_startup")
__extern xdc_Int ti_sysbios_family_c28_Hwi_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Instance_init__F, "ti_sysbios_family_c28_Hwi_Instance_init")
__extern int ti_sysbios_family_c28_Hwi_Instance_init__F( ti_sysbios_family_c28_Hwi_Object*, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_c28_Hwi_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Instance_finalize__F, "ti_sysbios_family_c28_Hwi_Instance_finalize")
__extern void ti_sysbios_family_c28_Hwi_Instance_finalize__F( ti_sysbios_family_c28_Hwi_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Instance_init__R, "ti_sysbios_family_c28_Hwi_Instance_init")
__extern int ti_sysbios_family_c28_Hwi_Instance_init__R( ti_sysbios_family_c28_Hwi_Object*, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_c28_Hwi_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Instance_finalize__R, "ti_sysbios_family_c28_Hwi_Instance_finalize")
__extern void ti_sysbios_family_c28_Hwi_Instance_finalize__R( ti_sysbios_family_c28_Hwi_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Handle__label__S, "ti_sysbios_family_c28_Hwi_Handle__label")
__extern xdc_runtime_Types_Label* ti_sysbios_family_c28_Hwi_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Module__startupDone__S, "ti_sysbios_family_c28_Hwi_Module__startupDone")
__extern xdc_Bool ti_sysbios_family_c28_Hwi_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Object__create__S, "ti_sysbios_family_c28_Hwi_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Object__delete__S, "ti_sysbios_family_c28_Hwi_Object__delete")
__extern xdc_Void ti_sysbios_family_c28_Hwi_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Object__destruct__S, "ti_sysbios_family_c28_Hwi_Object__destruct")
__extern xdc_Void ti_sysbios_family_c28_Hwi_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Object__get__S, "ti_sysbios_family_c28_Hwi_Object__get")
__extern xdc_Ptr ti_sysbios_family_c28_Hwi_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Object__first__S, "ti_sysbios_family_c28_Hwi_Object__first")
__extern xdc_Ptr ti_sysbios_family_c28_Hwi_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Object__next__S, "ti_sysbios_family_c28_Hwi_Object__next")
__extern xdc_Ptr ti_sysbios_family_c28_Hwi_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_family_c28_Hwi_Params__init__S, "ti_sysbios_family_c28_Hwi_Params__init")
__extern xdc_Void ti_sysbios_family_c28_Hwi_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_getStackInfo__F, "ti_sysbios_family_c28_Hwi_getStackInfo")
__extern xdc_Bool ti_sysbios_family_c28_Hwi_getStackInfo__F( ti_sysbios_interfaces_IHwi_StackInfo* stkInfo, xdc_Bool computeStackDepth );
__extern xdc_Bool ti_sysbios_family_c28_Hwi_getStackInfo__R( ti_sysbios_interfaces_IHwi_StackInfo* stkInfo, xdc_Bool computeStackDepth );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_startup__F, "ti_sysbios_family_c28_Hwi_startup")
__extern xdc_Void ti_sysbios_family_c28_Hwi_startup__F( void );
__extern xdc_Void ti_sysbios_family_c28_Hwi_startup__R( void );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_switchFromBootStack__F, "ti_sysbios_family_c28_Hwi_switchFromBootStack")
__extern xdc_Void ti_sysbios_family_c28_Hwi_switchFromBootStack__F( void );
__extern xdc_Void ti_sysbios_family_c28_Hwi_switchFromBootStack__R( void );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_post__F, "ti_sysbios_family_c28_Hwi_post")
__extern xdc_Void ti_sysbios_family_c28_Hwi_post__F( xdc_UInt intNum );
__extern xdc_Void ti_sysbios_family_c28_Hwi_post__R( xdc_UInt intNum );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_getTaskSP__F, "ti_sysbios_family_c28_Hwi_getTaskSP")
__extern xdc_Char* ti_sysbios_family_c28_Hwi_getTaskSP__F( void );
__extern xdc_Char* ti_sysbios_family_c28_Hwi_getTaskSP__R( void );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_getFunc__F, "ti_sysbios_family_c28_Hwi_getFunc")
__extern ti_sysbios_interfaces_IHwi_FuncPtr ti_sysbios_family_c28_Hwi_getFunc__F( ti_sysbios_family_c28_Hwi_Object* __inst, xdc_UArg* arg );
__extern ti_sysbios_interfaces_IHwi_FuncPtr ti_sysbios_family_c28_Hwi_getFunc__R( ti_sysbios_family_c28_Hwi_Handle __inst, xdc_UArg* arg );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_setFunc__F, "ti_sysbios_family_c28_Hwi_setFunc")
__extern xdc_Void ti_sysbios_family_c28_Hwi_setFunc__F( ti_sysbios_family_c28_Hwi_Object* __inst, ti_sysbios_interfaces_IHwi_FuncPtr fxn, xdc_UArg arg );
__extern xdc_Void ti_sysbios_family_c28_Hwi_setFunc__R( ti_sysbios_family_c28_Hwi_Handle __inst, ti_sysbios_interfaces_IHwi_FuncPtr fxn, xdc_UArg arg );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_getHookContext__F, "ti_sysbios_family_c28_Hwi_getHookContext")
__extern xdc_Ptr ti_sysbios_family_c28_Hwi_getHookContext__F( ti_sysbios_family_c28_Hwi_Object* __inst, xdc_Int id );
__extern xdc_Ptr ti_sysbios_family_c28_Hwi_getHookContext__R( ti_sysbios_family_c28_Hwi_Handle __inst, xdc_Int id );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_setHookContext__F, "ti_sysbios_family_c28_Hwi_setHookContext")
__extern xdc_Void ti_sysbios_family_c28_Hwi_setHookContext__F( ti_sysbios_family_c28_Hwi_Object* __inst, xdc_Int id, xdc_Ptr hookContext );
__extern xdc_Void ti_sysbios_family_c28_Hwi_setHookContext__R( ti_sysbios_family_c28_Hwi_Handle __inst, xdc_Int id, xdc_Ptr hookContext );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_getIrp__F, "ti_sysbios_family_c28_Hwi_getIrp")
__extern ti_sysbios_interfaces_IHwi_Irp ti_sysbios_family_c28_Hwi_getIrp__F( ti_sysbios_family_c28_Hwi_Object* __inst );
__extern ti_sysbios_interfaces_IHwi_Irp ti_sysbios_family_c28_Hwi_getIrp__R( ti_sysbios_family_c28_Hwi_Handle __inst );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_plug__F, "ti_sysbios_family_c28_Hwi_plug")
__extern xdc_Void ti_sysbios_family_c28_Hwi_plug__F( xdc_UInt intNum, ti_sysbios_family_c28_Hwi_PlugFuncPtr fxn );
__extern xdc_Void ti_sysbios_family_c28_Hwi_plug__R( xdc_UInt intNum, ti_sysbios_family_c28_Hwi_PlugFuncPtr fxn );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_getHandle__F, "ti_sysbios_family_c28_Hwi_getHandle")
__extern ti_sysbios_family_c28_Hwi_Handle ti_sysbios_family_c28_Hwi_getHandle__F( xdc_UInt intNum );
__extern ti_sysbios_family_c28_Hwi_Handle ti_sysbios_family_c28_Hwi_getHandle__R( xdc_UInt intNum );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_disableInterrupt__F, "ti_sysbios_family_c28_Hwi_disableInterrupt")
__extern xdc_UInt ti_sysbios_family_c28_Hwi_disableInterrupt__F( xdc_UInt intNum );
__extern xdc_UInt ti_sysbios_family_c28_Hwi_disableInterrupt__R( xdc_UInt intNum );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_enableInterrupt__F, "ti_sysbios_family_c28_Hwi_enableInterrupt")
__extern xdc_UInt ti_sysbios_family_c28_Hwi_enableInterrupt__F( xdc_UInt intNum );
__extern xdc_UInt ti_sysbios_family_c28_Hwi_enableInterrupt__R( xdc_UInt intNum );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_restoreInterrupt__F, "ti_sysbios_family_c28_Hwi_restoreInterrupt")
__extern xdc_Void ti_sysbios_family_c28_Hwi_restoreInterrupt__F( xdc_UInt intNum, xdc_UInt key );
__extern xdc_Void ti_sysbios_family_c28_Hwi_restoreInterrupt__R( xdc_UInt intNum, xdc_UInt key );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_clearInterrupt__F, "ti_sysbios_family_c28_Hwi_clearInterrupt")
__extern xdc_Void ti_sysbios_family_c28_Hwi_clearInterrupt__F( xdc_UInt intNum );
__extern xdc_Void ti_sysbios_family_c28_Hwi_clearInterrupt__R( xdc_UInt intNum );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_disableIER__F, "ti_sysbios_family_c28_Hwi_disableIER")
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_disableIER__F( xdc_Bits16 mask );
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_disableIER__R( xdc_Bits16 mask );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_enableIER__F, "ti_sysbios_family_c28_Hwi_enableIER")
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_enableIER__F( xdc_Bits16 mask );
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_enableIER__R( xdc_Bits16 mask );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_restoreIER__F, "ti_sysbios_family_c28_Hwi_restoreIER")
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_restoreIER__F( xdc_Bits16 mask );
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_restoreIER__R( xdc_Bits16 mask );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_enablePIEIER__F, "ti_sysbios_family_c28_Hwi_enablePIEIER")
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_enablePIEIER__F( xdc_UInt groupNum, xdc_Bits16 pieMask );
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_enablePIEIER__R( xdc_UInt groupNum, xdc_Bits16 pieMask );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_disablePIEIER__F, "ti_sysbios_family_c28_Hwi_disablePIEIER")
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_disablePIEIER__F( xdc_UInt groupNum, xdc_Bits16 pieMask );
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_disablePIEIER__R( xdc_UInt groupNum, xdc_Bits16 pieMask );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_restorePIEIER__F, "ti_sysbios_family_c28_Hwi_restorePIEIER")
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_restorePIEIER__F( xdc_UInt groupNum, xdc_Bits16 pieMask );
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_restorePIEIER__R( xdc_UInt groupNum, xdc_Bits16 pieMask );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_getInterruptFlag__F, "ti_sysbios_family_c28_Hwi_getInterruptFlag")
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_getInterruptFlag__F( xdc_UInt intNum );
__extern xdc_Bits16 ti_sysbios_family_c28_Hwi_getInterruptFlag__R( xdc_UInt intNum );
...
xdc__CODESECT(ti_sysbios_family_c28_Hwi_reconfig__F, "ti_sysbios_family_c28_Hwi_reconfig")
__extern xdc_Void ti_sysbios_family_c28_Hwi_reconfig__F( ti_sysbios_family_c28_Hwi_Object* __inst, ti_sysbios_family_c28_Hwi_FuncPtr fxn, const ti_sysbios_family_c28_Hwi_Params* params );
__extern xdc_Void ti_sysbios_family_c28_Hwi_reconfig__R( ti_sysbios_family_c28_Hwi_Handle __inst, ti_sysbios_family_c28_Hwi_FuncPtr fxn, const ti_sysbios_family_c28_Hwi_Params* params );
...
/* getFunc_{FxnT,fxnP} */
typedef ti_sysbios_interfaces_IHwi_FuncPtr (*ti_sysbios_family_c28_Hwi_getFunc_FxnT)(void*, xdc_UArg*);
static inline ti_sysbios_family_c28_Hwi_getFunc_FxnT ti_sysbios_family_c28_Hwi_getFunc_fxnP( void )
{
    return (ti_sysbios_family_c28_Hwi_getFunc_FxnT)ti_sysbios_family_c28_Hwi_getFunc; 
}

/* setFunc_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_family_c28_Hwi_setFunc_FxnT)(void*, ti_sysbios_interfaces_IHwi_FuncPtr, xdc_UArg);
static inline ti_sysbios_family_c28_Hwi_setFunc_FxnT ti_sysbios_family_c28_Hwi_setFunc_fxnP( void )
{
    return (ti_sysbios_family_c28_Hwi_setFunc_FxnT)ti_sysbios_family_c28_Hwi_setFunc; 
}

/* getHookContext_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sysbios_family_c28_Hwi_getHookContext_FxnT)(void*, xdc_Int);
static inline ti_sysbios_family_c28_Hwi_getHookContext_FxnT ti_sysbios_family_c28_Hwi_getHookContext_fxnP( void )
{
    return (ti_sysbios_family_c28_Hwi_getHookContext_FxnT)ti_sysbios_family_c28_Hwi_getHookContext; 
}

/* setHookContext_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_family_c28_Hwi_setHookContext_FxnT)(void*, xdc_Int, xdc_Ptr);
static inline ti_sysbios_family_c28_Hwi_setHookContext_FxnT ti_sysbios_family_c28_Hwi_setHookContext_fxnP( void )
{
    return (ti_sysbios_family_c28_Hwi_setHookContext_FxnT)ti_sysbios_family_c28_Hwi_setHookContext; 
}

/* getIrp_{FxnT,fxnP} */
typedef ti_sysbios_interfaces_IHwi_Irp (*ti_sysbios_family_c28_Hwi_getIrp_FxnT)(void*);
static inline ti_sysbios_family_c28_Hwi_getIrp_FxnT ti_sysbios_family_c28_Hwi_getIrp_fxnP( void )
{
    return (ti_sysbios_family_c28_Hwi_getIrp_FxnT)ti_sysbios_family_c28_Hwi_getIrp; 
}

/* reconfig_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_family_c28_Hwi_reconfig_FxnT)(void*, ti_sysbios_family_c28_Hwi_FuncPtr, const ti_sysbios_family_c28_Hwi_Params*);
static inline ti_sysbios_family_c28_Hwi_reconfig_FxnT ti_sysbios_family_c28_Hwi_reconfig_fxnP( void )
{
    return (ti_sysbios_family_c28_Hwi_reconfig_FxnT)ti_sysbios_family_c28_Hwi_reconfig; 
}
...
{
    if (dst) {
        ti_sysbios_family_c28_Hwi_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_family_c28_Hwi_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sysbios_family_c28_Hwi_Handle_name( ti_sysbios_family_c28_Hwi_Handle inst )
{
...
/* create */
static inline ti_sysbios_family_c28_Hwi_Handle ti_sysbios_family_c28_Hwi_create( xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_c28_Hwi_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_family_c28_Hwi_Args__create __args;
    __args.intNum = intNum;
    __args.hwiFxn = hwiFxn;
    return (ti_sysbios_family_c28_Hwi_Handle)ti_sysbios_family_c28_Hwi_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_family_c28_Hwi_Params), __eb);
}

/* construct */
static inline void ti_sysbios_family_c28_Hwi_construct( ti_sysbios_family_c28_Hwi_Struct* __obj, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_c28_Hwi_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_family_c28_Hwi_Args__create __args;
    __args.intNum = intNum;
    __args.hwiFxn = hwiFxn;
    ti_sysbios_family_c28_Hwi_Object__create__S(__obj, sizeof (ti_sysbios_family_c28_Hwi_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_family_c28_Hwi_Params), __eb);
}

/* delete */
static inline void ti_sysbios_family_c28_Hwi_delete( ti_sysbios_family_c28_Hwi_Handle* instp )
{
    ti_sysbios_family_c28_Hwi_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_family_c28_Hwi_destruct( ti_sysbios_family_c28_Hwi_Struct* obj )
{
...
#define Hwi_getFunc_fxnP ti_sysbios_family_c28_Hwi_getFunc_fxnP
#define Hwi_getFunc_FxnT ti_sysbios_family_c28_Hwi_getFunc_FxnT
#define Hwi_setFunc ti_sysbios_family_c28_Hwi_setFunc
#define Hwi_setFunc_fxnP ti_sysbios_family_c28_Hwi_setFunc_fxnP
#define Hwi_setFunc_FxnT ti_sysbios_family_c28_Hwi_setFunc_FxnT
#define Hwi_getHookContext ti_sysbios_family_c28_Hwi_getHookContext
#define Hwi_getHookContext_fxnP ti_sysbios_family_c28_Hwi_getHookContext_fxnP
#define Hwi_getHookContext_FxnT ti_sysbios_family_c28_Hwi_getHookContext_FxnT
#define Hwi_setHookContext ti_sysbios_family_c28_Hwi_setHookContext
#define Hwi_setHookContext_fxnP ti_sysbios_family_c28_Hwi_setHookContext_fxnP
#define Hwi_setHookContext_FxnT ti_sysbios_family_c28_Hwi_setHookContext_FxnT
#define Hwi_getIrp ti_sysbios_family_c28_Hwi_getIrp
#define Hwi_getIrp_fxnP ti_sysbios_family_c28_Hwi_getIrp_fxnP
#define Hwi_getIrp_FxnT ti_sysbios_family_c28_Hwi_getIrp_FxnT
...
#define Hwi_reconfig_fxnP ti_sysbios_family_c28_Hwi_reconfig_fxnP
#define Hwi_reconfig_FxnT ti_sysbios_family_c28_Hwi_reconfig_FxnT
