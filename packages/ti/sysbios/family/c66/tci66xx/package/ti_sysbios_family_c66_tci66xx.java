...
public class ti_sysbios_family_c66_tci66xx
{
    ...
    void CpIntc$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.c66.tci66xx.CpIntc.dispatch", new Extern("ti_sysbios_family_c66_tci66xx_CpIntc_dispatch__E", "xdc_Void(*)(xdc_UInt)", true, false));
    ...
    void CpIntc$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("sysIntToHostInt", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt8)"), false), $$DEFAULT, "w");
        ...
        po.init("ti.sysbios.family.c66.tci66xx.CpIntc.Module_State", null);
                ...
                po.addFld("hostIntToSysInt", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt8)"), false), $$DEFAULT, "w");
    ...
    void CpIntc$$ROV()
    {
        ...
        po.bind("hostIntToSysInt$fetchDesc", Global.newObject("type", "xdc.rov.support.ScalarStructs.S_UInt8", "isScalar", true));
    ...
    void CpIntc$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "clearSysInt", "entry", "0x%x, 0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "disableAllHostInts", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "disableHostInt", "entry", "0x%x, 0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "disableSysInt", "entry", "0x%x, 0x%x", "exit", ""));
        ...
        loggables.add(Global.newObject("name", "enableAllHostInts", "entry", "0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "enableHostInt", "entry", "0x%x, 0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "enableSysInt", "entry", "0x%x, 0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "getEventId", "entry", "0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "getHostInt", "entry", "0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "mapSysIntToHostInt", "entry", "0x%x, 0x%x, 0x%x", "exit", ""));
        loggables.add(Global.newObject("name", "postSysInt", "entry", "0x%x, 0x%x", "exit", ""));
