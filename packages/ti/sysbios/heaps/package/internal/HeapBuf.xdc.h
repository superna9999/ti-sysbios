...
#define ti_sysbios_heaps_HeapBuf_free ti_sysbios_heaps_HeapBuf_free__F

/* getStats */
#undef ti_sysbios_heaps_HeapBuf_getStats
#define ti_sysbios_heaps_HeapBuf_getStats ti_sysbios_heaps_HeapBuf_getStats__F
...
#define ti_sysbios_heaps_HeapBuf_Module_startup ti_sysbios_heaps_HeapBuf_Module_startup__F

/* Instance_init */
#undef ti_sysbios_heaps_HeapBuf_Instance_init
#define ti_sysbios_heaps_HeapBuf_Instance_init ti_sysbios_heaps_HeapBuf_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_heaps_HeapBuf_Instance_finalize
#define ti_sysbios_heaps_HeapBuf_Instance_finalize ti_sysbios_heaps_HeapBuf_Instance_finalize__F
