...
public class ti_sysbios_heaps
{
    ...
    void HeapBuf$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.heaps.HeapBuf.Object", new Proto.Str(po, false));
    ...
    void HeapMem$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.heaps.HeapMem.Object", new Proto.Str(po, false));
    ...
    void HeapMultiBuf$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.heaps.HeapMultiBuf.Object", new Proto.Str(po, false));
    ...
    void HeapNull$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.heaps.HeapNull.Object", new Proto.Str(po, false));
    ...
    void HeapMem_Module_GateProxy$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.heaps.HeapMem_Module_GateProxy.Object", new Proto.Str(po, false));
    ...
    void HeapBuf$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("A_zeroBlockSize", (Proto)om.findStrict("xdc.runtime.Assert$$Id", "ti.sysbios.heaps"), Global.newObject("msg", "blockSize cannot be zero"), "w");
    ...
    void HeapMem$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("A_invalidFree", (Proto)om.findStrict("xdc.runtime.Assert$$Id", "ti.sysbios.heaps"), Global.newObject("msg", "A_invalidFree: Invalid free"), "w");
            po.addFld("reqAlign", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF, "w");
            po.addFld("reqAlignMask", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF, "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/debug/ti.sysbios.heaps.a64',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.a64P',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.a64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.a674',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.a430',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.a430X',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.a430XS',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.ae430X',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.ae430XS',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.ae64P',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.ae64Pe',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.ae674',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.ae64T',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.heaps.aea8f',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.heaps.aer4te',\n");
            sb.append("'lib/debug/ti.sysbios.heaps.aer4fte',\n");
            ...
            sb.append("'lib/debug/ti.sysbios.heaps.a86W',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/ti.sysbios.heaps.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.a430', {target: 'ti.targets.msp430.MSP430', suffix: '430'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.a430X', {target: 'ti.targets.msp430.MSP430X', suffix: '430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.a430XS', {target: 'ti.targets.msp430.MSP430X_small', suffix: '430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.ae430XS', {target: 'ti.targets.msp430.elf.MSP430X_small', suffix: 'e430XS'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.heaps.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.heaps.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/debug/ti.sysbios.heaps.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
            ...
            sb.append("['lib/debug/ti.sysbios.heaps.a86W', {target: 'microsoft.targets.Win32', suffix: '86W'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void HeapBuf$$SINGLETONS()
    {
        ...
        vo.bind("$$assertDescCfgs", Global.newArray("A_nullBuf", "A_bufAlign", "A_invalidAlign", "A_zeroBlockSize", "A_zeroBlocks", "A_zeroBufSize", "A_invalidBufSize", "A_noBlocksToFree", "A_invalidFree"));
    ...
    void HeapMem$$SINGLETONS()
    {
        ...
        mcfgs.add("reqAlign");
        icfgs.add("reqAlign");
        mcfgs.add("reqAlignMask");
        icfgs.add("reqAlignMask");
