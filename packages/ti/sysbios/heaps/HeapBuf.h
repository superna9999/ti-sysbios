...
#define ti_sysbios_heaps_HeapBuf___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Instance_init__F, "ti_sysbios_heaps_HeapBuf_Instance_init")
__extern int ti_sysbios_heaps_HeapBuf_Instance_init__F( ti_sysbios_heaps_HeapBuf_Object*, const ti_sysbios_heaps_HeapBuf_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Instance_finalize__F, "ti_sysbios_heaps_HeapBuf_Instance_finalize")
__extern void ti_sysbios_heaps_HeapBuf_Instance_finalize__F( ti_sysbios_heaps_HeapBuf_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Instance_init__R, "ti_sysbios_heaps_HeapBuf_Instance_init")
__extern int ti_sysbios_heaps_HeapBuf_Instance_init__R( ti_sysbios_heaps_HeapBuf_Object*, const ti_sysbios_heaps_HeapBuf_Params*, xdc_runtime_Error_Block* );
...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Handle__label__S, "ti_sysbios_heaps_HeapBuf_Handle__label")
__extern xdc_runtime_Types_Label* ti_sysbios_heaps_HeapBuf_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Module__startupDone__S, "ti_sysbios_heaps_HeapBuf_Module__startupDone")
__extern xdc_Bool ti_sysbios_heaps_HeapBuf_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Object__create__S, "ti_sysbios_heaps_HeapBuf_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Object__delete__S, "ti_sysbios_heaps_HeapBuf_Object__delete")
__extern xdc_Void ti_sysbios_heaps_HeapBuf_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Object__destruct__S, "ti_sysbios_heaps_HeapBuf_Object__destruct")
__extern xdc_Void ti_sysbios_heaps_HeapBuf_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Object__get__S, "ti_sysbios_heaps_HeapBuf_Object__get")
__extern xdc_Ptr ti_sysbios_heaps_HeapBuf_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Object__first__S, "ti_sysbios_heaps_HeapBuf_Object__first")
__extern xdc_Ptr ti_sysbios_heaps_HeapBuf_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Object__next__S, "ti_sysbios_heaps_HeapBuf_Object__next")
__extern xdc_Ptr ti_sysbios_heaps_HeapBuf_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_heaps_HeapBuf_Params__init__S, "ti_sysbios_heaps_HeapBuf_Params__init")
__extern xdc_Void ti_sysbios_heaps_HeapBuf_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
/* free_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapBuf_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
static inline ti_sysbios_heaps_HeapBuf_free_FxnT ti_sysbios_heaps_HeapBuf_free_fxnP( void )
{
    return (ti_sysbios_heaps_HeapBuf_free_FxnT)ti_sysbios_heaps_HeapBuf_free; 
}

/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapBuf_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
static inline ti_sysbios_heaps_HeapBuf_getStats_FxnT ti_sysbios_heaps_HeapBuf_getStats_fxnP( void )
{
    return (ti_sysbios_heaps_HeapBuf_getStats_FxnT)ti_sysbios_heaps_HeapBuf_getStats; 
}
...
{
    return (ti_sysbios_heaps_HeapBuf_alloc_FxnT)ti_sysbios_heaps_HeapBuf_alloc; 
}
...
{
    return (ti_sysbios_heaps_HeapBuf_isBlocking_FxnT)ti_sysbios_heaps_HeapBuf_isBlocking; 
}
...
{
    return (ti_sysbios_heaps_HeapBuf_getBlockSize_FxnT)ti_sysbios_heaps_HeapBuf_getBlockSize; 
}
...
{
    return (ti_sysbios_heaps_HeapBuf_getAlign_FxnT)ti_sysbios_heaps_HeapBuf_getAlign; 
}
...
{
    return (ti_sysbios_heaps_HeapBuf_getEndAddr_FxnT)ti_sysbios_heaps_HeapBuf_getEndAddr; 
}

/* getExtendedStats_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapBuf_getExtendedStats_FxnT)(void*, ti_sysbios_heaps_HeapBuf_ExtendedStats*);
static inline ti_sysbios_heaps_HeapBuf_getExtendedStats_FxnT ti_sysbios_heaps_HeapBuf_getExtendedStats_fxnP( void )
{
    return (ti_sysbios_heaps_HeapBuf_getExtendedStats_FxnT)ti_sysbios_heaps_HeapBuf_getExtendedStats; 
}

/* mergeHeapBufs_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapBuf_mergeHeapBufs_FxnT)(void*, ti_sysbios_heaps_HeapBuf_Handle);
static inline ti_sysbios_heaps_HeapBuf_mergeHeapBufs_FxnT ti_sysbios_heaps_HeapBuf_mergeHeapBufs_fxnP( void )
{
    return (ti_sysbios_heaps_HeapBuf_mergeHeapBufs_FxnT)ti_sysbios_heaps_HeapBuf_mergeHeapBufs; 
}
...
#define HeapBuf_free_fxnP ti_sysbios_heaps_HeapBuf_free_fxnP
#define HeapBuf_free_FxnT ti_sysbios_heaps_HeapBuf_free_FxnT
#define HeapBuf_getStats ti_sysbios_heaps_HeapBuf_getStats
#define HeapBuf_getStats_fxnP ti_sysbios_heaps_HeapBuf_getStats_fxnP
#define HeapBuf_getStats_FxnT ti_sysbios_heaps_HeapBuf_getStats_FxnT
#define HeapBuf_alloc ti_sysbios_heaps_HeapBuf_alloc
#define HeapBuf_alloc_fxnP ti_sysbios_heaps_HeapBuf_alloc_fxnP
#define HeapBuf_alloc_FxnT ti_sysbios_heaps_HeapBuf_alloc_FxnT
#define HeapBuf_isBlocking ti_sysbios_heaps_HeapBuf_isBlocking
#define HeapBuf_isBlocking_fxnP ti_sysbios_heaps_HeapBuf_isBlocking_fxnP
#define HeapBuf_isBlocking_FxnT ti_sysbios_heaps_HeapBuf_isBlocking_FxnT
#define HeapBuf_getBlockSize ti_sysbios_heaps_HeapBuf_getBlockSize
#define HeapBuf_getBlockSize_fxnP ti_sysbios_heaps_HeapBuf_getBlockSize_fxnP
#define HeapBuf_getBlockSize_FxnT ti_sysbios_heaps_HeapBuf_getBlockSize_FxnT
#define HeapBuf_getAlign ti_sysbios_heaps_HeapBuf_getAlign
#define HeapBuf_getAlign_fxnP ti_sysbios_heaps_HeapBuf_getAlign_fxnP
#define HeapBuf_getAlign_FxnT ti_sysbios_heaps_HeapBuf_getAlign_FxnT
#define HeapBuf_getEndAddr ti_sysbios_heaps_HeapBuf_getEndAddr
#define HeapBuf_getEndAddr_fxnP ti_sysbios_heaps_HeapBuf_getEndAddr_fxnP
#define HeapBuf_getEndAddr_FxnT ti_sysbios_heaps_HeapBuf_getEndAddr_FxnT
#define HeapBuf_getExtendedStats ti_sysbios_heaps_HeapBuf_getExtendedStats
#define HeapBuf_getExtendedStats_fxnP ti_sysbios_heaps_HeapBuf_getExtendedStats_fxnP
#define HeapBuf_getExtendedStats_FxnT ti_sysbios_heaps_HeapBuf_getExtendedStats_FxnT
#define HeapBuf_mergeHeapBufs ti_sysbios_heaps_HeapBuf_mergeHeapBufs
#define HeapBuf_mergeHeapBufs_fxnP ti_sysbios_heaps_HeapBuf_mergeHeapBufs_fxnP
#define HeapBuf_mergeHeapBufs_FxnT ti_sysbios_heaps_HeapBuf_mergeHeapBufs_FxnT
