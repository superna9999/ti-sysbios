...
#define ti_sysbios_heaps_HeapMultiBuf___VERS 150
...
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Module_startup__R, "ti_sysbios_heaps_HeapMultiBuf_Module_startup")
__extern xdc_Int ti_sysbios_heaps_HeapMultiBuf_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Instance_init__F, "ti_sysbios_heaps_HeapMultiBuf_Instance_init")
__extern int ti_sysbios_heaps_HeapMultiBuf_Instance_init__F( ti_sysbios_heaps_HeapMultiBuf_Object*, const ti_sysbios_heaps_HeapMultiBuf_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Instance_finalize__F, "ti_sysbios_heaps_HeapMultiBuf_Instance_finalize")
__extern void ti_sysbios_heaps_HeapMultiBuf_Instance_finalize__F( ti_sysbios_heaps_HeapMultiBuf_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Instance_init__R, "ti_sysbios_heaps_HeapMultiBuf_Instance_init")
__extern int ti_sysbios_heaps_HeapMultiBuf_Instance_init__R( ti_sysbios_heaps_HeapMultiBuf_Object*, const ti_sysbios_heaps_HeapMultiBuf_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Instance_finalize__R, "ti_sysbios_heaps_HeapMultiBuf_Instance_finalize")
__extern void ti_sysbios_heaps_HeapMultiBuf_Instance_finalize__R( ti_sysbios_heaps_HeapMultiBuf_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Handle__label__S, "ti_sysbios_heaps_HeapMultiBuf_Handle__label")
...
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Module__startupDone__S, "ti_sysbios_heaps_HeapMultiBuf_Module__startupDone")
__extern xdc_Bool ti_sysbios_heaps_HeapMultiBuf_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Object__create__S, "ti_sysbios_heaps_HeapMultiBuf_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Object__delete__S, "ti_sysbios_heaps_HeapMultiBuf_Object__delete")
__extern xdc_Void ti_sysbios_heaps_HeapMultiBuf_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Object__destruct__S, "ti_sysbios_heaps_HeapMultiBuf_Object__destruct")
__extern xdc_Void ti_sysbios_heaps_HeapMultiBuf_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Object__get__S, "ti_sysbios_heaps_HeapMultiBuf_Object__get")
__extern xdc_Ptr ti_sysbios_heaps_HeapMultiBuf_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Object__first__S, "ti_sysbios_heaps_HeapMultiBuf_Object__first")
__extern xdc_Ptr ti_sysbios_heaps_HeapMultiBuf_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Object__next__S, "ti_sysbios_heaps_HeapMultiBuf_Object__next")
__extern xdc_Ptr ti_sysbios_heaps_HeapMultiBuf_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Params__init__S, "ti_sysbios_heaps_HeapMultiBuf_Params__init")
__extern xdc_Void ti_sysbios_heaps_HeapMultiBuf_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_getStats__F, "ti_sysbios_heaps_HeapMultiBuf_getStats")
__extern xdc_Void ti_sysbios_heaps_HeapMultiBuf_getStats__F( ti_sysbios_heaps_HeapMultiBuf_Object* __inst, xdc_runtime_Memory_Stats* stats );
__extern xdc_Void ti_sysbios_heaps_HeapMultiBuf_getStats__R( ti_sysbios_heaps_HeapMultiBuf_Handle __inst, xdc_runtime_Memory_Stats* stats );
...
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_alloc__F, "ti_sysbios_heaps_HeapMultiBuf_alloc")
__extern xdc_Ptr ti_sysbios_heaps_HeapMultiBuf_alloc__F( ti_sysbios_heaps_HeapMultiBuf_Object* __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
__extern xdc_Ptr ti_sysbios_heaps_HeapMultiBuf_alloc__R( ti_sysbios_heaps_HeapMultiBuf_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_free__F, "ti_sysbios_heaps_HeapMultiBuf_free")
__extern xdc_Void ti_sysbios_heaps_HeapMultiBuf_free__F( ti_sysbios_heaps_HeapMultiBuf_Object* __inst, xdc_Ptr block, xdc_SizeT size );
__extern xdc_Void ti_sysbios_heaps_HeapMultiBuf_free__R( ti_sysbios_heaps_HeapMultiBuf_Handle __inst, xdc_Ptr block, xdc_SizeT size );
...
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_isBlocking__F, "ti_sysbios_heaps_HeapMultiBuf_isBlocking")
__extern xdc_Bool ti_sysbios_heaps_HeapMultiBuf_isBlocking__F( ti_sysbios_heaps_HeapMultiBuf_Object* __inst );
__extern xdc_Bool ti_sysbios_heaps_HeapMultiBuf_isBlocking__R( ti_sysbios_heaps_HeapMultiBuf_Handle __inst );
...
/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapMultiBuf_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
static inline ti_sysbios_heaps_HeapMultiBuf_getStats_FxnT ti_sysbios_heaps_HeapMultiBuf_getStats_fxnP( void )
{
    return (ti_sysbios_heaps_HeapMultiBuf_getStats_FxnT)ti_sysbios_heaps_HeapMultiBuf_getStats; 
}

/* alloc_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sysbios_heaps_HeapMultiBuf_alloc_FxnT)(void*, xdc_SizeT, xdc_SizeT, xdc_runtime_Error_Block*);
static inline ti_sysbios_heaps_HeapMultiBuf_alloc_FxnT ti_sysbios_heaps_HeapMultiBuf_alloc_fxnP( void )
{
    return (ti_sysbios_heaps_HeapMultiBuf_alloc_FxnT)ti_sysbios_heaps_HeapMultiBuf_alloc; 
}

/* free_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapMultiBuf_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
static inline ti_sysbios_heaps_HeapMultiBuf_free_FxnT ti_sysbios_heaps_HeapMultiBuf_free_fxnP( void )
{
    return (ti_sysbios_heaps_HeapMultiBuf_free_FxnT)ti_sysbios_heaps_HeapMultiBuf_free; 
}

/* isBlocking_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_heaps_HeapMultiBuf_isBlocking_FxnT)(void*);
static inline ti_sysbios_heaps_HeapMultiBuf_isBlocking_FxnT ti_sysbios_heaps_HeapMultiBuf_isBlocking_fxnP( void )
{
    return (ti_sysbios_heaps_HeapMultiBuf_isBlocking_FxnT)ti_sysbios_heaps_HeapMultiBuf_isBlocking; 
}
...
{
    if (dst) {
        ti_sysbios_heaps_HeapMultiBuf_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_heaps_HeapMultiBuf_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sysbios_heaps_HeapMultiBuf_Handle_name( ti_sysbios_heaps_HeapMultiBuf_Handle inst )
{
...
/* create */
static inline ti_sysbios_heaps_HeapMultiBuf_Handle ti_sysbios_heaps_HeapMultiBuf_create( const ti_sysbios_heaps_HeapMultiBuf_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_sysbios_heaps_HeapMultiBuf_Handle)ti_sysbios_heaps_HeapMultiBuf_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_heaps_HeapMultiBuf_Params), __eb);
}

/* construct */
static inline void ti_sysbios_heaps_HeapMultiBuf_construct( ti_sysbios_heaps_HeapMultiBuf_Struct* __obj, const ti_sysbios_heaps_HeapMultiBuf_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_heaps_HeapMultiBuf_Object__create__S(__obj, sizeof (ti_sysbios_heaps_HeapMultiBuf_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_heaps_HeapMultiBuf_Params), __eb);
}

/* delete */
static inline void ti_sysbios_heaps_HeapMultiBuf_delete( ti_sysbios_heaps_HeapMultiBuf_Handle* instp )
{
    ti_sysbios_heaps_HeapMultiBuf_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_heaps_HeapMultiBuf_destruct( ti_sysbios_heaps_HeapMultiBuf_Struct* obj )
{
    ti_sysbios_heaps_HeapMultiBuf_Object__destruct__S(obj);
}
...
#define HeapMultiBuf_getStats_fxnP ti_sysbios_heaps_HeapMultiBuf_getStats_fxnP
#define HeapMultiBuf_getStats_FxnT ti_sysbios_heaps_HeapMultiBuf_getStats_FxnT
#define HeapMultiBuf_alloc ti_sysbios_heaps_HeapMultiBuf_alloc
#define HeapMultiBuf_alloc_fxnP ti_sysbios_heaps_HeapMultiBuf_alloc_fxnP
#define HeapMultiBuf_alloc_FxnT ti_sysbios_heaps_HeapMultiBuf_alloc_FxnT
#define HeapMultiBuf_free ti_sysbios_heaps_HeapMultiBuf_free
#define HeapMultiBuf_free_fxnP ti_sysbios_heaps_HeapMultiBuf_free_fxnP
#define HeapMultiBuf_free_FxnT ti_sysbios_heaps_HeapMultiBuf_free_FxnT
#define HeapMultiBuf_isBlocking ti_sysbios_heaps_HeapMultiBuf_isBlocking
#define HeapMultiBuf_isBlocking_fxnP ti_sysbios_heaps_HeapMultiBuf_isBlocking_fxnP
#define HeapMultiBuf_isBlocking_FxnT ti_sysbios_heaps_HeapMultiBuf_isBlocking_FxnT
