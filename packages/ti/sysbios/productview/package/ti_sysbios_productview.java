...
public class ti_sysbios_productview
{
    ...
    void BiosProductView$$TYPES()
    {
        ...
        po.addFld("ti_sysbios_rta_Agent", (Proto)om.findStrict("ti.sysbios.productview.BiosProductView.ProductElemDesc", "ti.sysbios.productview"), $$DEFAULT, "wh");
        ...
        po.addFld("xdc_runtime_HeapStd", (Proto)om.findStrict("ti.sysbios.productview.BiosProductView.ProductElemDesc", "ti.sysbios.productview"), $$DEFAULT, "wh");
        ...
        po.addFld("ti_sysbios_family_arm_tms570_Hwi", (Proto)om.findStrict("ti.sysbios.productview.BiosProductView.ProductElemDesc", "ti.sysbios.productview"), $$DEFAULT, "wh");
        po.addFld("ti_sysbios_family_arm_tms570_Timer", (Proto)om.findStrict("ti.sysbios.productview.BiosProductView.ProductElemDesc", "ti.sysbios.productview"), $$DEFAULT, "wh");
        po.addFld("ti_sysbios_family_arm_tms570_TimestampProvider", (Proto)om.findStrict("ti.sysbios.productview.BiosProductView.ProductElemDesc", "ti.sysbios.productview"), $$DEFAULT, "wh");
        ...
        po.addFld("r4Group", (Proto)om.findStrict("ti.sysbios.productview.BiosProductView.ProductElemDesc", "ti.sysbios.productview"), $$DEFAULT, "wh");
