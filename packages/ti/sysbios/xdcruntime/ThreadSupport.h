...
#define ti_sysbios_xdcruntime_ThreadSupport___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Instance_init__F, "ti_sysbios_xdcruntime_ThreadSupport_Instance_init")
__extern int ti_sysbios_xdcruntime_ThreadSupport_Instance_init__F( ti_sysbios_xdcruntime_ThreadSupport_Object*, xdc_runtime_knl_IThreadSupport_RunFxn fxn, const ti_sysbios_xdcruntime_ThreadSupport_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Instance_finalize__F, "ti_sysbios_xdcruntime_ThreadSupport_Instance_finalize")
__extern void ti_sysbios_xdcruntime_ThreadSupport_Instance_finalize__F( ti_sysbios_xdcruntime_ThreadSupport_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Instance_init__R, "ti_sysbios_xdcruntime_ThreadSupport_Instance_init")
__extern int ti_sysbios_xdcruntime_ThreadSupport_Instance_init__R( ti_sysbios_xdcruntime_ThreadSupport_Object*, xdc_runtime_knl_IThreadSupport_RunFxn fxn, const ti_sysbios_xdcruntime_ThreadSupport_Params*, xdc_runtime_Error_Block* );
...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Handle__label__S, "ti_sysbios_xdcruntime_ThreadSupport_Handle__label")
...
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Module__startupDone__S, "ti_sysbios_xdcruntime_ThreadSupport_Module__startupDone")
__extern xdc_Bool ti_sysbios_xdcruntime_ThreadSupport_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Object__create__S, "ti_sysbios_xdcruntime_ThreadSupport_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Object__delete__S, "ti_sysbios_xdcruntime_ThreadSupport_Object__delete")
__extern xdc_Void ti_sysbios_xdcruntime_ThreadSupport_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Object__destruct__S, "ti_sysbios_xdcruntime_ThreadSupport_Object__destruct")
__extern xdc_Void ti_sysbios_xdcruntime_ThreadSupport_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Object__get__S, "ti_sysbios_xdcruntime_ThreadSupport_Object__get")
__extern xdc_Ptr ti_sysbios_xdcruntime_ThreadSupport_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Object__first__S, "ti_sysbios_xdcruntime_ThreadSupport_Object__first")
__extern xdc_Ptr ti_sysbios_xdcruntime_ThreadSupport_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Object__next__S, "ti_sysbios_xdcruntime_ThreadSupport_Object__next")
__extern xdc_Ptr ti_sysbios_xdcruntime_ThreadSupport_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_xdcruntime_ThreadSupport_Params__init__S, "ti_sysbios_xdcruntime_ThreadSupport_Params__init")
__extern xdc_Void ti_sysbios_xdcruntime_ThreadSupport_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
/* join_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_xdcruntime_ThreadSupport_join_FxnT)(void*, xdc_runtime_Error_Block*);
static inline ti_sysbios_xdcruntime_ThreadSupport_join_FxnT ti_sysbios_xdcruntime_ThreadSupport_join_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_join_FxnT)ti_sysbios_xdcruntime_ThreadSupport_join; 
}

/* getPriority_{FxnT,fxnP} */
typedef xdc_runtime_knl_IThreadSupport_Priority (*ti_sysbios_xdcruntime_ThreadSupport_getPriority_FxnT)(void*, xdc_runtime_Error_Block*);
static inline ti_sysbios_xdcruntime_ThreadSupport_getPriority_FxnT ti_sysbios_xdcruntime_ThreadSupport_getPriority_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_getPriority_FxnT)ti_sysbios_xdcruntime_ThreadSupport_getPriority; 
}

/* setPriority_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_xdcruntime_ThreadSupport_setPriority_FxnT)(void*, xdc_runtime_knl_IThreadSupport_Priority, xdc_runtime_Error_Block*);
static inline ti_sysbios_xdcruntime_ThreadSupport_setPriority_FxnT ti_sysbios_xdcruntime_ThreadSupport_setPriority_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_setPriority_FxnT)ti_sysbios_xdcruntime_ThreadSupport_setPriority; 
}

/* getOsPriority_{FxnT,fxnP} */
typedef xdc_Int (*ti_sysbios_xdcruntime_ThreadSupport_getOsPriority_FxnT)(void*, xdc_runtime_Error_Block*);
static inline ti_sysbios_xdcruntime_ThreadSupport_getOsPriority_FxnT ti_sysbios_xdcruntime_ThreadSupport_getOsPriority_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_getOsPriority_FxnT)ti_sysbios_xdcruntime_ThreadSupport_getOsPriority; 
}

/* setOsPriority_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_xdcruntime_ThreadSupport_setOsPriority_FxnT)(void*, xdc_Int, xdc_runtime_Error_Block*);
static inline ti_sysbios_xdcruntime_ThreadSupport_setOsPriority_FxnT ti_sysbios_xdcruntime_ThreadSupport_setOsPriority_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_setOsPriority_FxnT)ti_sysbios_xdcruntime_ThreadSupport_setOsPriority; 
}

/* getOsHandle_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sysbios_xdcruntime_ThreadSupport_getOsHandle_FxnT)(void*);
static inline ti_sysbios_xdcruntime_ThreadSupport_getOsHandle_FxnT ti_sysbios_xdcruntime_ThreadSupport_getOsHandle_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_getOsHandle_FxnT)ti_sysbios_xdcruntime_ThreadSupport_getOsHandle; 
}

/* getTls_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sysbios_xdcruntime_ThreadSupport_getTls_FxnT)(void*);
static inline ti_sysbios_xdcruntime_ThreadSupport_getTls_FxnT ti_sysbios_xdcruntime_ThreadSupport_getTls_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_getTls_FxnT)ti_sysbios_xdcruntime_ThreadSupport_getTls; 
}

/* setTls_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_xdcruntime_ThreadSupport_setTls_FxnT)(void*, xdc_Ptr);
static inline ti_sysbios_xdcruntime_ThreadSupport_setTls_FxnT ti_sysbios_xdcruntime_ThreadSupport_setTls_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_setTls_FxnT)ti_sysbios_xdcruntime_ThreadSupport_setTls; 
}

/* stat_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_xdcruntime_ThreadSupport_stat_FxnT)(void*, xdc_runtime_knl_IThreadSupport_Stat*, xdc_runtime_Error_Block*);
static inline ti_sysbios_xdcruntime_ThreadSupport_stat_FxnT ti_sysbios_xdcruntime_ThreadSupport_stat_fxnP( void )
{
    return (ti_sysbios_xdcruntime_ThreadSupport_stat_FxnT)ti_sysbios_xdcruntime_ThreadSupport_stat; 
}
...
{
    if (dst) {
        ti_sysbios_xdcruntime_ThreadSupport_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sysbios_xdcruntime_ThreadSupport_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* create */
static inline ti_sysbios_xdcruntime_ThreadSupport_Handle ti_sysbios_xdcruntime_ThreadSupport_create( xdc_runtime_knl_IThreadSupport_RunFxn fxn, const ti_sysbios_xdcruntime_ThreadSupport_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_xdcruntime_ThreadSupport_Args__create __args;
    __args.fxn = fxn;
    return (ti_sysbios_xdcruntime_ThreadSupport_Handle)ti_sysbios_xdcruntime_ThreadSupport_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_xdcruntime_ThreadSupport_Params), __eb);
}

/* construct */
static inline void ti_sysbios_xdcruntime_ThreadSupport_construct( ti_sysbios_xdcruntime_ThreadSupport_Struct* __obj, xdc_runtime_knl_IThreadSupport_RunFxn fxn, const ti_sysbios_xdcruntime_ThreadSupport_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_xdcruntime_ThreadSupport_Args__create __args;
    __args.fxn = fxn;
    ti_sysbios_xdcruntime_ThreadSupport_Object__create__S(__obj, sizeof (ti_sysbios_xdcruntime_ThreadSupport_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sysbios_xdcruntime_ThreadSupport_Params), __eb);
}

/* delete */
static inline void ti_sysbios_xdcruntime_ThreadSupport_delete( ti_sysbios_xdcruntime_ThreadSupport_Handle* instp )
{
    ti_sysbios_xdcruntime_ThreadSupport_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_xdcruntime_ThreadSupport_destruct( ti_sysbios_xdcruntime_ThreadSupport_Struct* obj )
{
    ti_sysbios_xdcruntime_ThreadSupport_Object__destruct__S(obj);
}
...
#define ThreadSupport_join_fxnP ti_sysbios_xdcruntime_ThreadSupport_join_fxnP
#define ThreadSupport_join_FxnT ti_sysbios_xdcruntime_ThreadSupport_join_FxnT
#define ThreadSupport_getPriority ti_sysbios_xdcruntime_ThreadSupport_getPriority
#define ThreadSupport_getPriority_fxnP ti_sysbios_xdcruntime_ThreadSupport_getPriority_fxnP
#define ThreadSupport_getPriority_FxnT ti_sysbios_xdcruntime_ThreadSupport_getPriority_FxnT
#define ThreadSupport_setPriority ti_sysbios_xdcruntime_ThreadSupport_setPriority
#define ThreadSupport_setPriority_fxnP ti_sysbios_xdcruntime_ThreadSupport_setPriority_fxnP
#define ThreadSupport_setPriority_FxnT ti_sysbios_xdcruntime_ThreadSupport_setPriority_FxnT
#define ThreadSupport_getOsPriority ti_sysbios_xdcruntime_ThreadSupport_getOsPriority
#define ThreadSupport_getOsPriority_fxnP ti_sysbios_xdcruntime_ThreadSupport_getOsPriority_fxnP
#define ThreadSupport_getOsPriority_FxnT ti_sysbios_xdcruntime_ThreadSupport_getOsPriority_FxnT
#define ThreadSupport_setOsPriority ti_sysbios_xdcruntime_ThreadSupport_setOsPriority
#define ThreadSupport_setOsPriority_fxnP ti_sysbios_xdcruntime_ThreadSupport_setOsPriority_fxnP
#define ThreadSupport_setOsPriority_FxnT ti_sysbios_xdcruntime_ThreadSupport_setOsPriority_FxnT
#define ThreadSupport_getOsHandle ti_sysbios_xdcruntime_ThreadSupport_getOsHandle
#define ThreadSupport_getOsHandle_fxnP ti_sysbios_xdcruntime_ThreadSupport_getOsHandle_fxnP
#define ThreadSupport_getOsHandle_FxnT ti_sysbios_xdcruntime_ThreadSupport_getOsHandle_FxnT
#define ThreadSupport_getTls ti_sysbios_xdcruntime_ThreadSupport_getTls
#define ThreadSupport_getTls_fxnP ti_sysbios_xdcruntime_ThreadSupport_getTls_fxnP
#define ThreadSupport_getTls_FxnT ti_sysbios_xdcruntime_ThreadSupport_getTls_FxnT
#define ThreadSupport_setTls ti_sysbios_xdcruntime_ThreadSupport_setTls
#define ThreadSupport_setTls_fxnP ti_sysbios_xdcruntime_ThreadSupport_setTls_fxnP
#define ThreadSupport_setTls_FxnT ti_sysbios_xdcruntime_ThreadSupport_setTls_FxnT
#define ThreadSupport_stat ti_sysbios_xdcruntime_ThreadSupport_stat
#define ThreadSupport_stat_fxnP ti_sysbios_xdcruntime_ThreadSupport_stat_fxnP
#define ThreadSupport_stat_FxnT ti_sysbios_xdcruntime_ThreadSupport_stat_FxnT
