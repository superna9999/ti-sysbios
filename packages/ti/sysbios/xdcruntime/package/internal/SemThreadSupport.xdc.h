...
#define ti_sysbios_xdcruntime_SemThreadSupport_pend ti_sysbios_xdcruntime_SemThreadSupport_pend__F

/* post */
#undef ti_sysbios_xdcruntime_SemThreadSupport_post
#define ti_sysbios_xdcruntime_SemThreadSupport_post ti_sysbios_xdcruntime_SemThreadSupport_post__F

/* Module_startup */
#undef ti_sysbios_xdcruntime_SemThreadSupport_Module_startup
#define ti_sysbios_xdcruntime_SemThreadSupport_Module_startup ti_sysbios_xdcruntime_SemThreadSupport_Module_startup__F

/* Instance_init */
#undef ti_sysbios_xdcruntime_SemThreadSupport_Instance_init
#define ti_sysbios_xdcruntime_SemThreadSupport_Instance_init ti_sysbios_xdcruntime_SemThreadSupport_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_xdcruntime_SemThreadSupport_Instance_finalize
#define ti_sysbios_xdcruntime_SemThreadSupport_Instance_finalize ti_sysbios_xdcruntime_SemThreadSupport_Instance_finalize__F
