...
public class ti_bios_support
{
    ...
    void Lck$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.bios.support.Lck.Object", new Proto.Str(po, false));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.bios.support.a28L',\n");
            sb.append("'lib/debug/ti.bios.support.a28FP',\n");
            sb.append("'lib/debug/ti.bios.support.a64',\n");
            sb.append("'lib/debug/ti.bios.support.a64P',\n");
            sb.append("'lib/debug/ti.bios.support.a64Pe',\n");
            sb.append("'lib/debug/ti.bios.support.a674',\n");
            sb.append("'lib/debug/ti.bios.support.ae64P',\n");
            sb.append("'lib/debug/ti.bios.support.ae64Pe',\n");
            sb.append("'lib/debug/ti.bios.support.ae674',\n");
            sb.append("'lib/debug/ti.bios.support.ae64T',\n");
            sb.append("'lib/debug/ti.bios.support.ae66',\n");
            sb.append("'lib/debug/ti.bios.support.ae66e',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.bios.support.a28L', {target: 'ti.targets.C28_large', suffix: '28L'}],\n");
            sb.append("['lib/debug/ti.bios.support.a28FP', {target: 'ti.targets.C28_float', suffix: '28FP'}],\n");
            sb.append("['lib/debug/ti.bios.support.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            sb.append("['lib/debug/ti.bios.support.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/debug/ti.bios.support.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/debug/ti.bios.support.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/debug/ti.bios.support.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/debug/ti.bios.support.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/debug/ti.bios.support.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/debug/ti.bios.support.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            sb.append("['lib/debug/ti.bios.support.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/debug/ti.bios.support.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
